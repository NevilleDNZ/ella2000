...
A_PROCEDURE(A68_VOID ,A68t429,(A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ),(A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,void *));
typedef struct A68t429  A68_429 ;    /* PROC(INT,INT,INT,INT,INT,INT) VOID */

A_PROCEDURE(A68_VOID ,A68t430,(A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ),(A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,void *));
typedef struct A68t430  A68_430 ;    /* PROC(INT,INT,INT,INT,INT,INT,INT) VOID */

A_PROCEDURE(A68_VOID ,A68t431,(struct A68t32 ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ),(struct A68t32 ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,void *));
typedef struct A68t431  A68_431 ;    /* PROC(MODE32,INT,INT,INT,INT,INT) VOID */

A_PROCEDURE(A68_VOID ,A68t432,(struct A68t158 ,A68_VC ,struct A68t218 ,struct A68t32 ,A68_INT ,struct A68t221 ,struct A68t231 *,struct A68t36 ,struct A68t292 *),(struct A68t158 ,A68_VC ,struct A68t218 ,struct A68t32 ,A68_INT ,struct A68t221 ,struct A68t231 *,struct A68t36 ,struct A68t292 *,void *));
typedef struct A68t432  A68_432 ;    /* PROC(MODE158,REF MODE26,MODE218,MODE32,INT,MODE221,REF MODE231,MODE36) MODE292 */
A_ISTRUCT(A68_CHAR ,33,A68t433);
typedef struct A68t433  A68_433 ;    /* STRUCT 33 CHAR */
A_ISTRUCT(A68_CHAR ,37,A68t434);
typedef struct A68t434  A68_434 ;    /* STRUCT 37 CHAR */
A_ISTRUCT(A68_CHAR ,38,A68t435);
typedef struct A68t435  A68_435 ;    /* STRUCT 38 CHAR */

A_PROCEDURE(A68_VOID ,A68t436,(A68_BOOL ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ),(A68_BOOL ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,A68_INT ,void *));
typedef struct A68t436  A68_436 ;    /* PROC(BOOL,INT,INT,INT,INT,INT) VOID */
A_ISTRUCT(A68_CHAR ,12,A68t437);
typedef struct A68t437  A68_437 ;    /* STRUCT 12 CHAR */
...
extern A68_VOID  XVNASIM_amutos(A68_INT );
...
static A68_428   DXWASIM = {"$Id: keamconc.a68,v 34.2 1995/03/29 13:04:35 ella Exp $"}; 
A_GISVEC(A68_VC ,EXWASIM,DXWASIM,55)
static A68_433   KZWASIM = {"translate conc: wrong input count"}; 
A_GISVEC(A68_VC ,LZWASIM,KZWASIM,33)
static A68_433   QZWASIM = {"translate conc: wrong output sort"}; 
A_GISVEC(A68_VC ,RZWASIM,QZWASIM,33)
static A68_434   AAXASIM = {"translate conc: wrong left input sort"}; 
A_GISVEC(A68_VC ,BAXASIM,AAXASIM,37)
static A68_435   JAXASIM = {"translate conc: wrong right input sort"}; 
A_GISVEC(A68_VC ,KAXASIM,JAXASIM,38)
static A68_437   VBXASIM = {"Genericquery"}; 
A_GISVEC(A68_VC ,WBXASIM,VBXASIM,12)

A_STATIC A68_VOID  LXWASIM_copychartostringoutput(A68_INT  Inputoffset, A68_INT  Outputoffset, A68_INT  Enclosinglen, A68_INT  Msboffset, A68_INT  Flagadjust, A68_INT  D);

A_STATIC A68_VOID  ZXWASIM_copystringtostringoutput(A68_INT  Inoffset, A68_INT  Outoffset, A68_INT  Sourcesize, A68_INT  Destmsboffset, A68_INT  Destencsize, A68_INT  Flagadjust, A68_INT  D);

A_STATIC A68_VOID  QYWASIM_copytrimmedstrings(A68_32  Inputtypes, A68_INT  Inoffset, A68_INT  Outoffset, A68_INT  Enclosinglen, A68_INT  Flagadjust, A68_INT  D);

A68_VOID  JZWASIM_translateconc(A68_158  Body, A68_VC  Name, A68_218  Declaration, A68_32  Inputtypes, A68_INT  Outputtype, A68_221  Environ, A68_231 * Closure, A68_36  Flt, A68_292  *ReturnedValue);

A_STATIC A68_VOID  NBXASIM_translatepushpartialinput(A68_BOOL  Ischar, A68_INT  Inputoffset, A68_INT  Bitoffset, A68_INT  Bitsize, A68_INT  Bitlength, A68_INT  D);

A_STATIC A68_VOID  NBXASIM_translatepushpartialinput(A68_BOOL  Ischar, A68_INT  Inputoffset, A68_INT  Bitoffset, A68_INT  Bitsize, A68_INT  Bitlength, A68_INT  D)
{ 
A_PROC_ENTRY(translatepushpartialinput);
 /* line 397: */
 /* line 398: */
if ( Ischar )
{ 
...
SSNASIM_amadd();
 /* line 414: */
 /* line 415: */
LVNASIM_ambstring(Bitsize, Bitlength, ONFASIM_indirect);
} 
A_PROC_EXIT(translatepushpartialinput);
return;
} 
#undef NL
 /* line 90: */
...
A_STATIC A68_VOID  LXWASIM_copychartostringoutput(A68_INT  Inputoffset, A68_INT  Outputoffset, A68_INT  Enclosinglen, A68_INT  Msboffset, A68_INT  Flagadjust, A68_INT  D)
{ 
A68_INT  MXWASIM;  /* ADICOPS - MOD */
A68_INT  NXWASIM_byteoffset;
A68_INT  OXWASIM_shiftamount;
A68_INT  PXWASIM_aloffset;
A68_INT  QXWASIM;  /* clause result */
A68_INT  RXWASIM_alignedout;
A_PROC_ENTRY(copychartostringoutput);
 /* line 91: */
 /* line 92: */
{ 
NXWASIM_byteoffset = A_MOD(Msboffset,DENASIM_ws,MXWASIM);
 /* line 93: */
OXWASIM_shiftamount = (((DENASIM_ws-1)-NXWASIM_byteoffset)*CENASIM_bitsperbyte);
 /* line 94: */
PXWASIM_aloffset = ((Msboffset/DENASIM_ws)*DENASIM_ws);
 /* line 95: */
 /* line 96: */
 /* line 97: */
...
{ 
 /* line 98: */
 /* line 99: */
QXWASIM = (((Outputoffset+Enclosinglen)-DENASIM_ws)-PXWASIM_aloffset);
} 
else
{ 
 /* line 100: */
QXWASIM = (Outputoffset+PXWASIM_aloffset);
} 
RXWASIM_alignedout = QXWASIM;
 /* line 104: */
WUNASIM_amlocal((D-1));
 /* line 105: */
QUNASIM_ampushint(RXWASIM_alignedout);
 /* line 106: */
SSNASIM_amadd();
 /* line 109: */
WUNASIM_amlocal(0);
...
AVNASIM_amglobal(DENASIM_ws, ONFASIM_indirect);
 /* line 113: */
QUNASIM_ampushint(255);
 /* line 115: */
QUNASIM_ampushint(OXWASIM_shiftamount);
 /* line 116: */
KTNASIM_amshl();
 /* line 117: */
OTNASIM_amcom();
...
GUNASIM_amor();
 /* line 139: */
NPPASIM_translatecompareandsetflag(DENASIM_ws, 1, Flagadjust, (D+2));
 /* line 140: */
 /* line 143: */
FVNASIM_amstore(DENASIM_ws, ONFASIM_indirect);
} 
A_PROC_EXIT(copychartostringoutput);
return;
} 
#undef NL
 /* line 148: */
...
A_STATIC A68_VOID  ZXWASIM_copystringtostringoutput(A68_INT  Inoffset, A68_INT  Outoffset, A68_INT  Sourcesize, A68_INT  Destmsboffset, A68_INT  Destencsize, A68_INT  Flagadjust, A68_INT  D)
{ 
A68_INT  AYWASIM_sourceencsize;
A68_INT  BYWASIM_destmsbaloffset;
A68_INT  CYWASIM;  /* clause result */
A68_INT  DYWASIM_destmswordoffset;
A68_INT  EYWASIM;  /* ADICOPS - MOD */
A68_INT  FYWASIM_destmsboverlap;
A68_INT  GYWASIM;  /* clause result */
A68_INT  HYWASIM_destlsendoffset;
A68_INT  IYWASIM_destlsendbitsize;
A68_INT  JYWASIM_destmsbbitoverlap;
A_PROC_ENTRY(copystringtostringoutput);
 /* line 149: */
 /* line 150: */
{ 
AYWASIM_sourceencsize = (((Sourcesize+(DENASIM_ws-1))/DENASIM_ws)*DENASIM_ws);
 /* line 151: */
BYWASIM_destmsbaloffset = ((Destmsboffset/DENASIM_ws)*DENASIM_ws);
 /* line 152: */
 /* line 153: */
 /* line 154: */
if ( EENASIM_amversionup )
{ 
 /* line 155: */
 /* line 156: */
CYWASIM = (((Outoffset+Destencsize)-DENASIM_ws)-BYWASIM_destmsbaloffset);
} 
else
{ 
 /* line 157: */
CYWASIM = (Outoffset+BYWASIM_destmsbaloffset);
} 
DYWASIM_destmswordoffset = CYWASIM;
 /* line 158: */
FYWASIM_destmsboverlap = (DENASIM_ws-A_MOD(Destmsboffset,DENASIM_ws,EYWASIM));
 /* line 159: */
 /* line 160: */
 /* line 161: */
if ( EENASIM_amversionup )
{ 
 ...
 /* line 163: */
 /* line 164: */
GYWASIM = (DYWASIM_destmswordoffset-(((((Sourcesize-FYWASIM_destmsboverlap)+DENASIM_ws)-1)/DENASIM_ws)*DENASIM_ws));
} 
else
{ 
 /* line 165: */
GYWASIM = (DYWASIM_destmswordoffset+DENASIM_ws);
} 
HYWASIM_destlsendoffset = GYWASIM;
 /* line 166: */
IYWASIM_destlsendbitsize = ((Sourcesize-FYWASIM_destmsboverlap)*CENASIM_bitsperbyte);
 /* line 167: */
JYWASIM_destmsbbitoverlap = (FYWASIM_destmsboverlap*CENASIM_bitsperbyte);
 /* line 171: */
QUNASIM_ampushint(0);
 /* line 172: */
WUNASIM_amlocal(D);
...
SSNASIM_amadd();
 /* line 179: */
LVNASIM_ambstring(JYWASIM_destmsbbitoverlap, (AYWASIM_sourceencsize*CENASIM_bitsperbyte), ONFASIM_indirect);
 /* line 180: */
BWNASIM_amstou();
 /* line 183: */
 /* line 184: */
if ( ((DENASIM_ws-FYWASIM_destmsboverlap)!=0) )
{ 
QUNASIM_ampushint(0);
 /* line 185: */
WUNASIM_amlocal((D+1));
 /* line 186: */
QUNASIM_ampushint(DYWASIM_destmswordoffset);
 /* line 187: */
SSNASIM_amadd();
 /* line 189: */
LVNASIM_ambstring(((DENASIM_ws-FYWASIM_destmsboverlap)*CENASIM_bitsperbyte), (DENASIM_ws*CENASIM_bitsperbyte), ONFASIM_indirect);
 /* line 190: */
BWNASIM_amstou();
 /* line 192: */
QUNASIM_ampushint(JYWASIM_destmsbbitoverlap);
 /* line 193: */
KTNASIM_amshl();
 /* line 194: */
 /* line 195: */
...
WUNASIM_amlocal(1);
 /* line 206: */
NPPASIM_translatecompareandsetflag(DENASIM_ws, 1, Flagadjust, (D+3));
 /* line 207: */
QVNASIM_ambstore((DENASIM_ws*CENASIM_bitsperbyte), ONFASIM_indirect);
 /* line 209: */
TUNASIM_amdrop(1);
 /* line 212: */
 /* line 215: */
if ( (Sourcesize>FYWASIM_destmsboverlap) )
{ 
WUNASIM_amlocal((D-1));
 /* line 216: */
QUNASIM_ampushint(HYWASIM_destlsendoffset);
 /* line 217: */
SSNASIM_amadd();
 /* line 220: */
QUNASIM_ampushint(JYWASIM_destmsbbitoverlap);
...
SSNASIM_amadd();
 /* line 229: */
LVNASIM_ambstring(IYWASIM_destlsendbitsize, (AYWASIM_sourceencsize*CENASIM_bitsperbyte), ONFASIM_indirect);
 /* line 231: */
 /* line 232: */
NPPASIM_translatecompareandsetflag((IYWASIM_destlsendbitsize/CENASIM_bitsperbyte), 1, Flagadjust, (D+2));
 /* line 233: */
 /* line 235: */
 /* line 236: */
QVNASIM_ambstore(IYWASIM_destlsendbitsize, ONFASIM_indirect);
} 
} 
A_PROC_EXIT(copystringtostringoutput);
return;
} 
#undef NL
 /* line 239: */
...
A_STATIC A68_VOID  QYWASIM_copytrimmedstrings(A68_32  Inputtypes, A68_INT  Inoffset, A68_INT  Outoffset, A68_INT  Enclosinglen, A68_INT  Flagadjust, A68_INT  D)
{ 
A68_INT  RYWASIM_getfrom;
A68_INT  SYWASIM_writeto;
A68_INT  TYWASIM_size;
A68_INT  UYWASIM_i;
A68_INT  VYWASIM;  /* to part of loop */
A68_277  WYWASIM;  /* avoid structure result */
A68_277  XYWASIM;  /* united object - for case conformity */
A68_281 * YYWASIM_char;
A68_INT  ZYWASIM;  /* clause result */
A68_283 * AZWASIM_str;
A_PROC_ENTRY(copytrimmedstrings);
 /* line 240: */
 /* line 241: */
{ 
RYWASIM_getfrom = Inoffset;
 /* line 242: */
SYWASIM_writeto = 0;
 /* line 243: */
 /* line 244: */
VYWASIM = Inputtypes.upb;
for ( UYWASIM_i = 1;
UYWASIM_i <= VYWASIM;
UYWASIM_i += 1 )
{ 
 ...
 /* line 246: */
 /* line 247: */
VGCASIM_lookuptype( A_VINDEX(Inputtypes,UYWASIM_i), &WYWASIM );
XYWASIM = WYWASIM ;
switch ( XYWASIM.mode )
{ 
case 3: /* REF STRUCT(REF MODE26,REF MODE26)  */
YYWASIM_char = (XYWASIM.data.mode3);
 /* line 248: */
 /* line 250: */
{ 
 /* line 251: */
LXWASIM_copychartostringoutput(RYWASIM_getfrom, Outoffset, Enclosinglen, SYWASIM_writeto, Flagadjust, D);
 /* line 252: */
 /* line 253: */
 /* line 254: */
ZYWASIM = 1;
...
break;
case 5: /* REF STRUCT(INT,MODE281)  */
AZWASIM_str = (XYWASIM.data.mode5);
 /* line 255: */
 /* line 257: */
{ 
 /* line 258: */
ZXWASIM_copystringtostringoutput(RYWASIM_getfrom, Outoffset, (*(&(AZWASIM_str->No))), SYWASIM_writeto, Enclosinglen, Flagadjust, D);
 /* line 259: */
 /* line 260: */
 /* line 261: */
ZYWASIM = (*(&(AZWASIM_str->No)));
} 
break;
default: 
A_IMP_SKIP ;
...
TYWASIM_size = ZYWASIM;
 /* line 262: */
RYWASIM_getfrom+=DENASIM_ws;
 /* line 263: */
 /* line 264: */
SYWASIM_writeto+=TYWASIM_size;
}
 /* line 265: */
} 
A_PROC_EXIT(copytrimmedstrings);
return;
} 
#undef NL
 /* line 282: */
...
A68_VOID  JZWASIM_translateconc(A68_158  Body, A68_VC  Name, A68_218  Declaration, A68_32  Inputtypes, A68_INT  Outputtype, A68_221  Environ, A68_231 * Closure, A68_36  Flt, A68_292  *ReturnedValue)
{ 
A68_277  MZWASIM;  /* avoid structure result */
A68_277  NZWASIM;  /* united object - for case conformity */
A68_283 * OZWASIM_s;
A68_BOOL  PZWASIM;  /* clause result */
A68_BOOL  SZWASIM_bitstring;
A68_INT  TZWASIM_outputsize;
A68_INT  UZWASIM;  /* YIELD */
A68_277  VZWASIM;  /* avoid structure result */
A68_277  WZWASIM;  /* united object - for case conformity */
A68_283 * XZWASIM_s;
A68_INT  YZWASIM;  /* clause result */
A68_281 * ZZWASIM_c;
A68_INT  CAXASIM_leftinputsize;
A68_INT  DAXASIM;  /* YIELD */
A68_277  EAXASIM;  /* avoid structure result */
A68_277  FAXASIM;  /* united object - for case conformity */
A68_283 * GAXASIM_s;
A68_INT  HAXASIM;  /* clause result */
A68_281 * IAXASIM_c;
A68_INT  LAXASIM_rightinputsize;
A68_INT  MAXASIM_leftinputoffset;
A68_INT  NAXASIM_rightinputoffset;
A68_INT  OAXASIM_outputoffset;
A68_INT  PAXASIM_fixedpartsize;
A68_327  QAXASIM;  /* avoid structure result */
A68_327  RAXASIM_outputquery;
A68_327  SAXASIM;  /* avoid structure result */
A68_327  TAXASIM_end;
A68_327  UAXASIM;  /* avoid structure result */
A68_327  VAXASIM_samelabel;
A68_INT  WAXASIM_l;
A68_INT  XAXASIM_r;
A68_BOOL  YAXASIM_lischar;
A68_BOOL  ZAXASIM_rischar;
A68_INT  ABXASIM_wsb;
A68_INT  BBXASIM;  /* ADICOPS - MOD */
A68_INT  CBXASIM_b1;
A68_INT  DBXASIM_a;
A68_INT  EBXASIM;  /* clause result */
A68_INT  FBXASIM_b2;
A68_INT  GBXASIM_c;
A68_327  OBXASIM;  /* avoid structure result */
A68_327  PBXASIM_samelabel;
A68_327  QBXASIM;  /* avoid structure result */
A68_327  RBXASIM_samelabel;
A68_327  SBXASIM;  /* avoid structure result */
A68_327  TBXASIM_samelabel;
A68_INT  UBXASIM_datasize;
A68_327  XBXASIM;  /* avoid structure result */
A68_292  YBXASIM;  /* collateral clause result */
A68_292  ZBXASIM;  /* clause result */
A_PROC_ENTRY(translateconc);
 /* line 285: */
 /* line 286: */
{ 
 /* line 287: */
...
{ 
 /* line 288: */
NKDAOST_sysfault(LZWASIM);
} 
 /* line 289: */
 /* line 290: */
 /* line 291: */
VGCASIM_lookuptype( Outputtype, &MZWASIM );
NZWASIM = MZWASIM ;
switch ( NZWASIM.mode )
{ 
case 5: /* REF STRUCT(INT,MODE281)  */
OZWASIM_s = (NZWASIM.data.mode5);
 /* line 292: */
PZWASIM = ((*(&((&(OZWASIM_s->T))->Char))).upb==2);
break;
default: 
NKDAOST_sysfault(RZWASIM);
 /* line 293: */
PZWASIM = A68_FALSE;
break;
} 
SZWASIM_bitstring = PZWASIM;
 /* line 295: */
TZWASIM_outputsize = YGCASIM_lookuptypesize(Outputtype);
 /* line 296: */
 /* line 297: */
 /* line 298: */
UZWASIM = 1 ;
VGCASIM_lookuptype( A_VINDEX(Inputtypes,UZWASIM), &VZWASIM );
WZWASIM = VZWASIM ;
switch ( WZWASIM.mode )
{ 
case 5: /* REF STRUCT(INT,MODE281)  */
XZWASIM_s = (WZWASIM.data.mode5);
 /* line 299: */
YZWASIM = (*(&(XZWASIM_s->No)));
break;
case 3: /* REF STRUCT(REF MODE26,REF MODE26)  */
ZZWASIM_c = (WZWASIM.data.mode3);
 /* line 300: */
YZWASIM = 1;
break;
default: 
NKDAOST_sysfault(BAXASIM);
 /* line 301: */
YZWASIM = 0;
break;
} 
CAXASIM_leftinputsize = YZWASIM;
 /* line 302: */
 /* line 303: */
 /* line 304: */
DAXASIM = 2 ;
VGCASIM_lookuptype( A_VINDEX(Inputtypes,DAXASIM), &EAXASIM );
FAXASIM = EAXASIM ;
switch ( FAXASIM.mode )
{ 
case 5: /* REF STRUCT(INT,MODE281)  */
GAXASIM_s = (FAXASIM.data.mode5);
 /* line 305: */
HAXASIM = (*(&(GAXASIM_s->No)));
break;
case 3: /* REF STRUCT(REF MODE26,REF MODE26)  */
IAXASIM_c = (FAXASIM.data.mode3);
 /* line 306: */
HAXASIM = 1;
break;
default: 
NKDAOST_sysfault(KAXASIM);
 /* line 307: */
HAXASIM = 0;
break;
} 
LAXASIM_rightinputsize = HAXASIM;
 /* line 309: */
MAXASIM_leftinputoffset = (GENASIM_sizeunit+DENASIM_ws);
 /* line 310: */
NAXASIM_rightinputoffset = (MAXASIM_leftinputoffset+DENASIM_ws);
 /* line 311: */
OAXASIM_outputoffset = (NAXASIM_rightinputoffset+DENASIM_ws);
 /* line 312: */
PAXASIM_fixedpartsize = (OAXASIM_outputoffset+TZWASIM_outputsize);
 /* line 314: */
YFNASIM_newlabel(  &QAXASIM );
RAXASIM_outputquery = QAXASIM;
 /* line 315: */
YFNASIM_newlabel(  &SAXASIM );
TAXASIM_end = SAXASIM;
 /* line 317: */
...
WUNASIM_amlocal(0);
 /* line 322: */
QUNASIM_ampushint(MAXASIM_leftinputoffset);
 /* line 323: */
SSNASIM_amadd();
 /* line 324: */
AVNASIM_amglobal(DENASIM_ws, ONFASIM_indirect);
...
QTNASIM_amtest();
 /* line 327: */
IWNASIM_amjumpno(0, RAXASIM_outputquery);
 /* line 328: */
WUNASIM_amlocal(0);
 /* line 329: */
QUNASIM_ampushint(NAXASIM_rightinputoffset);
 /* line 330: */
SSNASIM_amadd();
 /* line 331: */
AVNASIM_amglobal(DENASIM_ws, ONFASIM_indirect);
...
WUNASIM_amlocal(0);
 /* line 346: */
QUNASIM_ampushint(OAXASIM_outputoffset);
 /* line 347: */
SSNASIM_amadd();
 /* line 348: */
 /* line 349: */
if ( SZWASIM_bitstring )
{ 
WUNASIM_amlocal(0);
 /* line 350: */
AVNASIM_amglobal(DENASIM_ws, ONFASIM_indirect);
...
IUNASIM_amnot();
 /* line 353: */
YFNASIM_newlabel(  &UAXASIM );
VAXASIM_samelabel = UAXASIM;
 /* line 354: */
IWNASIM_amjumpno(0, VAXASIM_samelabel);
 /* line 355: */
WUNASIM_amlocal(1);
 /* line 356: */
QUNASIM_ampushint(0);
...
FVNASIM_amstore(GENASIM_sizeunit, ONFASIM_indirect);
 /* line 358: */
 /* line 359: */
NWNASIM_amlabel(2, VAXASIM_samelabel);
} 
 /* line 360: */
QUNASIM_ampushint(1);
 /* line 361: */
...
if ( SZWASIM_bitstring )
{ 
WAXASIM_l = CAXASIM_leftinputsize;
 /* line 373: */
XAXASIM_r = LAXASIM_rightinputsize;
 /* line 375: */
YAXASIM_lischar = (Body.Sort==UIAATRN_flattenright);
 /* line 376: */
ZAXASIM_rischar = (Body.Sort==TIAATRN_flattenleft);
 /* line 381: */
ABXASIM_wsb = (DENASIM_ws*CENASIM_bitsperbyte);
 /* line 382: */
CBXASIM_b1 = A_MOD(WAXASIM_l,ABXASIM_wsb,BBXASIM);
 /* line 383: */
DBXASIM_a = (WAXASIM_l-CBXASIM_b1);
 /* line 384: */
 /* line 385: */
 /* line 386: */
if ( (CBXASIM_b1==0) )
...
{ 
 /* line 387: */
if ( ((XAXASIM_r+CBXASIM_b1)<ABXASIM_wsb) )
{ 
EBXASIM = XAXASIM_r;
} 
else
{ 
 /* line 388: */
EBXASIM = (ABXASIM_wsb-CBXASIM_b1);
} 
} 
FBXASIM_b2 = EBXASIM;
 /* line 389: */
GBXASIM_c = (XAXASIM_r-FBXASIM_b2);
 /* line 395: */
 /* line 396: */
 /* line 418: */
WUNASIM_amlocal(0);
...
if ( !EENASIM_amversionup )
{ 
QUNASIM_ampushint((OAXASIM_outputoffset+GENASIM_sizeunit));
 /* line 421: */
 /* line 422: */
 /* line 423: */
SSNASIM_amadd();
...
{ 
QUNASIM_ampushint(((OAXASIM_outputoffset+TZWASIM_outputsize)-(DBXASIM_a/CENASIM_bitsperbyte)));
 /* line 424: */
 /* line 426: */
SSNASIM_amadd();
} 
...
WUNASIM_amlocal(0);
 /* line 431: */
 /* line 432: */
NBXASIM_translatepushpartialinput(YAXASIM_lischar, MAXASIM_leftinputoffset, 0, DBXASIM_a, WAXASIM_l, 3);
 /* line 434: */
QUNASIM_ampushint(0);
 /* line 435: */
WUNASIM_amlocal(2);
 /* line 436: */
LVNASIM_ambstring(DBXASIM_a, DBXASIM_a, ONFASIM_indirect);
 /* line 437: */
WUNASIM_amlocal(1);
 /* line 438: */
UTNASIM_amneq();
 /* line 439: */
YFNASIM_newlabel(  &OBXASIM );
PBXASIM_samelabel = OBXASIM;
 /* line 440: */
IWNASIM_amjumpno(0, PBXASIM_samelabel);
 /* line 441: */
WUNASIM_amlocal(3);
 /* line 442: */
QUNASIM_ampushint(0);
...
FVNASIM_amstore(GENASIM_sizeunit, ONFASIM_indirect);
 /* line 444: */
NWNASIM_amlabel(4, PBXASIM_samelabel);
 /* line 445: */
QVNASIM_ambstore(DBXASIM_a, ONFASIM_indirect);
 /* line 446: */
 /* line 447: */
if ( !EENASIM_amversionup )
{ 
QUNASIM_ampushint((DBXASIM_a/CENASIM_bitsperbyte));
 /* line 448: */
 /* line 449: */
 /* line 450: */
SSNASIM_amadd();
...
WUNASIM_amlocal(0);
 /* line 459: */
 /* line 460: */
NBXASIM_translatepushpartialinput(YAXASIM_lischar, MAXASIM_leftinputoffset, DBXASIM_a, CBXASIM_b1, WAXASIM_l, 3);
 /* line 462: */
BWNASIM_amstou();
 /* line 463: */
QUNASIM_ampushint((ABXASIM_wsb-CBXASIM_b1));
 /* line 464: */
KTNASIM_amshl();
 /* line 465: */
 /* line 466: */
NBXASIM_translatepushpartialinput(ZAXASIM_rischar, NAXASIM_rightinputoffset, 0, FBXASIM_b2, XAXASIM_r, 4);
 /* line 468: */
BWNASIM_amstou();
 /* line 469: */
 /* line 470: */
if ( ((CBXASIM_b1+FBXASIM_b2)<ABXASIM_wsb) )
{ 
QUNASIM_ampushint(((ABXASIM_wsb-CBXASIM_b1)-FBXASIM_b2));
 /* line 471: */
 /* line 472: */
KTNASIM_amshl();
} 
...
UTNASIM_amneq();
 /* line 478: */
YFNASIM_newlabel(  &QBXASIM );
RBXASIM_samelabel = QBXASIM;
 /* line 479: */
IWNASIM_amjumpno(0, RBXASIM_samelabel);
 /* line 480: */
WUNASIM_amlocal(3);
 /* line 481: */
QUNASIM_ampushint(0);
...
FVNASIM_amstore(GENASIM_sizeunit, ONFASIM_indirect);
 /* line 483: */
NWNASIM_amlabel(4, RBXASIM_samelabel);
 /* line 484: */
FVNASIM_amstore(DENASIM_ws, ONFASIM_indirect);
 /* line 485: */
 /* line 486: */
...
if ( (GBXASIM_c>0) )
{ 
NBXASIM_translatepushpartialinput(ZAXASIM_rischar, NAXASIM_rightinputoffset, FBXASIM_b2, GBXASIM_c, XAXASIM_r, 2);
 /* line 502: */
QUNASIM_ampushint(0);
 /* line 503: */
WUNASIM_amlocal(2);
 /* line 504: */
LVNASIM_ambstring(GBXASIM_c, GBXASIM_c, ONFASIM_indirect);
 /* line 505: */
WUNASIM_amlocal(1);
 /* line 506: */
UTNASIM_amneq();
 /* line 507: */
YFNASIM_newlabel(  &SBXASIM );
TBXASIM_samelabel = SBXASIM;
 /* line 508: */
IWNASIM_amjumpno(0, TBXASIM_samelabel);
 /* line 509: */
WUNASIM_amlocal(2);
 /* line 510: */
QUNASIM_ampushint(0);
...
FVNASIM_amstore(GENASIM_sizeunit, ONFASIM_indirect);
 /* line 512: */
NWNASIM_amlabel(3, TBXASIM_samelabel);
 /* line 513: */
 /* line 514: */
 /* line 515: */
QVNASIM_ambstore(GBXASIM_c, ONFASIM_indirect);
} 
else
{ 
 /* line 516: */
...
{ 
 ...
 /* line 522: */
 /* line 523: */
QYWASIM_copytrimmedstrings(Inputtypes, MAXASIM_leftinputoffset, (OAXASIM_outputoffset+GENASIM_sizeunit), (TZWASIM_outputsize-GENASIM_sizeunit), IPPASIM_resetflag, 1);
} 
 /* line 524: */
EWNASIM_amjump(TAXASIM_end);
 /* line 527: */
NWNASIM_amlabel(1, RAXASIM_outputquery);
 /* line 528: */
UBXASIM_datasize = YGCASIM_lookuptypesize(Outputtype);
 /* line 529: */
QUNASIM_ampushint(OAXASIM_outputoffset);
 /* line 530: */
QUNASIM_ampushint(UBXASIM_datasize);
 /* line 531: */
YLFASIM_label( WBXASIM, &XBXASIM );
BXNASIM_amcall(3, XBXASIM);
 /* line 532: */
TUNASIM_amdrop(2);
 /* line 535: */
NWNASIM_amlabel(1, TAXASIM_end);
 /* line 536: */
ZOPASIM_translateendfunction(PAXASIM_fixedpartsize, 1);
 /* line 538: */
YBXASIM.Size = PAXASIM_fixedpartsize;
YBXASIM.Offset = OAXASIM_outputoffset;
 /* line 539: */
YBXASIM.Sort = IHCASIM_combinatorial;
ZBXASIM = YBXASIM;
} 
A_PROC_EXIT(translateconc);
*ReturnedValue = (ZBXASIM);
return;
} 
#undef NL
 /* line 1: */
 /* line 2: */
 /* line 5: */
void AXWASIM(void)   /* initialise DECS keamconc */
{ 
static A68_BOOL A_invoked = A68_FALSE;

/* --- Configuration information for this module */
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","/u/model/ella/oslib/assoc/mfiles","-dir","/u/model/ella/ostools/assoc/mfiles","-dir","/u/model/ella/transform/assoc/mfiles","-dir","./mfiles","-staredit","259R","./a68files/keamconc.a68",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/sim/assoc/./a68files/keamconc.a68";
A_config.translation_time = "Tue Apr  4 11:11:48 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "ZWWASIM (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 11:11:48 1995";
A_config.arguments = A_config_arguments;
A_config.environment = A_config_environment;
A_config.modinfo_files = A_config_modinfo_files;
A_PROC_ENTRY(DECS keamconc);
UEAALIB_a68config(LGAALIB_configinfo, EXWASIM);
 /* line 89: */
 /* line 147: */
 /* line 238: */
 /* line 281: */
 ...
 /* line 546: */
/*SKIP*/;
A_PROC_EXIT(DECS keamconc);
} 
#undef NL
/* end of translation of ./a68files/keamconc.a68 */
