...
A_ISTRUCT(A68_CHAR ,58,A68t428);
typedef struct A68t428  A68_428 ;    /* STRUCT 58 CHAR */

A_PROCEDURE(A68_VOID ,A68t429,(struct A68t150 ,A68_VC ,struct A68t218 ,struct A68t32 ,A68_INT ,struct A68t221 ,struct A68t231 *,struct A68t36 ,struct A68t292 *),(struct A68t150 ,A68_VC ,struct A68t218 ,struct A68t32 ,A68_INT ,struct A68t221 ,struct A68t231 *,struct A68t36 ,struct A68t292 *,void *));
typedef struct A68t429  A68_429 ;    /* PROC(MODE150,REF MODE26,MODE218,MODE32,INT,MODE221,REF MODE231,MODE36) MODE292 */
A_ISTRUCT(A68_CHAR ,33,A68t430);
typedef struct A68t430  A68_430 ;    /* STRUCT 33 CHAR */
...
extern A68_VOID  ITPASIM_translatecopytrimmedinputs(struct A68t32 ,struct A68t32 ,A68_INT ,A68_INT ,A68_INT ,A68_INT );
...
static A68_428   VSVASIM = {"$Id: keamextract.a68,v 34.2 1995/03/29 13:04:36 ella Exp $"}; 
A_GISVEC(A68_VC ,WSVASIM,VSVASIM,58)
static A68_430   GTVASIM = {"translate extract: invalid inputs"}; 
A_GISVEC(A68_VC ,HTVASIM,GTVASIM,33)
static A68_431   TTVASIM = {"Genericquery"}; 
A_GISVEC(A68_VC ,UTVASIM,TTVASIM,12)

A68_VOID  FTVASIM_translateextract(A68_150  Body, A68_VC  Name, A68_218  Declaration, A68_32  Inputtypes, A68_INT  Outputtype, A68_221  Environ, A68_231 * Closure, A68_36  Flt, A68_292  *ReturnedValue);
 /* line 73: */
 /* line 74: */
 /* line 75: */
...
A68_VOID  FTVASIM_translateextract(A68_150  Body, A68_VC  Name, A68_218  Declaration, A68_32  Inputtypes, A68_INT  Outputtype, A68_221  Environ, A68_231 * Closure, A68_36  Flt, A68_292  *ReturnedValue)
{ 
A68_INT  ITVASIM_outputsize;
A68_INT  JTVASIM_inputoffset;
A68_INT  KTVASIM_outputoffset;
A68_INT  LTVASIM_fixedpartsize;
A68_327  MTVASIM;  /* avoid structure result */
A68_327  NTVASIM_outputquery;
A68_327  OTVASIM;  /* avoid structure result */
A68_327  PTVASIM_end;
A68_32  QTVASIM;  /* OPERATORS - scalar -> [] or VEC[] */
A68_32  RTVASIM;  /* OPERATORS - scalar -> [] or VEC[] */
A68_INT  STVASIM_datasize;
A68_327  VTVASIM;  /* avoid structure result */
A68_292  WTVASIM;  /* collateral clause result */
A68_292  XTVASIM;  /* clause result */
A_PROC_ENTRY(translateextract);
 /* line 76: */
 /* line 77: */
{ 
 /* line 78: */
...
{ 
 /* line 79: */
NKDAOST_sysfault(HTVASIM);
} 
 /* line 81: */
ITVASIM_outputsize = YGCASIM_lookuptypesize(Outputtype);
 /* line 82: */
JTVASIM_inputoffset = (GENASIM_sizeunit+DENASIM_ws);
 /* line 83: */
KTVASIM_outputoffset = (JTVASIM_inputoffset+(Inputtypes.upb*DENASIM_ws));
 /* line 84: */
LTVASIM_fixedpartsize = (KTVASIM_outputoffset+ITVASIM_outputsize);
 /* line 86: */
YFNASIM_newlabel(  &MTVASIM );
NTVASIM_outputquery = MTVASIM;
 /* line 87: */
YFNASIM_newlabel(  &OTVASIM );
PTVASIM_end = OTVASIM;
 /* line 89: */
...
WUNASIM_amlocal(0);
 /* line 94: */
QUNASIM_ampushint(JTVASIM_inputoffset);
 /* line 95: */
SSNASIM_amadd();
 /* line 96: */
...
STNASIM_ameq();
 /* line 100: */
IWNASIM_amjumpno(0, NTVASIM_outputquery);
 /* line 103: */
 /* line 104: */
ITPASIM_translatecopytrimmedinputs(A_HVEC(RTVASIM,ITVASIM_outputsize,A68_INT ), A_HVEC(QTVASIM,GENASIM_sizeunit,A68_INT ), JTVASIM_inputoffset, KTVASIM_outputoffset, IPPASIM_resetflag, 1);
 /* line 105: */
EWNASIM_amjump(PTVASIM_end);
 /* line 108: */
NWNASIM_amlabel(1, NTVASIM_outputquery);
 /* line 109: */
STVASIM_datasize = YGCASIM_lookuptypesize(Outputtype);
 /* line 110: */
QUNASIM_ampushint(KTVASIM_outputoffset);
 /* line 111: */
QUNASIM_ampushint(STVASIM_datasize);
 /* line 112: */
YLFASIM_label( UTVASIM, &VTVASIM );
BXNASIM_amcall(3, VTVASIM);
 /* line 113: */
TUNASIM_amdrop(2);
 /* line 116: */
NWNASIM_amlabel(1, PTVASIM_end);
 /* line 117: */
ZOPASIM_translateendfunction(LTVASIM_fixedpartsize, 1);
 /* line 119: */
WTVASIM.Size = LTVASIM_fixedpartsize;
WTVASIM.Offset = KTVASIM_outputoffset;
 /* line 120: */
WTVASIM.Sort = IHCASIM_combinatorial;
XTVASIM = WTVASIM;
} 
A_PROC_EXIT(translateextract);
*ReturnedValue = (XTVASIM);
return;
} 
#undef NL
 /* line 1: */
 /* line 2: */
 /* line 5: */
void SSVASIM(void)   /* initialise DECS keamextract */
{ 
static A68_BOOL A_invoked = A68_FALSE;

/* --- Configuration information for this module */
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","/u/model/ella/oslib/assoc/mfiles","-dir","/u/model/ella/ostools/assoc/mfiles","-dir","/u/model/ella/transform/assoc/mfiles","-dir","./mfiles","-staredit","259R","./a68files/keamextract.a68",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/sim/assoc/./a68files/keamextract.a68";
A_config.translation_time = "Tue Apr  4 11:10:44 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "RSVASIM (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 11:10:44 1995";
A_config.arguments = A_config_arguments;
A_config.environment = A_config_environment;
A_config.modinfo_files = A_config_modinfo_files;
A_PROC_ENTRY(DECS keamextract);
UEAALIB_a68config(LGAALIB_configinfo, WSVASIM);
 /* line 72: */
 /* line 122: */
 /* line 124: */
 /* line 127: */
/*SKIP*/;
A_PROC_EXIT(DECS keamextract);
} 
#undef NL
/* end of translation of ./a68files/keamextract.a68 */
