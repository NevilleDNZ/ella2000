...
A_ISTRUCT(A68_CHAR ,57,A68t428);
typedef struct A68t428  A68_428 ;    /* STRUCT 57 CHAR */

A_PROCEDURE(A68_VOID ,A68t429,(struct A68t169 ,A68_VC ,struct A68t218 ,struct A68t32 ,A68_INT ,struct A68t221 ,struct A68t231 *,struct A68t36 ,struct A68t292 *),(struct A68t169 ,A68_VC ,struct A68t218 ,struct A68t32 ,A68_INT ,struct A68t221 ,struct A68t231 *,struct A68t36 ,struct A68t292 *,void *));
typedef struct A68t429  A68_429 ;    /* PROC(MODE169,REF MODE26,MODE218,MODE32,INT,MODE221,REF MODE231,MODE36) MODE292 */
A_ISTRUCT(A68_CHAR ,35,A68t430);
typedef struct A68t430  A68_430 ;    /* STRUCT 35 CHAR */
...
static A68_428   DCXASIM = {"$Id: keamstring.a68,v 34.2 1995/03/29 13:04:39 ella Exp $"}; 
A_GISVEC(A68_VC ,ECXASIM,DCXASIM,57)
static A68_430   VCXASIM = {"translate string: wrong input count"}; 
A_GISVEC(A68_VC ,WCXASIM,VCXASIM,35)
static A68_430   BDXASIM = {"translate string: wrong output sort"}; 
A_GISVEC(A68_VC ,CDXASIM,BDXASIM,35)
static A68_431   TDXASIM = {"Genericquery"}; 
A_GISVEC(A68_VC ,UDXASIM,TDXASIM,12)

A_STATIC A68_VOID  JCXASIM_filloutputarea(A68_INT  Outputoffset, A68_INT  Inputbytesize, A68_INT  Outputbytesize, A68_INT  D);

A68_VOID  UCXASIM_translatestring(A68_169  Body, A68_VC  Name, A68_218  Declaration, A68_32  Inputtypes, A68_INT  Outputtype, A68_221  Environ, A68_231 * Closure, A68_36  Flt, A68_292  *ReturnedValue);
 /* line 72: */

A_STATIC A68_VOID  JCXASIM_filloutputarea(A68_INT  Outputoffset, A68_INT  Inputbytesize, A68_INT  Outputbytesize, A68_INT  D)
{ 
A68_327  KCXASIM;  /* avoid structure result */
A68_327  LCXASIM_samelabel;
A_PROC_ENTRY(filloutputarea);
 /* line 78: */
 /* line 80: */
{ 
WUNASIM_amlocal((D-1));
 /* line 81: */
QUNASIM_ampushint((Outputoffset+Outputbytesize));
 /* line 82: */
SSNASIM_amadd();
 /* line 85: */
WUNASIM_amlocal(D);
...
WUNASIM_amlocal(1);
 /* line 93: */
 /* line 94: */
LVNASIM_ambstring((Inputbytesize*CENASIM_bitsperbyte), (Inputbytesize*CENASIM_bitsperbyte), ONFASIM_indirect);
 /* line 95: */
WUNASIM_amlocal(3);
 /* line 96: */
UTNASIM_amneq();
 /* line 97: */
YFNASIM_newlabel(  &KCXASIM );
LCXASIM_samelabel = KCXASIM;
 /* line 98: */
IWNASIM_amjumpno(0, LCXASIM_samelabel);
 /* line 99: */
WUNASIM_amlocal((D+1));
 /* line 100: */
QUNASIM_ampushint(0);
...
FVNASIM_amstore(GENASIM_sizeunit, ONFASIM_indirect);
 /* line 102: */
NWNASIM_amlabel((D+2), LCXASIM_samelabel);
 /* line 104: */
QWNASIM_amrepeat();
 /* line 105: */
WUNASIM_amlocal(0);
...
WUNASIM_amlocal(3);
 /* line 107: */
QVNASIM_ambstore((Inputbytesize*CENASIM_bitsperbyte), ONFASIM_indirect);
 /* line 110: */
QUNASIM_ampushint(Inputbytesize);
 /* line 111: */
SSNASIM_amadd();
 /* line 113: */
WUNASIM_amlocal(1);
...
A68_VOID  UCXASIM_translatestring(A68_169  Body, A68_VC  Name, A68_218  Declaration, A68_32  Inputtypes, A68_INT  Outputtype, A68_221  Environ, A68_231 * Closure, A68_36  Flt, A68_292  *ReturnedValue)
{ 
A68_277  XCXASIM;  /* avoid structure result */
A68_277  YCXASIM;  /* united object - for case conformity */
A68_283 * ZCXASIM_s;
A68_BOOL  ADXASIM;  /* clause result */
A68_BOOL  DDXASIM_bitstring;
A68_INT  EDXASIM_outputsize;
A68_INT  FDXASIM;  /* YIELD */
A68_INT  GDXASIM_inputsize;
A68_INT  HDXASIM_inputoffset;
A68_INT  IDXASIM_outputoffset;
A68_INT  JDXASIM_fixedpartsize;
A68_327  KDXASIM;  /* avoid structure result */
A68_327  LDXASIM_outputquery;
A68_327  MDXASIM;  /* avoid structure result */
A68_327  NDXASIM_end;
A68_327  ODXASIM;  /* avoid structure result */
A68_327  PDXASIM_samelabel;
A68_INT  QDXASIM_i;
A68_INT  RDXASIM;  /* to part of loop */
A68_INT  SDXASIM_datasize;
A68_327  VDXASIM;  /* avoid structure result */
A68_292  WDXASIM;  /* collateral clause result */
A68_292  XDXASIM;  /* clause result */
A_PROC_ENTRY(translatestring);
 /* line 132: */
 /* line 133: */
{ 
 /* line 134: */
...
{ 
 /* line 135: */
NKDAOST_sysfault(WCXASIM);
} 
 /* line 136: */
 /* line 137: */
 /* line 138: */
VGCASIM_lookuptype( Outputtype, &XCXASIM );
YCXASIM = XCXASIM ;
switch ( YCXASIM.mode )
{ 
case 5: /* REF STRUCT(INT,MODE281)  */
ZCXASIM_s = (YCXASIM.data.mode5);
 /* line 139: */
ADXASIM = ((*(&((&(ZCXASIM_s->T))->Char))).upb==2);
break;
default: 
NKDAOST_sysfault(CDXASIM);
 /* line 140: */
ADXASIM = A68_FALSE;
break;
} 
DDXASIM_bitstring = ADXASIM;
 /* line 142: */
EDXASIM_outputsize = YGCASIM_lookuptypesize(Outputtype);
 /* line 143: */
FDXASIM = 1 ;
GDXASIM_inputsize = YGCASIM_lookuptypesize(A_VINDEX(Inputtypes,FDXASIM));
 /* line 145: */
HDXASIM_inputoffset = (GENASIM_sizeunit+DENASIM_ws);
 /* line 146: */
IDXASIM_outputoffset = (HDXASIM_inputoffset+DENASIM_ws);
 /* line 147: */
JDXASIM_fixedpartsize = (IDXASIM_outputoffset+EDXASIM_outputsize);
 /* line 149: */
YFNASIM_newlabel(  &KDXASIM );
LDXASIM_outputquery = KDXASIM;
 /* line 150: */
YFNASIM_newlabel(  &MDXASIM );
NDXASIM_end = MDXASIM;
 /* line 152: */
...
WUNASIM_amlocal(0);
 /* line 156: */
QUNASIM_ampushint(HDXASIM_inputoffset);
 /* line 157: */
SSNASIM_amadd();
 /* line 158: */
...
QTNASIM_amtest();
 /* line 161: */
IWNASIM_amjumpno(0, LDXASIM_outputquery);
 /* line 172: */
WUNASIM_amlocal(0);
 /* line 173: */
QUNASIM_ampushint(IDXASIM_outputoffset);
 /* line 174: */
SSNASIM_amadd();
 /* line 175: */
 /* line 176: */
if ( DDXASIM_bitstring )
{ 
WUNASIM_amlocal(0);
 /* line 177: */
AVNASIM_amglobal(DENASIM_ws, ONFASIM_indirect);
...
IUNASIM_amnot();
 /* line 180: */
YFNASIM_newlabel(  &ODXASIM );
PDXASIM_samelabel = ODXASIM;
 /* line 181: */
IWNASIM_amjumpno(0, PDXASIM_samelabel);
 /* line 182: */
WUNASIM_amlocal(1);
 /* line 183: */
QUNASIM_ampushint(0);
...
FVNASIM_amstore(GENASIM_sizeunit, ONFASIM_indirect);
 /* line 185: */
 /* line 186: */
NWNASIM_amlabel(2, PDXASIM_samelabel);
} 
 /* line 187: */
QUNASIM_ampushint(1);
 /* line 188: */
...
USNASIM_amsub();
 /* line 203: */
UVNASIM_amitos((CENASIM_bitsperbyte*GENASIM_sizeunit));
 /* line 208: */
 /* line 209: */
 /* line 210: */
 /* line 212: */
JCXASIM_filloutputarea((IDXASIM_outputoffset+GENASIM_sizeunit), GENASIM_sizeunit, (EDXASIM_outputsize-GENASIM_sizeunit), 2);
} 
else
{ 
WUNASIM_amlocal(0);
...
GUNASIM_amor();
 ...
 /* line 228: */
XVNASIM_amutos((CENASIM_bitsperbyte*GENASIM_sizeunit));
 /* line 232: */
 /* line 233: */
JCXASIM_filloutputarea((IDXASIM_outputoffset+GENASIM_sizeunit), GENASIM_sizeunit, (EDXASIM_outputsize-GENASIM_sizeunit), 3);
 /* line 234: */
 /* line 235: */
TUNASIM_amdrop(1);
} 
 /* line 236: */
EWNASIM_amjump(NDXASIM_end);
 /* line 239: */
NWNASIM_amlabel(1, LDXASIM_outputquery);
 /* line 240: */
SDXASIM_datasize = YGCASIM_lookuptypesize(Outputtype);
 /* line 241: */
QUNASIM_ampushint(IDXASIM_outputoffset);
 /* line 242: */
QUNASIM_ampushint(SDXASIM_datasize);
 /* line 243: */
YLFASIM_label( UDXASIM, &VDXASIM );
BXNASIM_amcall(3, VDXASIM);
 /* line 244: */
TUNASIM_amdrop(2);
 /* line 247: */
NWNASIM_amlabel(1, NDXASIM_end);
 /* line 248: */
ZOPASIM_translateendfunction(JDXASIM_fixedpartsize, 1);
 /* line 250: */
WDXASIM.Size = JDXASIM_fixedpartsize;
WDXASIM.Offset = IDXASIM_outputoffset;
 /* line 251: */
WDXASIM.Sort = IHCASIM_combinatorial;
XDXASIM = WDXASIM;
} 
A_PROC_EXIT(translatestring);
*ReturnedValue = (XDXASIM);
return;
} 
#undef NL
 /* line 1: */
 /* line 2: */
 /* line 5: */
void ACXASIM(void)   /* initialise DECS keamstring */
{ 
static A68_BOOL A_invoked = A68_FALSE;

/* --- Configuration information for this module */
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","/u/model/ella/oslib/assoc/mfiles","-dir","/u/model/ella/ostools/assoc/mfiles","-dir","/u/model/ella/transform/assoc/mfiles","-dir","./mfiles","-staredit","259R","./a68files/keamstring.a68",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/sim/assoc/./a68files/keamstring.a68";
A_config.translation_time = "Tue Apr  4 11:12:00 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "ZBXASIM (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 11:12:00 1995";
A_config.arguments = A_config_arguments;
A_config.environment = A_config_environment;
A_config.modinfo_files = A_config_modinfo_files;
A_PROC_ENTRY(DECS keamstring);
UEAALIB_a68config(LGAALIB_configinfo, ECXASIM);
 /* line 71: */
 /* line 128: */
 /* line 253: */
 /* line 255: */
 /* line 258: */
/*SKIP*/;
A_PROC_EXIT(DECS keamstring);
} 
#undef NL
/* end of translation of ./a68files/keamstring.a68 */
