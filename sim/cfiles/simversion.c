...
A_ISTRUCT(A68_CHAR ,14,A68t149);
typedef struct A68t149  A68_149 ;    /* STRUCT 14 CHAR */
A_ISTRUCT(A68_CHAR ,125,A68t150);
typedef struct A68t150  A68_150 ;    /* STRUCT 125 CHAR */
...
static A68_146   EAAASIM = {"$Id: simversion.a68,v 34.5 1995/03/29 14:01:46 ella Exp $"}; 
A_GISVEC(A68_VC ,FAAASIM,EAAASIM,57)
static A68_147   GAAASIM = {"Update 34.4"}; 
A_GISVEC(A68_VC ,HAAASIM,GAAASIM,11)
static A68_VC  IAAASIM_version_id;
static A68_148   JAAASIM = {"Release March 1995"}; 
A_GISVEC(A68_VC ,KAAASIM,JAAASIM,18)
static A68_VC  LAAASIM_version_msg;
static A68_149   MAAASIM = {"29-03-95 14:00"}; 
A_GISVEC(A68_VC ,NAAASIM,MAAASIM,14)
static A68_VC  OAAASIM_version_date;
static A68_149   RAAASIM = {"ELLA Simulator"}; 
A_GISVEC(A68_VC ,SAAASIM,RAAASIM,14)
static A68_150   TAAASIM = {"Please make a copy of your simulator input (.ela open interface) file and the ELLA sources used to make it and report details"}; 
A_GISVEC(A68_VC ,UAAASIM,TAAASIM,125)

A68_VOID  PAAASIM_simversion(A68_134  *ReturnedValue);

A68_VOID  PAAASIM_simversion(A68_134  *ReturnedValue)
{ 
A68_134  QAAASIM;  /* collateral clause result */
A68_134  VAAASIM;  /* clause result */
A_PROC_ENTRY(simversion);
QAAASIM.Name = SAAASIM;
QAAASIM.Version = IAAASIM_version_id;
QAAASIM.Date = OAAASIM_version_date;
 /* line 57: */
QAAASIM.Msg = LAAASIM_version_msg;
 /* line 59: */
QAAASIM.Sys_fault = UAAASIM;
VAAASIM = QAAASIM;
A_PROC_EXIT(simversion);
*ReturnedValue = (VAAASIM);
return;
} 
#undef NL
 /* line 1: */
 /* line 3: */
void BAAASIM(void)   /* initialise DECS simversion */
{ 
static A68_BOOL A_invoked = A68_FALSE;

/* --- Configuration information for this module */
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","/u/model/ella/oslib/assoc/mfiles","-dir","/u/model/ella/ostools/assoc/mfiles","-dir","/u/model/ella/transform/assoc/mfiles","-dir","./mfiles","-staredit","259R","./a68files/simversion.a68",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/sim/assoc/./a68files/simversion.a68";
A_config.translation_time = "Tue Apr  4 11:05:28 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "AAAASIM (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 11:05:28 1995";
A_config.arguments = A_config_arguments;
A_config.environment = A_config_environment;
A_config.modinfo_files = A_config_modinfo_files;
A_PROC_ENTRY(DECS simversion);
UEAALIB_a68config(LGAALIB_configinfo, FAAASIM);
 /* line 50: */
IAAASIM_version_id = HAAASIM;
 /* line 51: */
LAAASIM_version_msg = KAAASIM;
 /* line 52: */
OAAASIM_version_date = NAAASIM;
 /* line 54: */
 /* line 55: */
 /* line 60: */
A_PROC_EXIT(DECS simversion);
} 
#undef NL
/* end of translation of ./a68files/simversion.a68 */
