...
A_ISTRUCT(A68_CHAR ,55,A68t417);
typedef struct A68t417  A68_417 ;    /* STRUCT 55 CHAR */
...
static A68_417   HUAAEXT = {"$Id: revdinst.a68,v 34.2 1995/03/29 13:05:09 ella Exp $"}; 
A_GISVEC(A68_VC ,IUAAEXT,HUAAEXT,55)
A68_46  VUAAEXT_revdinst_options;
...
A_STATIC A68_VOID  KUAAEXT_generator(A68_BOOL  JUAAEXT_anonymous, A68_46  *ReturnedValue);

A_STATIC A68_VOID  OUAAEXT_generator(A68_BOOL  NUAAEXT_anonymous, A68_VC  *ReturnedValue);

A_STATIC A68_VOID  ZUAAEXT_fnbody_dinst(A68_248  Fbody, A68_360 * Tprocs, A68_354  *ReturnedValue);

A68_VOID  KVAAEXT_outer_revdinst(A68_261  Outer, A68_265 * Closure, A68_408  Options, A68_108  Msg, A68_358  *ReturnedValue);

A_STATIC A68_VOID  OVAAEXT_unit_proc(A68_176  U, A68_360 * Tprocs, A68_336  *ReturnedValue);

A68_VOID  IXAAEXT_transform_revdinst(A68_265 * Closure, A68_408  Options, A68_108  Msg, A68_359  *ReturnedValue);

A_STATIC A68_VOID  NXAAEXT_outer(A68_261  O, A68_360 * Tprocs, A68_358  *ReturnedValue, void *NonLocals);

A_STATIC A68_VOID  OUAAEXT_generator(A68_BOOL  NUAAEXT_anonymous, A68_VC  *ReturnedValue)
{ 
A68_VC  PUAAEXT;  /* clause result */
A68_VC  QUAAEXT;  /* OPERATORS - dynamic generator */
{ 
QUAAEXT.upb = 0 ;
( NUAAEXT_anonymous? A_VLOC(A68_CHAR ,QUAAEXT): A_VHEAP(A68_CHAR ,QUAAEXT) );
PUAAEXT = QUAAEXT;
} 
*ReturnedValue = (PUAAEXT);
return;
} 
#undef NL
...
A_STATIC A68_VOID  OVAAEXT_unit_proc(A68_176  U, A68_360 * Tprocs, A68_336  *ReturnedValue)
{ 
A68_176  PVAAEXT;  /* united object - for case conformity */
A68_193 * QVAAEXT_minst;
A68_379  RVAAEXT;  /* CALL */
A68_336  SVAAEXT;  /* avoid structure result */
A68_336  TVAAEXT_right;
A68_176  UVAAEXT;  /* united object - for case conformity */
A68_191 * VVAAEXT_ustr;
A68_BOOL  WVAAEXT;  /* optbool result */
A68_194  XVAAEXT;  /* collateral clause result */
A68_194 * YVAAEXT;  /* YIELD */
A68_194 * ZVAAEXT_dinst;
A68_336  AWAAEXT;  /* collateral clause result */
A68_176  BWAAEXT;  /* OPERATORS - mode -> union mode */
A68_336  CWAAEXT;  /* clause result */
A68_336  DWAAEXT;  /* collateral clause result */
A68_193  EWAAEXT;  /* collateral clause result */
A68_193 * FWAAEXT;  /* YIELD */
A68_176  GWAAEXT;  /* OPERATORS - mode -> union mode */
A68_336  HWAAEXT;  /* collateral clause result */
A68_336  IWAAEXT;  /* collateral clause result */
A68_193  JWAAEXT;  /* collateral clause result */
A68_193 * KWAAEXT;  /* YIELD */
A68_176  LWAAEXT;  /* OPERATORS - mode -> union mode */
A68_336  MWAAEXT;  /* collateral clause result */
A68_379  NWAAEXT;  /* CALL */
A68_336  OWAAEXT;  /* avoid structure result */
...
QVAAEXT_minst = (PVAAEXT.data.mode23);
 /* line 63: */
{ 
RVAAEXT = (*(&(Tprocs->Unit))) ;
A_CALLPROC(RVAAEXT,((*(&(QVAAEXT_minst->Right))), Tprocs, &SVAAEXT),((*(&(QVAAEXT_minst->Right))), Tprocs, &SVAAEXT,(RVAAEXT).nonlocals));
TVAAEXT_right = SVAAEXT;
 /* line 65: */
 /* line 66: */
UVAAEXT = TVAAEXT_right.U ;
switch ( UVAAEXT.mode )
{ 
case 21: /* REF STRUCT(MODE176,REF MODE191)  */
VVAAEXT_ustr = (UVAAEXT.data.mode21);
 /* line 67: */
{ 
 /* line 68: */
WVAAEXT = ((*(&(VVAAEXT_ustr->Rest)))!=IAAATRN_nilustr);
if ( WVAAEXT )
{ /* line 69: */
WVAAEXT = ((*(&((*(&(VVAAEXT_ustr->Rest)))->Rest)))==IAAATRN_nilustr);
}
 /* line 70: */
if ( WVAAEXT )
{ 
 /* line 71: */
XVAAEXT.Left = (*(&(VVAAEXT_ustr->Elem)));
XVAAEXT.Inst = (*(&(QVAAEXT_minst->Inst)));
XVAAEXT.Right = (*(&((*(&(VVAAEXT_ustr->Rest)))->Elem)));
YVAAEXT = A_HEAP(A68_194 ) ;
(*YVAAEXT) = XVAAEXT ;
ZVAAEXT_dinst = YVAAEXT;
 /* line 72: */
AWAAEXT.U = A_UNITE(BWAAEXT,mode24,24,ZVAAEXT_dinst);
 /* line 73: */
 /* line 74: */
AWAAEXT.C = A68_TRUE;
CWAAEXT = AWAAEXT;
...
if ( TVAAEXT_right.C )
{ 
EWAAEXT.Inst = (*(&(QVAAEXT_minst->Inst)));
EWAAEXT.Right = TVAAEXT_right.U;
FWAAEXT = A_HEAP(A68_193 ) ;
(*FWAAEXT) = EWAAEXT ;
DWAAEXT.U = A_UNITE(GWAAEXT,mode23,23,FWAAEXT);
 /* line 75: */
DWAAEXT.C = A68_TRUE;
CWAAEXT = DWAAEXT;
} 
...
if ( TVAAEXT_right.C )
{ 
JWAAEXT.Inst = (*(&(QVAAEXT_minst->Inst)));
JWAAEXT.Right = TVAAEXT_right.U;
KWAAEXT = A_HEAP(A68_193 ) ;
(*KWAAEXT) = JWAAEXT ;
IWAAEXT.U = A_UNITE(LWAAEXT,mode23,23,KWAAEXT);
 /* line 81: */
IWAAEXT.C = A68_TRUE;
CWAAEXT = IWAAEXT;
} 
...
default: 
 /* line 87: */
NWAAEXT = (*(&(AWLATRN_nulltprocs->Unit))) ;
A_CALLPROC(NWAAEXT,(U, Tprocs, &OWAAEXT),(U, Tprocs, &OWAAEXT,(NWAAEXT).nonlocals));
CWAAEXT = OWAAEXT;
break;
} 
A_PROC_EXIT(unit_proc);
*ReturnedValue = (CWAAEXT);
return;
} 
#undef NL

A_STATIC A68_VOID  NXAAEXT_outer(A68_261  O, A68_360 * Tprocs, A68_358  *ReturnedValue, void *NonLocals)
#define NL(x) (((OXAAEXT_outer *)NonLocals)->x)
{ 
A68_358  PXAAEXT;  /* clause result */
A68_358  QXAAEXT;  /* avoid structure result */
A_PROC_ENTRY(outer);
 /* line 103: */
KVAAEXT_outer_revdinst( O, NL(Closure), NL(Options), NL(Msg), &QXAAEXT );
PXAAEXT = QXAAEXT;
A_PROC_EXIT(outer);
*ReturnedValue = (PXAAEXT);
return;
} 
#undef NL
...
A_STATIC A68_VOID  KUAAEXT_generator(A68_BOOL  JUAAEXT_anonymous, A68_46  *ReturnedValue)
{ 
A68_46  MUAAEXT;  /* OPERATORS - dynamic generator */
A68_419  LUAAEXT_anonymous;
A68_418 * RUAAEXT_anonymous;
A68_INT  SUAAEXT;  /* forall loop counter */
A68_VC  TUAAEXT;  /* avoid structure result */
A68_46  UUAAEXT;  /* clause result */
{ 
MUAAEXT.upb = 0 ;
( JUAAEXT_anonymous? A_VLOC(A68_VC ,MUAAEXT): A_VHEAP(A68_VC ,MUAAEXT) );
LUAAEXT_anonymous = MUAAEXT;
SUAAEXT = (*(&LUAAEXT_anonymous)).upb -1;
RUAAEXT_anonymous = (*(&LUAAEXT_anonymous)).data;
for (;SUAAEXT-- >= 0;
(RUAAEXT_anonymous++
) )
{
OUAAEXT_generator( JUAAEXT_anonymous, &TUAAEXT );
(*RUAAEXT_anonymous) = TUAAEXT;
}
UUAAEXT = LUAAEXT_anonymous;
} 
*ReturnedValue = (UUAAEXT);
return;
} 
#undef NL
...
A_STATIC A68_VOID  ZUAAEXT_fnbody_dinst(A68_248  Fbody, A68_360 * Tprocs, A68_354  *ReturnedValue)
{ 
A68_248  AVAAEXT;  /* united object - for case conformity */
A68_221 * BVAAEXT_ut;
A68_354  CVAAEXT;  /* clause result */
A68_397  DVAAEXT;  /* CALL */
A68_354  EVAAEXT;  /* avoid structure result */
A68_354  FVAAEXT;  /* collateral clause result */
A_PROC_ENTRY(fnbody_dinst);
 /* line 48: */
 /* line 49: */
AVAAEXT = Fbody ;
switch ( AVAAEXT.mode )
...
BVAAEXT_ut = (AVAAEXT.data.mode1);
 /* line 50: */
DVAAEXT = (*(&(AWLATRN_nulltprocs->Fnbody))) ;
A_CALLPROC(DVAAEXT,(Fbody, Tprocs, &EVAAEXT),(Fbody, Tprocs, &EVAAEXT,(DVAAEXT).nonlocals));
CVAAEXT = EVAAEXT;
break;
default: 
FVAAEXT.F = Fbody;
...
A_PROC_EXIT(fnbody_dinst);
*ReturnedValue = (CVAAEXT);
return;
} 
#undef NL
 /* line 54: */
...
{ 
A68_255 * LVAAEXT_env;
A68_421  PWAAEXT;  /* collateral clause result */
A68_405  QWAAEXT;  /* OPERATORS - mode -> union mode */
A68_364  RWAAEXT;  /* procedure value */
A68_405  SWAAEXT;  /* OPERATORS - mode -> union mode */
A68_370  TWAAEXT;  /* procedure value */
A68_405  UWAAEXT;  /* OPERATORS - mode -> union mode */
A68_397  VWAAEXT;  /* YIELD */
A68_397  WWAAEXT;  /* procedure value */
A68_405  XWAAEXT;  /* OPERATORS - mode -> union mode */
A68_379  YWAAEXT;  /* YIELD */
A68_379  ZWAAEXT;  /* procedure value */
A68_404  AXAAEXT;  /* OPERATORS - istruct -> vector */
A68_360 * BXAAEXT_newtprocs;
A68_358  CXAAEXT;  /* clause result */
A68_401  DXAAEXT;  /* CALL */
A68_358  EXAAEXT;  /* avoid structure result */
A_PROC_ENTRY(outer_revdinst);
 /* line 57: */
 /* line 58: */
{ 
LVAAEXT_env = Outer.Environ;
 /* line 60: */
 /* line 89: */
 /* line 90: */
RWAAEXT.fn.fn_global = IWLATRN_null_formula;
RWAAEXT.nonlocals = A68_NIL;
PWAAEXT.data[0] = A_UNITE(QWAAEXT,mode4,4,RWAAEXT);
 /* line 91: */
TWAAEXT.fn.fn_global = NWLATRN_null_type;
TWAAEXT.nonlocals = A68_NIL;
PWAAEXT.data[1] = A_UNITE(SWAAEXT,mode10,10,TWAAEXT);
 /* line 92: */
WWAAEXT.fn.fn_global = ZUAAEXT_fnbody_dinst;
WWAAEXT.nonlocals = A68_NIL;
VWAAEXT = WWAAEXT ;
PWAAEXT.data[2] = A_UNITE(UWAAEXT,mode37,37,VWAAEXT);
ZWAAEXT.fn.fn_global = OVAAEXT_unit_proc;
ZWAAEXT.nonlocals = A68_NIL;
YWAAEXT = ZWAAEXT ;
PWAAEXT.data[3] = A_UNITE(XWAAEXT,mode19,19,YWAAEXT);
BXAAEXT_newtprocs = THJATRN_make_newtprocs(AWLATRN_nulltprocs, A_HISVEC(AXAAEXT,PWAAEXT,4,A68_405 ));
 /* line 94: */
 /* line 95: */
DXAAEXT = (*(&(AWLATRN_nulltprocs->Outer))) ;
A_CALLPROC(DXAAEXT,(Outer, BXAAEXT_newtprocs, &EXAAEXT),(Outer, BXAAEXT_newtprocs, &EXAAEXT,(DXAAEXT).nonlocals));
CXAAEXT = EXAAEXT;
} 
A_PROC_EXIT(outer_revdinst);
*ReturnedValue = (CXAAEXT);
return;
} 
#undef NL
 /* line 99: */
...
A68_VOID  IXAAEXT_transform_revdinst(A68_265 * Closure, A68_408  Options, A68_108  Msg, A68_359  *ReturnedValue)
{ 
A68_401  MXAAEXT_outer;   /* proc value of non-global proc */
A68_405  RXAAEXT;  /* OPERATORS - mode -> union mode */
A68_401  SXAAEXT;  /* YIELD */
A68_404  TXAAEXT;  /* OPERATORS - scalar -> [] or VEC[] */
A68_360 * UXAAEXT_newtprocs;
A68_359  VXAAEXT;  /* clause result */
A68_402  WXAAEXT;  /* CALL */
A68_359  XXAAEXT;  /* avoid structure result */
A_PROC_ENTRY(transform_revdinst);
 /* line 101: */
 /* line 102: */
{ 
A_CLOSURE( MXAAEXT_outer, NXAAEXT_outer, OXAAEXT_outer );
(( OXAAEXT_outer * ) ( MXAAEXT_outer.nonlocals )) -> Closure = Closure;
(( OXAAEXT_outer * ) ( MXAAEXT_outer.nonlocals )) -> Options = Options;
(( OXAAEXT_outer * ) ( MXAAEXT_outer.nonlocals )) -> Msg = Msg;
 /* line 105: */
SXAAEXT = MXAAEXT_outer ;
UXAAEXT_newtprocs = THJATRN_make_newtprocs(AWLATRN_nulltprocs, A_HVEC(TXAAEXT,A_UNITE(RXAAEXT,mode41,41,SXAAEXT),A68_405 ));
 /* line 107: */
 /* line 108: */
WXAAEXT = (*(&(AWLATRN_nulltprocs->Closure))) ;
A_CALLPROC(WXAAEXT,(Closure, UXAAEXT_newtprocs, Msg, &XXAAEXT),(Closure, UXAAEXT_newtprocs, Msg, &XXAAEXT,(WXAAEXT).nonlocals));
VXAAEXT = XXAAEXT;
} 
A_PROC_EXIT(transform_revdinst);
*ReturnedValue = (VXAAEXT);
return;
} 
#undef NL
 /* line 1: */
 /* line 2: */
 /* line 4: */
void EUAAEXT(void)   /* initialise DECS revdinst */
{ 
static A68_BOOL A_invoked = A68_FALSE;

/* --- Configuration information for this module */
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","/u/model/ella/oslib/assoc/mfiles","-dir","/u/model/ella/ostools/assoc/mfiles","-dir","/u/model/ella/transform/assoc/mfiles","-dir","./mfiles","-staredit","259","./a68files/revdinst.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","/u/model/ella/ostools/assoc/mfiles/options.m","/u/model/ella/transform/assoc/mfiles/transformprocs.m","/u/model/ella/transform/assoc/mfiles/modeprocs.m","/u/model/ella/transform/assoc/mfiles/assmodes.m","/u/model/ella/osif/assoc/mfiles/messageproc.m","/u/model/ella/ostools/assoc/mfiles/basics.m","/u/model/ella/oslib/assoc/mfiles/putstrings.m",""};
static A_CONFIG_INFO A_config;
/* --- end of configuration information */
A68_46  WUAAEXT;  /* avoid structure result */
if( A_invoked ) return;
A_invoked = A68_TRUE;
...
A_config.source_file = "/import/hazel/home/export/model/ella/external/assoc/./a68files/revdinst.a68";
A_config.translation_time = "Tue Apr  4 11:37:41 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "DUAAEXT (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 11:37:41 1995";
A_config.arguments = A_config_arguments;
A_config.environment = A_config_environment;
A_config.modinfo_files = A_config_modinfo_files;
A_PROC_ENTRY(DECS revdinst);
UEAALIB_a68config(LGAALIB_configinfo, IUAAEXT);
 /* line 44: */
KUAAEXT_generator( A68_TRUE, &WUAAEXT );
VUAAEXT_revdinst_options = WUAAEXT;
 /* line 47: */
 /* line 53: */
 /* line 98: */
 /* line 110: */
 ...
 /* line 112: */
/*SKIP*/;
A_PROC_EXIT(DECS revdinst);
} 
#undef NL
/* end of translation of ./a68files/revdinst.a68 */
