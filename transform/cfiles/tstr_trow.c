...
A_ISTRUCT(A68_CHAR ,56,A68t478);
typedef struct A68t478  A68_478 ;    /* STRUCT 56 CHAR */

A_PROCEDURE(A68_VOID ,A68t479,(struct A68t265 *,struct A68t108 ,struct A68t359 *),(struct A68t265 *,struct A68t108 ,struct A68t359 *,void *));
typedef struct A68t479  A68_479 ;    /* PROC(REF MODE265,MODE108) MODE359 */

A_PROCEDURE(A68_VOID ,A68t480,(A68_BOOL ,struct A68t54 *),(A68_BOOL ,struct A68t54 *,void *));
typedef struct A68t480  A68_480 ;    /* PROC(BOOL) MODE54 */

A_PROCEDURE(struct A68t265 **,A68t481,(void),(void *));
typedef struct A68t481  A68_481 ;    /* PROC REF REF MODE265 */
A_ISTRUCT(struct A68t405 ,3,A68t482);
typedef struct A68t482  A68_482 ;    /* STRUCT 3 MODE405 */
...
static A68_478   ZLQBTRN = {"$Id: tstr_trow.a68,v 34.2 1995/03/29 13:02:42 ella Exp $"}; 
A_GISVEC(A68_VC ,AMQBTRN,ZLQBTRN,56)
...
typedef struct   /* env of non-global proc */
{
A68_BOOL * HMQBTRN_closure_changed;
A68_265 ** GMQBTRN_thisclosure;
A68_108  Msg;
A68_262 ** IMQBTRN_closureptr;
} VMQBTRN_newclosure;
typedef struct   /* env of non-global proc */
{
A68_54  PMQBTRN_closuretags;
} ANQBTRN_is_modified;
typedef struct   /* env of non-global proc */
{
A68_265 ** GMQBTRN_thisclosure;
A68_475  YMQBTRN_is_modified;
A68_108  Msg;
A68_54  PMQBTRN_closuretags;
} GNQBTRN_outer_transform;
typedef struct   /* env of non-global proc */
{
A68_461 * HNQBTRN_ec;
} NNQBTRN_tstr_trow;

A68_VOID  DMQBTRN_transform_tstr_trow(A68_265 * Closure, A68_108  Msg, A68_359  *ReturnedValue);

A_STATIC A68_VOID  LMQBTRN_generator(A68_BOOL  JMQBTRN_anonymous, A68_54  *ReturnedValue, void *NonLocals);

A_STATIC A68_265 ** UMQBTRN_newclosure(void *NonLocals);

A_STATIC A68_BOOL  ZMQBTRN_is_modified(A68_INT  Clno, void *NonLocals);

A_STATIC A68_VOID  FNQBTRN_outer_transform(A68_261  Outer, A68_360 * Otprocs, A68_358  *ReturnedValue, void *NonLocals);

A_STATIC A68_VOID  MNQBTRN_tstr_trow(A68_154  Ty, A68_360 * Tprocs, A68_327  *ReturnedValue, void *NonLocals);

A_STATIC A68_VOID  MNQBTRN_tstr_trow(A68_154  Ty, A68_360 * Tprocs, A68_327  *ReturnedValue, void *NonLocals)
#define NL(x) (((NNQBTRN_tstr_trow *)NonLocals)->x)
{ 
A68_154  ONQBTRN;  /* united object - for case conformity */
A68_157 * PNQBTRN_ts;
A68_369  QNQBTRN;  /* CALL */
A68_326  RNQBTRN;  /* avoid structure result */
A68_326  SNQBTRN_tc;
A68_154  TNQBTRN;  /* avoid structure result */
A68_154  UNQBTRN_first;
A68_157 * VNQBTRN_tstr;
A68_BOOL  WNQBTRN_same;
A68_INT  XNQBTRN_count;
A68_BOOL  YNQBTRN;  /* optbool result */
A68_154  ZNQBTRN;  /* avoid structure result */
A68_139  AOQBTRN;  /* collateral clause result */
A68_139 * COQBTRN;  /* YIELD */
A68_139 * BOQBTRN_size;
A68_327  DOQBTRN;  /* collateral clause result */
A68_156  EOQBTRN;  /* collateral clause result */
A68_138  FOQBTRN;  /* OPERATORS - mode -> union mode */
A68_156 * GOQBTRN;  /* YIELD */
A68_154  HOQBTRN;  /* OPERATORS - mode -> union mode */
A68_327  IOQBTRN;  /* clause result */
A68_327  JOQBTRN;  /* collateral clause result */
A68_154  KOQBTRN;  /* OPERATORS - mode -> union mode */
A68_157 * LOQBTRN;  /* YIELD */
A68_370  MOQBTRN;  /* CALL */
A68_327  NOQBTRN;  /* avoid structure result */
...
PNQBTRN_ts = (ONQBTRN.data.mode3);
 /* line 75: */
{ 
QNQBTRN = (*(&(Tprocs->Tstr))) ;
A_CALLPROC(QNQBTRN,(PNQBTRN_ts, Tprocs, &RNQBTRN),(PNQBTRN_ts, Tprocs, &RNQBTRN,(QNQBTRN).nonlocals));
SNQBTRN_tc = RNQBTRN;
 /* line 76: */
DDOATRN_simplify_type( (*(&(SNQBTRN_tc.T->Elem))), (*(&(NL(HNQBTRN_ec)->E))), &TNQBTRN );
UNQBTRN_first = TNQBTRN;
 /* line 77: */
VNQBTRN_tstr = (*(&(SNQBTRN_tc.T->Rest)));
 /* line 78: */
WNQBTRN_same = A68_TRUE;
 /* line 79: */
XNQBTRN_count = 1;
 /* line 80: */
for ( ;; )
{ 
 /* line 81: */
YNQBTRN = (VNQBTRN_tstr!=GAAATRN_niltstr);
if ( YNQBTRN )
{YNQBTRN = WNQBTRN_same;
}
if ( !(YNQBTRN) ) break;
 /* line 82: */
 /* line 83: */
DDOATRN_simplify_type( (*(&(VNQBTRN_tstr->Elem))), (*(&(NL(HNQBTRN_ec)->E))), &ZNQBTRN );
if ( !NEOATRN_check_types(UNQBTRN_first, ZNQBTRN, (*(&(NL(HNQBTRN_ec)->E))), (*(&(NL(HNQBTRN_ec)->E))), A68_FALSE) )
{ 
 /* line 84: */
WNQBTRN_same = A68_FALSE;
} 
else
{ 
 /* line 85: */
XNQBTRN_count+=1;
 ...
 /* line 86: */
 /* line 87: */
VNQBTRN_tstr = (*(&(VNQBTRN_tstr->Rest)));
}
 /* line 88: */
 /* line 89: */
if ( WNQBTRN_same )
{ 
AOQBTRN.Int = XNQBTRN_count;
AOQBTRN.Text = TTCAOST_nullid;
COQBTRN = A_HEAP(A68_139 ) ;
(*COQBTRN) = AOQBTRN ;
BOQBTRN_size = COQBTRN;
 /* line 90: */
EOQBTRN.Size = A_UNITE(FOQBTRN,mode1,1,BOQBTRN_size);
EOQBTRN.Elem = UNQBTRN_first;
GOQBTRN = A_HEAP(A68_156 ) ;
(*GOQBTRN) = EOQBTRN ;
DOQBTRN.T = A_UNITE(HOQBTRN,mode2,2,GOQBTRN);
 /* line 91: */
DOQBTRN.C = A68_TRUE;
IOQBTRN = DOQBTRN;
} 
...
{ 
LOQBTRN = SNQBTRN_tc.T ;
JOQBTRN.T = A_UNITE(KOQBTRN,mode3,3,LOQBTRN);
 /* line 92: */
 /* line 93: */
 /* line 94: */
JOQBTRN.C = SNQBTRN_tc.C;
IOQBTRN = JOQBTRN;
} 
} 
break;
default: 
 /* line 95: */
MOQBTRN = (*(&(AWLATRN_nulltprocs->Type))) ;
A_CALLPROC(MOQBTRN,(Ty, Tprocs, &NOQBTRN),(Ty, Tprocs, &NOQBTRN,(MOQBTRN).nonlocals));
IOQBTRN = NOQBTRN;
break;
} 
A_PROC_EXIT(tstr_trow);
*ReturnedValue = (IOQBTRN);
return;
} 
#undef NL

A_STATIC A68_VOID  LMQBTRN_generator(A68_BOOL  JMQBTRN_anonymous, A68_54  *ReturnedValue, void *NonLocals)
#define NL(x) (((MMQBTRN_generator *)NonLocals)->x)
{ 
A68_54  NMQBTRN;  /* clause result */
A68_54  OMQBTRN;  /* OPERATORS - dynamic generator */
{ 
OMQBTRN.upb = ZKCATRN_maxclosureno(NL(Closure)) ;
( JMQBTRN_anonymous? A_VLOC(A68_BOOL ,OMQBTRN): A_VHEAP(A68_BOOL ,OMQBTRN) );
NMQBTRN = OMQBTRN;
} 
*ReturnedValue = (NMQBTRN);
return;
} 
#undef NL

A_STATIC A68_265 ** UMQBTRN_newclosure(void *NonLocals)
#define NL(x) (((VMQBTRN_newclosure *)NonLocals)->x)
{ 
A68_265 ** WMQBTRN;  /* clause result */
A_PROC_ENTRY(newclosure);
{ 
 /* line 57: */
if ( !(*NL(HMQBTRN_closure_changed)) )
{ 
(*NL(HMQBTRN_closure_changed)) = A68_TRUE;
 /* line 58: */
(*NL(GMQBTRN_thisclosure)) = DPCATRN_copy_closure((*NL(GMQBTRN_thisclosure)), NL(Msg));
 /* line 59: */
 /* line 60: */
 /* line 61: */
(*NL(IMQBTRN_closureptr)) = ELCATRN_find_outers((*(&((&((*NL(IMQBTRN_closureptr))->Outer))->Closureno))), (*NL(GMQBTRN_thisclosure)), NL(Msg));
} 
 /* line 62: */
 /* line 63: */
WMQBTRN = NL(GMQBTRN_thisclosure);
} 
...
A_STATIC A68_BOOL  ZMQBTRN_is_modified(A68_INT  Clno, void *NonLocals)
#define NL(x) (((ANQBTRN_is_modified *)NonLocals)->x)
{ 
A68_BOOL  BNQBTRN;  /* clause result */
A_PROC_ENTRY(is_modified);
BNQBTRN = (*(&A_VINDEX(NL(PMQBTRN_closuretags),Clno)));
...
A_STATIC A68_VOID  FNQBTRN_outer_transform(A68_261  Outer, A68_360 * Otprocs, A68_358  *ReturnedValue, void *NonLocals)
#define NL(x) (((GNQBTRN_outer_transform *)NonLocals)->x)
{ 
A68_461  INQBTRN;  /* avoid structure result */
A68_461  HNQBTRN_ec;
A68_370  LNQBTRN_tstr_trow;   /* proc value of non-global proc */
A68_482  OOQBTRN;  /* collateral clause result */
A68_405  POQBTRN;  /* OPERATORS - mode -> union mode */
A68_364  QOQBTRN;  /* procedure value */
A68_405  ROQBTRN;  /* OPERATORS - mode -> union mode */
A68_361  SOQBTRN;  /* procedure value */
A68_405  TOQBTRN;  /* OPERATORS - mode -> union mode */
A68_370  UOQBTRN;  /* YIELD */
A68_404  VOQBTRN;  /* OPERATORS - istruct -> vector */
A68_360 * WOQBTRN_newtprocs;
A68_374  XOQBTRN;  /* CALL */
A68_258  YOQBTRN;  /* OPERATORS - simple index */
A68_INT  ZOQBTRN;  /* YIELD */
A68_331  APQBTRN;  /* avoid structure result */
A68_331  BPQBTRN_tdecc;
A68_INT  CPQBTRN;  /* YIELD */
A68_BOOL * DPQBTRN;  /* YIELD */
A68_258  EPQBTRN;  /* avoid structure result */
A68_INT  FPQBTRN;  /* YIELD */
A68_169 ** GPQBTRN;  /* YIELD */
A68_INT  HPQBTRN_i;
A68_INT  IPQBTRN;  /* to part of loop */
A68_400  JPQBTRN;  /* CALL */
A68_260  KPQBTRN;  /* OPERATORS - simple index */
A68_357  LPQBTRN;  /* avoid structure result */
A68_357  MPQBTRN_fdecc;
A68_260  NPQBTRN;  /* avoid structure result */
A68_252 ** OPQBTRN;  /* YIELD */
A68_358  PPQBTRN;  /* collateral clause result */
A68_358  QPQBTRN;  /* clause result */
A68_358  RPQBTRN;  /* collateral clause result */
A_PROC_ENTRY(outer_transform);
 /* line 68: */
 /* line 69: */
{ 
 /* line 70: */
FLMBTRN_update_bodies( Outer.Environ, (*NL(GMQBTRN_thisclosure)), NL(YMQBTRN_is_modified), NL(Msg), &INQBTRN );
HNQBTRN_ec = INQBTRN;
 /* line 72: */
A_CLOSURE( LNQBTRN_tstr_trow, MNQBTRN_tstr_trow, NNQBTRN_tstr_trow );
(( NNQBTRN_tstr_trow * ) ( LNQBTRN_tstr_trow.nonlocals )) -> HNQBTRN_ec = (&HNQBTRN_ec);
 /* line 97: */
 /* line 98: */
QOQBTRN.fn.fn_global = IWLATRN_null_formula;
QOQBTRN.nonlocals = A68_NIL;
OOQBTRN.data[0] = A_UNITE(POQBTRN,mode4,4,QOQBTRN);
 /* line 99: */
SOQBTRN.fn.fn_global = DWLATRN_null_attr;
SOQBTRN.nonlocals = A68_NIL;
OOQBTRN.data[1] = A_UNITE(ROQBTRN,mode1,1,SOQBTRN);
UOQBTRN = LNQBTRN_tstr_trow ;
OOQBTRN.data[2] = A_UNITE(TOQBTRN,mode10,10,UOQBTRN);
WOQBTRN_newtprocs = THJATRN_make_newtprocs(AWLATRN_nulltprocs, A_HISVEC(VOQBTRN,OOQBTRN,3,A68_405 ));
 /* line 101: */
 /* line 102: */
if ( (Outer.Sort==TKAATRN_outertype) )
{ 
 /* line 103: */
XOQBTRN = (*(&(WOQBTRN_newtprocs->Typedec))) ;
YOQBTRN = (*(&((*(&((&HNQBTRN_ec)->E)))->Types))) ;
ZOQBTRN = 1 ;
A_CALLPROC(XOQBTRN,((*(&A_VINDEX(YOQBTRN,ZOQBTRN))), WOQBTRN_newtprocs, &APQBTRN),((*(&A_VINDEX(YOQBTRN,ZOQBTRN))), WOQBTRN_newtprocs, &APQBTRN,(XOQBTRN).nonlocals));
BPQBTRN_tdecc = APQBTRN;
 /* line 104: */
 /* line 105: */
if ( BPQBTRN_tdecc.C )
{ 
CPQBTRN = Outer.Closureno ;
DPQBTRN = (&A_VINDEX(NL(PMQBTRN_closuretags),CPQBTRN)) ;
(*DPQBTRN) = A68_TRUE;
 /* line 106: */
 /* line 107: */
 /* line 108: */
AIMBTRN_newtypes( (&HNQBTRN_ec), &EPQBTRN );
FPQBTRN = 1 ;
GPQBTRN = (&A_VINDEX(EPQBTRN,FPQBTRN)) ;
(*GPQBTRN) = BPQBTRN_tdecc.T;
} 
} 
else
{ 
...
{ 
 /* line 110: */
IPQBTRN = (*(&((*(&((&HNQBTRN_ec)->E)))->Fns))).upb;
for ( HPQBTRN_i = 1;
HPQBTRN_i <= IPQBTRN;
HPQBTRN_i += 1 )
{ 
 /* line 111: */
JPQBTRN = (*(&(WOQBTRN_newtprocs->Fndec))) ;
KPQBTRN = (*(&((*(&((&HNQBTRN_ec)->E)))->Fns))) ;
A_CALLPROC(JPQBTRN,((*(&A_VINDEX(KPQBTRN,HPQBTRN_i))), WOQBTRN_newtprocs, &LPQBTRN),((*(&A_VINDEX(KPQBTRN,HPQBTRN_i))), WOQBTRN_newtprocs, &LPQBTRN,(JPQBTRN).nonlocals));
MPQBTRN_fdecc = LPQBTRN;
 /* line 112: */
 /* line 113: */
if ( MPQBTRN_fdecc.C )
{ 
 /* line 114: */
 /* line 115: */
AJMBTRN_newfns( (&HNQBTRN_ec), &NPQBTRN );
OPQBTRN = (&A_VINDEX(NPQBTRN,HPQBTRN_i)) ;
(*OPQBTRN) = MPQBTRN_fdecc.F;
} 
}
 /* line 116: */
} 
 ...
 /* line 118: */
MLJATRN_discard_tprocs(WOQBTRN_newtprocs);
 /* line 120: */
 /* line 121: */
if ( (*(&((&HNQBTRN_ec)->C))) )
{ 
PPQBTRN.O.Closureno = Outer.Closureno;
PPQBTRN.O.Sort = Outer.Sort;
PPQBTRN.O.Environ = (*(&((&HNQBTRN_ec)->E)));
 /* line 122: */
PPQBTRN.C = A68_TRUE;
QPQBTRN = PPQBTRN;
} 
...
A68_VOID  DMQBTRN_transform_tstr_trow(A68_265 * Closure, A68_108  Msg, A68_359  *ReturnedValue)
{ 
A68_359  EMQBTRN;  /* collateral clause result */
A68_359  FMQBTRN_result;
A68_265 ** GMQBTRN_thisclosure;
A68_BOOL * HMQBTRN_closure_changed;
A68_262 * IMQBTRN_closureptr;
A68_480  KMQBTRN_generator;   /* proc value of non-global proc */
A68_54  QMQBTRN;  /* avoid structure result */
A68_54  PMQBTRN_closuretags;
A68_BOOL * RMQBTRN_ct;
A68_INT  SMQBTRN;  /* forall loop counter */
A68_481  TMQBTRN_newclosure;   /* proc value of non-global proc */
A68_475  YMQBTRN_is_modified;   /* proc value of non-global proc */
A68_401  ENQBTRN_outer_transform;   /* proc value of non-global proc */
A68_405  SPQBTRN;  /* OPERATORS - mode -> union mode */
A68_401  TPQBTRN;  /* YIELD */
A68_404  UPQBTRN;  /* OPERATORS - scalar -> [] or VEC[] */
A68_360 * VPQBTRN_newtprocs;
A68_401  WPQBTRN;  /* CALL */
A68_358  XPQBTRN;  /* avoid structure result */
A68_358  YPQBTRN_oc;
A68_261 * ZPQBTRN;  /* YIELD */
A68_359  AQQBTRN;  /* clause result */
A_PROC_ENTRY(transform_tstr_trow);
 /* line 47: */
 /* line 48: */
{ 
EMQBTRN.Cl = Closure;
EMQBTRN.C = A68_FALSE;
FMQBTRN_result = EMQBTRN;
 /* line 49: */
GMQBTRN_thisclosure = (&((&FMQBTRN_result)->Cl));
 /* line 50: */
HMQBTRN_closure_changed = (&((&FMQBTRN_result)->C));
 /* line 51: */
IMQBTRN_closureptr = (*(&((*GMQBTRN_thisclosure)->Outers)));
 /* line 52: */
A_CLOSURE( KMQBTRN_generator, LMQBTRN_generator, MMQBTRN_generator );
(( MMQBTRN_generator * ) ( KMQBTRN_generator.nonlocals )) -> Closure = Closure;
A_CALLPROC(KMQBTRN_generator,(A68_TRUE, &QMQBTRN),(A68_TRUE, &QMQBTRN,(KMQBTRN_generator).nonlocals));
PMQBTRN_closuretags = QMQBTRN;
 /* line 53: */
SMQBTRN = PMQBTRN_closuretags.upb -1;
RMQBTRN_ct = PMQBTRN_closuretags.data;
for (;SMQBTRN-- >= 0;
(RMQBTRN_ct++
) )
{
(*RMQBTRN_ct) = A68_FALSE;
}
 /* line 55: */
 /* line 56: */
A_CLOSURE( TMQBTRN_newclosure, UMQBTRN_newclosure, VMQBTRN_newclosure );
(( VMQBTRN_newclosure * ) ( TMQBTRN_newclosure.nonlocals )) -> HMQBTRN_closure_changed = HMQBTRN_closure_changed;
(( VMQBTRN_newclosure * ) ( TMQBTRN_newclosure.nonlocals )) -> GMQBTRN_thisclosure = GMQBTRN_thisclosure;
(( VMQBTRN_newclosure * ) ( TMQBTRN_newclosure.nonlocals )) -> Msg = Msg;
(( VMQBTRN_newclosure * ) ( TMQBTRN_newclosure.nonlocals )) -> IMQBTRN_closureptr = (&IMQBTRN_closureptr);
 /* line 65: */
A_CLOSURE( YMQBTRN_is_modified, ZMQBTRN_is_modified, ANQBTRN_is_modified );
(( ANQBTRN_is_modified * ) ( YMQBTRN_is_modified.nonlocals )) -> PMQBTRN_closuretags = PMQBTRN_closuretags;
 /* line 67: */
A_CLOSURE( ENQBTRN_outer_transform, FNQBTRN_outer_transform, GNQBTRN_outer_transform );
(( GNQBTRN_outer_transform * ) ( ENQBTRN_outer_transform.nonlocals )) -> GMQBTRN_thisclosure = GMQBTRN_thisclosure;
(( GNQBTRN_outer_transform * ) ( ENQBTRN_outer_transform.nonlocals )) -> YMQBTRN_is_modified = YMQBTRN_is_modified;
(( GNQBTRN_outer_transform * ) ( ENQBTRN_outer_transform.nonlocals )) -> Msg = Msg;
(( GNQBTRN_outer_transform * ) ( ENQBTRN_outer_transform.nonlocals )) -> PMQBTRN_closuretags = PMQBTRN_closuretags;
 /* line 128: */
 /* line 129: */
if ( ((*(&(Closure->Outers)))!=HBAATRN_nilouters) )
{ 
TPQBTRN = ENQBTRN_outer_transform ;
VPQBTRN_newtprocs = THJATRN_make_newtprocs(AWLATRN_nulltprocs, A_HVEC(UPQBTRN,A_UNITE(SPQBTRN,mode41,41,TPQBTRN),A68_405 ));
 /* line 131: */
for ( ;; )
{ 
 /* line 132: */
if ( !((IMQBTRN_closureptr!=HBAATRN_nilouters)) ) break;
SOAAOST_flt_if_interrupted(Msg);
 /* line 133: */
WPQBTRN = (*(&(VPQBTRN_newtprocs->Outer))) ;
A_CALLPROC(WPQBTRN,((*(&(IMQBTRN_closureptr->Outer))), VPQBTRN_newtprocs, &XPQBTRN),((*(&(IMQBTRN_closureptr->Outer))), VPQBTRN_newtprocs, &XPQBTRN,(WPQBTRN).nonlocals));
YPQBTRN_oc = XPQBTRN;
 /* line 134: */
if ( YPQBTRN_oc.C )
{ 
(*A_CALLPROC(TMQBTRN_newclosure,(),((TMQBTRN_newclosure).nonlocals)));
ZPQBTRN = (&(IMQBTRN_closureptr->Outer)) ;
(*ZPQBTRN) = YPQBTRN_oc.O;
} 
 /* line 135: */
 /* line 136: */
IMQBTRN_closureptr = (*(&(IMQBTRN_closureptr->Rest)));
}
 /* line 137: */
 /* line 138: */
MLJATRN_discard_tprocs(VPQBTRN_newtprocs);
} 
 /* line 139: */
 /* line 140: */
AQQBTRN = FMQBTRN_result;
} 
A_PROC_EXIT(transform_tstr_trow);
*ReturnedValue = (AQQBTRN);
return;
} 
#undef NL
 /* line 1: */
 /* line 2: */
 /* line 4: */
void WLQBTRN(void)   /* initialise DECS tstr_trow */
{ 
static A68_BOOL A_invoked = A68_FALSE;

/* --- Configuration information for this module */
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","/u/model/ella/oslib/assoc/mfiles","-dir","/u/model/ella/ostools/assoc/mfiles","-dir","./mfiles","-staredit","259","./a68files/tstr_trow.a68",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/transform/assoc/./a68files/tstr_trow.a68";
A_config.translation_time = "Tue Apr  4 10:10:58 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "VLQBTRN (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 10:10:58 1995";
A_config.arguments = A_config_arguments;
A_config.environment = A_config_environment;
A_config.modinfo_files = A_config_modinfo_files;
A_PROC_ENTRY(DECS tstr_trow);
UEAALIB_a68config(LGAALIB_configinfo, AMQBTRN);
 /* line 46: */
 /* line 142: */
 /* line 143: */
 /* line 144: */
/*SKIP*/;
A_PROC_EXIT(DECS tstr_trow);
} 
#undef NL
/* end of translation of ./a68files/tstr_trow.a68 */
