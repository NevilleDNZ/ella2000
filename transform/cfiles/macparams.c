...
A_ISTRUCT(struct A68t405 ,2,A68t421);
typedef struct A68t421  A68_421 ;    /* STRUCT 2 MODE405 */
A_ISTRUCT(struct A68t405 ,4,A68t422);
typedef struct A68t422  A68_422 ;    /* STRUCT 4 MODE405 */

A_PROCEDURE(A68_VOID ,A68t423,(struct A68t265 *,struct A68t408 ,struct A68t108 ,struct A68t359 *),(struct A68t265 *,struct A68t408 ,struct A68t108 ,struct A68t359 *,void *));
typedef struct A68t423  A68_423 ;    /* PROC(REF MODE265,MODE408,MODE108) MODE359 */
...
extern A68_218  ABAATRN_nilmacparams;
extern A68_253  FBAATRN_nilmacspecs;
...
static A68_417   IRFBTRN = {"$Id: macparams.a68,v 34.2 1995/03/29 13:02:57 ella Exp $"}; 
A_GISVEC(A68_VC ,JRFBTRN,IRFBTRN,56)
A68_46  WRFBTRN_macparams_options;
typedef struct   /* env of non-global proc */
{
A68_255 * DSFBTRN_env;
} ISFBTRN_fndec_macparams;
typedef struct   /* env of non-global proc */
{
A68_265 * Closure;
A68_408  Options;
...
{
A68_255 * DSFBTRN_env;
} OSFBTRN_instance_proc;

A_STATIC A68_VOID  LRFBTRN_generator(A68_BOOL  KRFBTRN_anonymous, A68_46  *ReturnedValue);

A_STATIC A68_VOID  PRFBTRN_generator(A68_BOOL  ORFBTRN_anonymous, A68_VC  *ReturnedValue);

A68_VOID  CSFBTRN_outerfn_macparams(A68_261  Ofn, A68_265 * Closure, A68_408  Options, A68_108  Msg, A68_358  *ReturnedValue);

A_STATIC A68_VOID  HSFBTRN_fndec_macparams(A68_252 * Fdec, A68_360 * Dec_tprocs, A68_357  *ReturnedValue, void *NonLocals);

A_STATIC A68_VOID  NSFBTRN_instance_proc(A68_216  Inst, A68_360 * Tprocs, A68_339  *ReturnedValue, void *NonLocals);

A_STATIC A68_VOID  DTFBTRN_fnbody_proc(A68_248  Fbody, A68_360 * Tprocs, A68_354  *ReturnedValue);

A68_VOID  VUFBTRN_transform_macparams(A68_265 * Closure, A68_408  Options, A68_108  Msg, A68_359  *ReturnedValue);

A_STATIC A68_VOID  ZUFBTRN_anonymous(A68_261  Ofn, A68_360 * Tprocs, A68_358  *ReturnedValue, void *NonLocals);

A_STATIC A68_VOID  NSFBTRN_instance_proc(A68_216  Inst, A68_360 * Tprocs, A68_339  *ReturnedValue, void *NonLocals)
#define NL(x) (((OSFBTRN_instance_proc *)NonLocals)->x)
{ 
A68_260  PSFBTRN;  /* OPERATORS - simple index */
A68_INT  QSFBTRN;  /* YIELD */
A68_BOOL  RSFBTRN_macro;
A68_381  SSFBTRN;  /* CALL */
A68_338  TSFBTRN;  /* avoid structure result */
A68_338  USFBTRN_mps;
A68_339  VSFBTRN;  /* collateral clause result */
A68_339  WSFBTRN;  /* clause result */
A68_339  XSFBTRN;  /* collateral clause result */
A68_218  YSFBTRN;  /* != */
A68_339  ZSFBTRN;  /* collateral clause result */
A68_339  ATFBTRN;  /* collateral clause result */
A_PROC_ENTRY(instance_proc);
 /* line 65: */
 /* line 66: */
{ 
PSFBTRN = (*(&(NL(DSFBTRN_env)->Fns))) ;
QSFBTRN = Inst.Fnno ;
RSFBTRN_macro = (*(&((*(&A_VINDEX(PSFBTRN,QSFBTRN)))->Macro)));
 /* line 67: */
 /* line 68: */
if ( RSFBTRN_macro )
{ 
SSFBTRN = (*(&(Tprocs->Macparams))) ;
A_CALLPROC(SSFBTRN,(Inst.Macparams, Tprocs, &TSFBTRN),(Inst.Macparams, Tprocs, &TSFBTRN,(SSFBTRN).nonlocals));
USFBTRN_mps = TSFBTRN;
 /* line 70: */
 /* line 71: */
if ( USFBTRN_mps.C )
{ 
VSFBTRN.I.Fnno = Inst.Fnno;
VSFBTRN.I.Macparams = USFBTRN_mps.M;
VSFBTRN.I.Attr = Inst.Attr;
 /* line 72: */
 /* line 73: */
VSFBTRN.C = A68_TRUE;
WSFBTRN = VSFBTRN;
...
{ 
 /* line 76: */
YSFBTRN = Inst.Macparams ;
if ( ! A_VSTRUCTCOMP(YSFBTRN,ABAATRN_nilmacparams) )
{ 
ZSFBTRN.I.Fnno = Inst.Fnno;
ZSFBTRN.I.Macparams = ABAATRN_nilmacparams;
ZSFBTRN.I.Attr = Inst.Attr;
 /* line 77: */
 /* line 78: */
ZSFBTRN.C = A68_TRUE;
WSFBTRN = ZSFBTRN;
...
A_PROC_EXIT(instance_proc);
*ReturnedValue = (WSFBTRN);
return;
} 
#undef NL
...
A_STATIC A68_VOID  DTFBTRN_fnbody_proc(A68_248  Fbody, A68_360 * Tprocs, A68_354  *ReturnedValue)
{ 
A68_248  ETFBTRN;  /* united object - for case conformity */
A68_221 * FTFBTRN_ut;
A68_354  GTFBTRN;  /* clause result */
A68_397  HTFBTRN;  /* CALL */
A68_354  ITFBTRN;  /* avoid structure result */
A68_354  JTFBTRN;  /* collateral clause result */
...
FTFBTRN_ut = (ETFBTRN.data.mode1);
 /* line 85: */
HTFBTRN = (*(&(AWLATRN_nulltprocs->Fnbody))) ;
A_CALLPROC(HTFBTRN,(Fbody, Tprocs, &ITFBTRN),(Fbody, Tprocs, &ITFBTRN,(HTFBTRN).nonlocals));
GTFBTRN = ITFBTRN;
break;
default: 
JTFBTRN.F = Fbody;
...
A_STATIC A68_VOID  PRFBTRN_generator(A68_BOOL  ORFBTRN_anonymous, A68_VC  *ReturnedValue)
{ 
A68_VC  QRFBTRN;  /* clause result */
A68_VC  RRFBTRN;  /* OPERATORS - dynamic generator */
{ 
RRFBTRN.upb = 0 ;
( ORFBTRN_anonymous? A_VLOC(A68_CHAR ,RRFBTRN): A_VHEAP(A68_CHAR ,RRFBTRN) );
QRFBTRN = RRFBTRN;
} 
*ReturnedValue = (QRFBTRN);
return;
} 
#undef NL

A_STATIC A68_VOID  HSFBTRN_fndec_macparams(A68_252 * Fdec, A68_360 * Dec_tprocs, A68_357  *ReturnedValue, void *NonLocals)
#define NL(x) (((ISFBTRN_fndec_macparams *)NonLocals)->x)
{ 
A68_382  MSFBTRN_instance_proc;   /* proc value of non-global proc */
A68_421  KTFBTRN;  /* collateral clause result */
A68_405  LTFBTRN;  /* OPERATORS - mode -> union mode */
A68_397  MTFBTRN;  /* YIELD */
A68_397  NTFBTRN;  /* procedure value */
A68_405  OTFBTRN;  /* OPERATORS - mode -> union mode */
A68_382  PTFBTRN;  /* YIELD */
A68_404  QTFBTRN;  /* OPERATORS - istruct -> vector */
A68_360 * RTFBTRN_newtprocs;
A68_397  STFBTRN;  /* CALL */
A68_354  TTFBTRN;  /* avoid structure result */
A68_354  UTFBTRN_bc;
A68_BOOL  VTFBTRN;  /* optbool result */
A68_BOOL  WTFBTRN;  /* optbool result */
A68_252 * XTFBTRN;  /* YIELD */
A68_252 * YTFBTRN_new;
A68_248 * ZTFBTRN;  /* YIELD */
A68_253 * AUFBTRN;  /* YIELD */
A68_357  BUFBTRN;  /* collateral clause result */
A68_357  CUFBTRN;  /* clause result */
A68_357  DUFBTRN;  /* collateral clause result */
A_PROC_ENTRY(fndec_macparams);
 /* line 62: */
 /* line 64: */
{ 
A_CLOSURE( MSFBTRN_instance_proc, NSFBTRN_instance_proc, OSFBTRN_instance_proc );
(( OSFBTRN_instance_proc * ) ( MSFBTRN_instance_proc.nonlocals )) -> DSFBTRN_env = NL(DSFBTRN_env);
 /* line 82: */
 /* line 88: */
 /* line 89: */
NTFBTRN.fn.fn_global = DTFBTRN_fnbody_proc;
NTFBTRN.nonlocals = A68_NIL;
MTFBTRN = NTFBTRN ;
KTFBTRN.data[0] = A_UNITE(LTFBTRN,mode37,37,MTFBTRN);
PTFBTRN = MSFBTRN_instance_proc ;
KTFBTRN.data[1] = A_UNITE(OTFBTRN,mode22,22,PTFBTRN);
RTFBTRN_newtprocs = THJATRN_make_newtprocs(Dec_tprocs, A_HISVEC(QTFBTRN,KTFBTRN,2,A68_405 ));
 /* line 90: */
STFBTRN = (*(&(AWLATRN_nulltprocs->Fnbody))) ;
A_CALLPROC(STFBTRN,((*(&(Fdec->Fnbody))), RTFBTRN_newtprocs, &TTFBTRN),((*(&(Fdec->Fnbody))), RTFBTRN_newtprocs, &TTFBTRN,(STFBTRN).nonlocals));
UTFBTRN_bc = TTFBTRN;
 /* line 92: */
 /* line 93: */
VTFBTRN = UTFBTRN_bc.C;
if ( ! VTFBTRN )
{WTFBTRN = !(*(&(Fdec->Macro)));
if ( WTFBTRN )
{WTFBTRN = ((*(&(Fdec->Macspecs))).upb>0);
}
VTFBTRN = WTFBTRN;
}
 /* line 94: */
if ( VTFBTRN )
{ 
XTFBTRN = A_HEAP(A68_252 ) ;
(*XTFBTRN) = (*Fdec) ;
YTFBTRN_new = XTFBTRN;
 /* line 96: */
ZTFBTRN = (&(YTFBTRN_new->Fnbody)) ;
(*ZTFBTRN) = UTFBTRN_bc.F;
 /* line 97: */
AUFBTRN = (&(YTFBTRN_new->Macspecs)) ;
(*AUFBTRN) = FBAATRN_nilmacspecs;
 /* line 98: */
BUFBTRN.F = YTFBTRN_new;
 /* line 99: */
 /* line 100: */
BUFBTRN.C = A68_TRUE;
CUFBTRN = BUFBTRN;
...
A_PROC_EXIT(fndec_macparams);
*ReturnedValue = (CUFBTRN);
return;
} 
#undef NL

A_STATIC A68_VOID  ZUFBTRN_anonymous(A68_261  Ofn, A68_360 * Tprocs, A68_358  *ReturnedValue, void *NonLocals)
#define NL(x) (((AVFBTRN_anonymous *)NonLocals)->x)
{ 
A68_358  BVFBTRN;  /* clause result */
A68_358  CVFBTRN;  /* avoid structure result */
 /* line 119: */
CSFBTRN_outerfn_macparams( Ofn, NL(Closure), NL(Options), NL(Msg), &CVFBTRN );
BVFBTRN = CVFBTRN;
*ReturnedValue = (BVFBTRN);
return;
} 
#undef NL
...
A_STATIC A68_VOID  LRFBTRN_generator(A68_BOOL  KRFBTRN_anonymous, A68_46  *ReturnedValue)
{ 
A68_46  NRFBTRN;  /* OPERATORS - dynamic generator */
A68_419  MRFBTRN_anonymous;
A68_418 * SRFBTRN_anonymous;
A68_INT  TRFBTRN;  /* forall loop counter */
A68_VC  URFBTRN;  /* avoid structure result */
A68_46  VRFBTRN;  /* clause result */
{ 
NRFBTRN.upb = 0 ;
( KRFBTRN_anonymous? A_VLOC(A68_VC ,NRFBTRN): A_VHEAP(A68_VC ,NRFBTRN) );
MRFBTRN_anonymous = NRFBTRN;
TRFBTRN = (*(&MRFBTRN_anonymous)).upb -1;
SRFBTRN_anonymous = (*(&MRFBTRN_anonymous)).data;
for (;TRFBTRN-- >= 0;
(SRFBTRN_anonymous++
) )
{
PRFBTRN_generator( KRFBTRN_anonymous, &URFBTRN );
(*SRFBTRN_anonymous) = URFBTRN;
}
VRFBTRN = MRFBTRN_anonymous;
} 
*ReturnedValue = (VRFBTRN);
return;
} 
#undef NL
 /* line 55: */
...
{ 
A68_255 * DSFBTRN_env;
A68_400  GSFBTRN_fndec_macparams;   /* proc value of non-global proc */
A68_422  EUFBTRN;  /* collateral clause result */
A68_405  FUFBTRN;  /* OPERATORS - mode -> union mode */
A68_361  GUFBTRN;  /* procedure value */
A68_405  HUFBTRN;  /* OPERATORS - mode -> union mode */
A68_364  IUFBTRN;  /* procedure value */
A68_405  JUFBTRN;  /* OPERATORS - mode -> union mode */
A68_370  KUFBTRN;  /* procedure value */
A68_405  LUFBTRN;  /* OPERATORS - mode -> union mode */
A68_400  MUFBTRN;  /* YIELD */
A68_404  NUFBTRN;  /* OPERATORS - istruct -> vector */
A68_360 * OUFBTRN_newtprocs;
A68_358  PUFBTRN;  /* clause result */
A68_401  QUFBTRN;  /* CALL */
A68_358  RUFBTRN;  /* avoid structure result */
A_PROC_ENTRY(outerfn_macparams);
 /* line 58: */
 /* line 59: */
{ 
DSFBTRN_env = Ofn.Environ;
 /* line 61: */
A_CLOSURE( GSFBTRN_fndec_macparams, HSFBTRN_fndec_macparams, ISFBTRN_fndec_macparams );
(( ISFBTRN_fndec_macparams * ) ( GSFBTRN_fndec_macparams.nonlocals )) -> DSFBTRN_env = DSFBTRN_env;
 /* line 104: */
 /* line 105: */
GUFBTRN.fn.fn_global = DWLATRN_null_attr;
GUFBTRN.nonlocals = A68_NIL;
EUFBTRN.data[0] = A_UNITE(FUFBTRN,mode1,1,GUFBTRN);
 /* line 106: */
IUFBTRN.fn.fn_global = IWLATRN_null_formula;
IUFBTRN.nonlocals = A68_NIL;
EUFBTRN.data[1] = A_UNITE(HUFBTRN,mode4,4,IUFBTRN);
 /* line 107: */
KUFBTRN.fn.fn_global = NWLATRN_null_type;
KUFBTRN.nonlocals = A68_NIL;
EUFBTRN.data[2] = A_UNITE(JUFBTRN,mode10,10,KUFBTRN);
MUFBTRN = GSFBTRN_fndec_macparams ;
EUFBTRN.data[3] = A_UNITE(LUFBTRN,mode40,40,MUFBTRN);
OUFBTRN_newtprocs = THJATRN_make_newtprocs(AWLATRN_nulltprocs, A_HISVEC(NUFBTRN,EUFBTRN,4,A68_405 ));
 /* line 109: */
 /* line 110: */
QUFBTRN = (*(&(AWLATRN_nulltprocs->Outer))) ;
A_CALLPROC(QUFBTRN,(Ofn, OUFBTRN_newtprocs, &RUFBTRN),(Ofn, OUFBTRN_newtprocs, &RUFBTRN,(QUFBTRN).nonlocals));
PUFBTRN = RUFBTRN;
} 
A_PROC_EXIT(outerfn_macparams);
*ReturnedValue = (PUFBTRN);
return;
} 
#undef NL
 /* line 114: */
...
A68_VOID  VUFBTRN_transform_macparams(A68_265 * Closure, A68_408  Options, A68_108  Msg, A68_359  *ReturnedValue)
{ 
A68_401  YUFBTRN_anonymous;   /* proc value of non-global proc */
A68_405  DVFBTRN;  /* OPERATORS - mode -> union mode */
A68_401  EVFBTRN;  /* YIELD */
A68_404  FVFBTRN;  /* OPERATORS - scalar -> [] or VEC[] */
A68_360 * GVFBTRN_newtprocs;
A68_359  HVFBTRN;  /* clause result */
A68_402  IVFBTRN;  /* CALL */
A68_359  JVFBTRN;  /* avoid structure result */
A_PROC_ENTRY(transform_macparams);
 /* line 116: */
 /* line 117: */
{ 
 /* line 118: */
A_CLOSURE( YUFBTRN_anonymous, ZUFBTRN_anonymous, AVFBTRN_anonymous );
(( AVFBTRN_anonymous * ) ( YUFBTRN_anonymous.nonlocals )) -> Closure = Closure;
(( AVFBTRN_anonymous * ) ( YUFBTRN_anonymous.nonlocals )) -> Options = Options;
(( AVFBTRN_anonymous * ) ( YUFBTRN_anonymous.nonlocals )) -> Msg = Msg;
EVFBTRN = YUFBTRN_anonymous ;
GVFBTRN_newtprocs = THJATRN_make_newtprocs(AWLATRN_nulltprocs, A_HVEC(FVFBTRN,A_UNITE(DVFBTRN,mode41,41,EVFBTRN),A68_405 ));
 /* line 121: */
 /* line 122: */
IVFBTRN = (*(&(AWLATRN_nulltprocs->Closure))) ;
A_CALLPROC(IVFBTRN,(Closure, GVFBTRN_newtprocs, Msg, &JVFBTRN),(Closure, GVFBTRN_newtprocs, Msg, &JVFBTRN,(IVFBTRN).nonlocals));
HVFBTRN = JVFBTRN;
} 
A_PROC_EXIT(transform_macparams);
*ReturnedValue = (HVFBTRN);
return;
} 
#undef NL
 /* line 1: */
 /* line 2: */
 /* line 5: */
void FRFBTRN(void)   /* initialise DECS macparams */
{ 
static A68_BOOL A_invoked = A68_FALSE;

/* --- Configuration information for this module */
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","/u/model/ella/oslib/assoc/mfiles","-dir","/u/model/ella/ostools/assoc/mfiles","-dir","./mfiles","-staredit","259","./a68files/macparams.a68",""};
...
A68_46  XRFBTRN;  /* avoid structure result */
if( A_invoked ) return;
A_invoked = A68_TRUE;
...
A_config.source_file = "/import/hazel/home/export/model/ella/transform/assoc/./a68files/macparams.a68";
A_config.translation_time = "Tue Apr  4 10:06:28 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "ERFBTRN (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 10:06:28 1995";
A_config.arguments = A_config_arguments;
A_config.environment = A_config_environment;
A_config.modinfo_files = A_config_modinfo_files;
A_PROC_ENTRY(DECS macparams);
UEAALIB_a68config(LGAALIB_configinfo, JRFBTRN);
 /* line 52: */
LRFBTRN_generator( A68_TRUE, &XRFBTRN );
WRFBTRN_macparams_options = XRFBTRN;
 /* line 54: */
 /* line 113: */
 /* line 124: */
 /* line 125: */
 /* line 126: */
/*SKIP*/;
A_PROC_EXIT(DECS macparams);
} 
#undef NL
/* end of translation of ./a68files/macparams.a68 */
