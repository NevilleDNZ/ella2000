...
static A68_417   COGBTRN = {"$Id: dinst.a68,v 34.2 1995/03/29 13:02:47 ella Exp $"}; 
A_GISVEC(A68_VC ,DOGBTRN,COGBTRN,52)
A68_46  QOGBTRN_dinst_options;
...
A_STATIC A68_VOID  FOGBTRN_generator(A68_BOOL  EOGBTRN_anonymous, A68_46  *ReturnedValue);

A_STATIC A68_VOID  JOGBTRN_generator(A68_BOOL  IOGBTRN_anonymous, A68_VC  *ReturnedValue);

A_STATIC A68_VOID  UOGBTRN_fnbody_dinst(A68_248  Fbody, A68_360 * Tprocs, A68_354  *ReturnedValue);

A68_VOID  FPGBTRN_outer_dinst(A68_261  Outer, A68_265 * Closure, A68_408  Options, A68_108  Msg, A68_358  *ReturnedValue);

A_STATIC A68_VOID  JPGBTRN_unit_proc(A68_176  U, A68_360 * Tprocs, A68_336  *ReturnedValue);

A68_VOID  ZQGBTRN_transform_dinst(A68_265 * Closure, A68_408  Options, A68_108  Msg, A68_359  *ReturnedValue);

A_STATIC A68_VOID  ERGBTRN_outer(A68_261  O, A68_360 * Tprocs, A68_358  *ReturnedValue, void *NonLocals);

A_STATIC A68_VOID  JOGBTRN_generator(A68_BOOL  IOGBTRN_anonymous, A68_VC  *ReturnedValue)
{ 
A68_VC  KOGBTRN;  /* clause result */
A68_VC  LOGBTRN;  /* OPERATORS - dynamic generator */
{ 
LOGBTRN.upb = 0 ;
( IOGBTRN_anonymous? A_VLOC(A68_CHAR ,LOGBTRN): A_VHEAP(A68_CHAR ,LOGBTRN) );
KOGBTRN = LOGBTRN;
} 
*ReturnedValue = (KOGBTRN);
return;
} 
#undef NL
...
A_STATIC A68_VOID  JPGBTRN_unit_proc(A68_176  U, A68_360 * Tprocs, A68_336  *ReturnedValue)
{ 
A68_176  KPGBTRN;  /* united object - for case conformity */
A68_194 * LPGBTRN_dinst;
A68_379  MPGBTRN;  /* CALL */
A68_336  NPGBTRN;  /* avoid structure result */
A68_336  OPGBTRN_left;
A68_379  PPGBTRN;  /* CALL */
A68_336  QPGBTRN;  /* avoid structure result */
A68_336  RPGBTRN_right;
A68_191  SPGBTRN;  /* collateral clause result */
A68_191  TPGBTRN;  /* collateral clause result */
A68_191 * UPGBTRN;  /* YIELD */
A68_191 * VPGBTRN;  /* YIELD */
A68_191 * WPGBTRN_str;
A68_193  XPGBTRN;  /* collateral clause result */
A68_176  YPGBTRN;  /* OPERATORS - mode -> union mode */
A68_193 * ZPGBTRN;  /* YIELD */
A68_193 * AQGBTRN_minst;
A68_336  BQGBTRN;  /* collateral clause result */
A68_176  CQGBTRN;  /* OPERATORS - mode -> union mode */
A68_336  DQGBTRN;  /* clause result */
A68_379  EQGBTRN;  /* CALL */
A68_336  FQGBTRN;  /* avoid structure result */
...
LPGBTRN_dinst = (KPGBTRN.data.mode24);
 /* line 62: */
{ 
MPGBTRN = (*(&(Tprocs->Unit))) ;
A_CALLPROC(MPGBTRN,((*(&(LPGBTRN_dinst->Left))), Tprocs, &NPGBTRN),((*(&(LPGBTRN_dinst->Left))), Tprocs, &NPGBTRN,(MPGBTRN).nonlocals));
OPGBTRN_left = NPGBTRN;
 /* line 63: */
PPGBTRN = (*(&(Tprocs->Unit))) ;
A_CALLPROC(PPGBTRN,((*(&(LPGBTRN_dinst->Right))), Tprocs, &QPGBTRN),((*(&(LPGBTRN_dinst->Right))), Tprocs, &QPGBTRN,(PPGBTRN).nonlocals));
RPGBTRN_right = QPGBTRN;
 /* line 64: */
 /* line 65: */
SPGBTRN.Elem = OPGBTRN_left.U;
TPGBTRN.Elem = RPGBTRN_right.U;
TPGBTRN.Rest = IAAATRN_nilustr;
UPGBTRN = A_HEAP(A68_191 ) ;
(*UPGBTRN) = TPGBTRN ;
SPGBTRN.Rest = UPGBTRN;
VPGBTRN = A_HEAP(A68_191 ) ;
(*VPGBTRN) = SPGBTRN ;
WPGBTRN_str = VPGBTRN;
 /* line 66: */
XPGBTRN.Inst = (*(&(LPGBTRN_dinst->Inst)));
XPGBTRN.Right = A_UNITE(YPGBTRN,mode21,21,WPGBTRN_str);
ZPGBTRN = A_HEAP(A68_193 ) ;
(*ZPGBTRN) = XPGBTRN ;
AQGBTRN_minst = ZPGBTRN;
 /* line 68: */
BQGBTRN.U = A_UNITE(CQGBTRN,mode23,23,AQGBTRN_minst);
 /* line 69: */
 /* line 70: */
 /* line 71: */
BQGBTRN.C = A68_TRUE;
...
default: 
 /* line 72: */
EQGBTRN = (*(&(AWLATRN_nulltprocs->Unit))) ;
A_CALLPROC(EQGBTRN,(U, Tprocs, &FQGBTRN),(U, Tprocs, &FQGBTRN,(EQGBTRN).nonlocals));
DQGBTRN = FQGBTRN;
break;
} 
A_PROC_EXIT(unit_proc);
*ReturnedValue = (DQGBTRN);
return;
} 
#undef NL

A_STATIC A68_VOID  ERGBTRN_outer(A68_261  O, A68_360 * Tprocs, A68_358  *ReturnedValue, void *NonLocals)
#define NL(x) (((FRGBTRN_outer *)NonLocals)->x)
{ 
A68_358  GRGBTRN;  /* clause result */
A68_358  HRGBTRN;  /* avoid structure result */
A_PROC_ENTRY(outer);
 /* line 88: */
FPGBTRN_outer_dinst( O, NL(Closure), NL(Options), NL(Msg), &HRGBTRN );
GRGBTRN = HRGBTRN;
A_PROC_EXIT(outer);
*ReturnedValue = (GRGBTRN);
return;
} 
#undef NL
...
A_STATIC A68_VOID  FOGBTRN_generator(A68_BOOL  EOGBTRN_anonymous, A68_46  *ReturnedValue)
{ 
A68_46  HOGBTRN;  /* OPERATORS - dynamic generator */
A68_419  GOGBTRN_anonymous;
A68_418 * MOGBTRN_anonymous;
A68_INT  NOGBTRN;  /* forall loop counter */
A68_VC  OOGBTRN;  /* avoid structure result */
A68_46  POGBTRN;  /* clause result */
{ 
HOGBTRN.upb = 0 ;
( EOGBTRN_anonymous? A_VLOC(A68_VC ,HOGBTRN): A_VHEAP(A68_VC ,HOGBTRN) );
GOGBTRN_anonymous = HOGBTRN;
NOGBTRN = (*(&GOGBTRN_anonymous)).upb -1;
MOGBTRN_anonymous = (*(&GOGBTRN_anonymous)).data;
for (;NOGBTRN-- >= 0;
(MOGBTRN_anonymous++
) )
{
JOGBTRN_generator( EOGBTRN_anonymous, &OOGBTRN );
(*MOGBTRN_anonymous) = OOGBTRN;
}
POGBTRN = GOGBTRN_anonymous;
} 
*ReturnedValue = (POGBTRN);
return;
} 
#undef NL
...
A_STATIC A68_VOID  UOGBTRN_fnbody_dinst(A68_248  Fbody, A68_360 * Tprocs, A68_354  *ReturnedValue)
{ 
A68_248  VOGBTRN;  /* united object - for case conformity */
A68_221 * WOGBTRN_ut;
A68_354  XOGBTRN;  /* clause result */
A68_397  YOGBTRN;  /* CALL */
A68_354  ZOGBTRN;  /* avoid structure result */
A68_354  APGBTRN;  /* collateral clause result */
...
WOGBTRN_ut = (VOGBTRN.data.mode1);
 /* line 49: */
YOGBTRN = (*(&(AWLATRN_nulltprocs->Fnbody))) ;
A_CALLPROC(YOGBTRN,(Fbody, Tprocs, &ZOGBTRN),(Fbody, Tprocs, &ZOGBTRN,(YOGBTRN).nonlocals));
XOGBTRN = ZOGBTRN;
break;
default: 
APGBTRN.F = Fbody;
...
{ 
A68_255 * GPGBTRN_env;
A68_421  GQGBTRN;  /* collateral clause result */
A68_405  HQGBTRN;  /* OPERATORS - mode -> union mode */
A68_364  IQGBTRN;  /* procedure value */
A68_405  JQGBTRN;  /* OPERATORS - mode -> union mode */
A68_370  KQGBTRN;  /* procedure value */
A68_405  LQGBTRN;  /* OPERATORS - mode -> union mode */
A68_397  MQGBTRN;  /* YIELD */
A68_397  NQGBTRN;  /* procedure value */
A68_405  OQGBTRN;  /* OPERATORS - mode -> union mode */
A68_379  PQGBTRN;  /* YIELD */
A68_379  QQGBTRN;  /* procedure value */
A68_404  RQGBTRN;  /* OPERATORS - istruct -> vector */
A68_360 * SQGBTRN_newtprocs;
A68_358  TQGBTRN;  /* clause result */
A68_401  UQGBTRN;  /* CALL */
A68_358  VQGBTRN;  /* avoid structure result */
A_PROC_ENTRY(outer_dinst);
 /* line 56: */
 /* line 57: */
{ 
GPGBTRN_env = Outer.Environ;
 /* line 59: */
 /* line 74: */
 /* line 75: */
IQGBTRN.fn.fn_global = IWLATRN_null_formula;
IQGBTRN.nonlocals = A68_NIL;
GQGBTRN.data[0] = A_UNITE(HQGBTRN,mode4,4,IQGBTRN);
 /* line 76: */
KQGBTRN.fn.fn_global = NWLATRN_null_type;
KQGBTRN.nonlocals = A68_NIL;
GQGBTRN.data[1] = A_UNITE(JQGBTRN,mode10,10,KQGBTRN);
 /* line 77: */
NQGBTRN.fn.fn_global = UOGBTRN_fnbody_dinst;
NQGBTRN.nonlocals = A68_NIL;
MQGBTRN = NQGBTRN ;
GQGBTRN.data[2] = A_UNITE(LQGBTRN,mode37,37,MQGBTRN);
QQGBTRN.fn.fn_global = JPGBTRN_unit_proc;
QQGBTRN.nonlocals = A68_NIL;
PQGBTRN = QQGBTRN ;
GQGBTRN.data[3] = A_UNITE(OQGBTRN,mode19,19,PQGBTRN);
SQGBTRN_newtprocs = THJATRN_make_newtprocs(AWLATRN_nulltprocs, A_HISVEC(RQGBTRN,GQGBTRN,4,A68_405 ));
 /* line 79: */
 /* line 80: */
UQGBTRN = (*(&(AWLATRN_nulltprocs->Outer))) ;
A_CALLPROC(UQGBTRN,(Outer, SQGBTRN_newtprocs, &VQGBTRN),(Outer, SQGBTRN_newtprocs, &VQGBTRN,(UQGBTRN).nonlocals));
TQGBTRN = VQGBTRN;
} 
A_PROC_EXIT(outer_dinst);
*ReturnedValue = (TQGBTRN);
return;
} 
#undef NL
 /* line 84: */
...
A68_VOID  ZQGBTRN_transform_dinst(A68_265 * Closure, A68_408  Options, A68_108  Msg, A68_359  *ReturnedValue)
{ 
A68_401  DRGBTRN_outer;   /* proc value of non-global proc */
A68_405  IRGBTRN;  /* OPERATORS - mode -> union mode */
A68_401  JRGBTRN;  /* YIELD */
A68_404  KRGBTRN;  /* OPERATORS - scalar -> [] or VEC[] */
A68_360 * LRGBTRN_newtprocs;
A68_359  MRGBTRN;  /* clause result */
A68_402  NRGBTRN;  /* CALL */
A68_359  ORGBTRN;  /* avoid structure result */
A_PROC_ENTRY(transform_dinst);
 /* line 86: */
 /* line 87: */
{ 
A_CLOSURE( DRGBTRN_outer, ERGBTRN_outer, FRGBTRN_outer );
(( FRGBTRN_outer * ) ( DRGBTRN_outer.nonlocals )) -> Closure = Closure;
(( FRGBTRN_outer * ) ( DRGBTRN_outer.nonlocals )) -> Options = Options;
(( FRGBTRN_outer * ) ( DRGBTRN_outer.nonlocals )) -> Msg = Msg;
 /* line 90: */
JRGBTRN = DRGBTRN_outer ;
LRGBTRN_newtprocs = THJATRN_make_newtprocs(AWLATRN_nulltprocs, A_HVEC(KRGBTRN,A_UNITE(IRGBTRN,mode41,41,JRGBTRN),A68_405 ));
 /* line 92: */
 /* line 93: */
NRGBTRN = (*(&(AWLATRN_nulltprocs->Closure))) ;
A_CALLPROC(NRGBTRN,(Closure, LRGBTRN_newtprocs, Msg, &ORGBTRN),(Closure, LRGBTRN_newtprocs, Msg, &ORGBTRN,(NRGBTRN).nonlocals));
MRGBTRN = ORGBTRN;
} 
A_PROC_EXIT(transform_dinst);
*ReturnedValue = (MRGBTRN);
return;
} 
#undef NL
 /* line 1: */
 /* line 2: */
 /* line 4: */
void ZNGBTRN(void)   /* initialise DECS dinst */
{ 
static A68_BOOL A_invoked = A68_FALSE;

/* --- Configuration information for this module */
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","/u/model/ella/oslib/assoc/mfiles","-dir","/u/model/ella/ostools/assoc/mfiles","-dir","./mfiles","-staredit","259","./a68files/dinst.a68",""};
...
A68_46  ROGBTRN;  /* avoid structure result */
if( A_invoked ) return;
A_invoked = A68_TRUE;
...
A_config.source_file = "/import/hazel/home/export/model/ella/transform/assoc/./a68files/dinst.a68";
A_config.translation_time = "Tue Apr  4 10:07:00 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "YNGBTRN (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 10:07:00 1995";
A_config.arguments = A_config_arguments;
A_config.environment = A_config_environment;
A_config.modinfo_files = A_config_modinfo_files;
A_PROC_ENTRY(DECS dinst);
UEAALIB_a68config(LGAALIB_configinfo, DOGBTRN);
 /* line 43: */
FOGBTRN_generator( A68_TRUE, &ROGBTRN );
QOGBTRN_dinst_options = ROGBTRN;
 /* line 46: */
 /* line 52: */
 /* line 83: */
 /* line 95: */
 ...
 /* line 97: */
/*SKIP*/;
A_PROC_EXIT(DECS dinst);
} 
#undef NL
/* end of translation of ./a68files/dinst.a68 */
