...
A_PROCEDURE(A68_BOOL ,A68t464,(struct A68t248 ),(struct A68t248 ,void *));
typedef struct A68t464  A68_464 ;    /* PROC(MODE248) BOOL */

A_PROCEDURE(A68_VOID ,A68t465,(struct A68t254 ,A68_INT ,A68_INT ,struct A68t251 *),(struct A68t254 ,A68_INT ,A68_INT ,struct A68t251 *,void *));
typedef struct A68t465  A68_465 ;    /* PROC(REF MODE254,INT,INT) MODE251 */

A_PROCEDURE(A68_VOID ,A68t466,(struct A68t265 *,struct A68t108 ,struct A68t359 *),(struct A68t265 *,struct A68t108 ,struct A68t359 *,void *));
typedef struct A68t466  A68_466 ;    /* PROC(REF MODE265,MODE108) MODE359 */

A_PROCEDURE(A68_VOID ,A68t467,(A68_BOOL ,struct A68t254 *),(A68_BOOL ,struct A68t254 *,void *));
typedef struct A68t467  A68_467 ;    /* PROC(BOOL) MODE254 */
A_ISTRUCT(struct A68t405 ,5,A68t468);
typedef struct A68t468  A68_468 ;    /* STRUCT 5 MODE405 */
...
extern A68_VOID  SWLATRN_null_unit(struct A68t176 ,struct A68t360 *,A68_336 *);
...
static A68_463   JGHBTRN = {"$Id: delay.a68,v 34.2 1995/03/29 13:02:44 ella Exp $"}; 
A_GISVEC(A68_VC ,KGHBTRN,JGHBTRN,52)
typedef struct   /* env of non-global proc */
{
int dummy;
} QHHBTRN_generator;

A_STATIC A68_BOOL  MGHBTRN_delay_body(A68_248  Fnbody);

A_STATIC A68_VOID  SGHBTRN_make_nametype(A68_254  Nametypes, A68_INT  First, A68_INT  Last, A68_251  *ReturnedValue);

A68_VOID  GHHBTRN_transform_delay(A68_265 * Closure, A68_108  Msg, A68_359  *ReturnedValue);

A_STATIC A68_VOID  KHHBTRN_fndec_trans(A68_252 * Fdec, A68_360 * Tprocs, A68_357  *ReturnedValue);

A_STATIC A68_VOID  PHHBTRN_generator(A68_BOOL  NHHBTRN_anonymous, A68_254  *ReturnedValue, void *NonLocals);

A_STATIC A68_VOID  PHHBTRN_generator(A68_BOOL  NHHBTRN_anonymous, A68_254  *ReturnedValue, void *NonLocals)
#define NL(x) (((QHHBTRN_generator *)NonLocals)->x)
{ 
A68_254  RHHBTRN;  /* clause result */
A68_254  SHHBTRN;  /* OPERATORS - dynamic generator */
{ 
SHHBTRN.upb = 2 ;
( NHHBTRN_anonymous? A_VLOC(A68_251 ,SHHBTRN): A_VHEAP(A68_251 ,SHHBTRN) );
RHHBTRN = SHHBTRN;
} 
*ReturnedValue = (RHHBTRN);
return;
} 
#undef NL
...
A_STATIC A68_VOID  KHHBTRN_fndec_trans(A68_252 * Fdec, A68_360 * Tprocs, A68_357  *ReturnedValue)
{ 
A68_BOOL  LHHBTRN;  /* optbool result */
A68_254  MHHBTRN_old_nametypes;
A68_467  OHHBTRN_generator;   /* proc value of non-global proc */
A68_254  UHHBTRN;  /* avoid structure result */
A68_254  THHBTRN_new_nametypes;
A68_INT  VHHBTRN_no_inputs;
A68_INT  WHHBTRN_no_outputs;
A68_INT  XHHBTRN;  /* YIELD */
A68_251  YHHBTRN;  /* avoid structure result */
A68_251 * ZHHBTRN;  /* YIELD */
A68_INT  AIHBTRN;  /* YIELD */
A68_251  BIHBTRN;  /* avoid structure result */
A68_251 * CIHBTRN;  /* YIELD */
A68_357  DIHBTRN;  /* collateral clause result */
A68_252  EIHBTRN;  /* collateral clause result */
A68_217  FIHBTRN;  /* collateral clause result */
A68_217 * GIHBTRN;  /* YIELD */
A68_217  HIHBTRN;  /* collateral clause result */
A68_217 * IIHBTRN;  /* YIELD */
A68_252 * JIHBTRN;  /* YIELD */
A68_357  KIHBTRN;  /* clause result */
A68_357  LIHBTRN;  /* collateral clause result */
A68_357  MIHBTRN;  /* collateral clause result */
...
{ 
LHHBTRN = MGHBTRN_delay_body((*(&(Fdec->Fnbody))));
if ( LHHBTRN )
{ /* line 67: */
LHHBTRN = ((*(&(Fdec->Nametypes))).upb>2);
}
if ( LHHBTRN )
{ 
MHHBTRN_old_nametypes = (*(&(Fdec->Nametypes)));
 /* line 68: */
A_CLOSURE( OHHBTRN_generator, PHHBTRN_generator, QHHBTRN_generator );
A_CALLPROC(OHHBTRN_generator,(A68_FALSE, &UHHBTRN),(A68_FALSE, &UHHBTRN,(OHHBTRN_generator).nonlocals));
THHBTRN_new_nametypes = UHHBTRN;
 /* line 69: */
VHHBTRN_no_inputs = DTNATRN_names_size((*(&(Fdec->Inputs))));
 /* line 70: */
WHHBTRN_no_outputs = DTNATRN_names_size((*(&(Fdec->Outputs))));
 /* line 71: */
XHHBTRN = 1 ;
SGHBTRN_make_nametype( MHHBTRN_old_nametypes, 1, VHHBTRN_no_inputs, &YHHBTRN );
ZHHBTRN = (&A_VINDEX(THHBTRN_new_nametypes,XHHBTRN)) ;
(*ZHHBTRN) = YHHBTRN;
 /* line 72: */
 /* line 73: */
AIHBTRN = 2 ;
SGHBTRN_make_nametype( MHHBTRN_old_nametypes, (VHHBTRN_no_inputs+1), (VHHBTRN_no_inputs+WHHBTRN_no_outputs), &BIHBTRN );
CIHBTRN = (&A_VINDEX(THHBTRN_new_nametypes,AIHBTRN)) ;
(*CIHBTRN) = BIHBTRN;
 /* line 74: */
EIHBTRN.Sort = (*(&(Fdec->Sort)));
EIHBTRN.Macro = (*(&(Fdec->Macro)));
 /* line 75: */
EIHBTRN.Fnname = (*(&(Fdec->Fnname)));
EIHBTRN.Macspecs = (*(&(Fdec->Macspecs)));
 /* line 76: */
EIHBTRN.Attr = (*(&(Fdec->Attr)));
FIHBTRN.Nameno = 1;
FIHBTRN.Rest = NAAATRN_nilnames;
 /* line 77: */
GIHBTRN = A_HEAP(A68_217 ) ;
(*GIHBTRN) = FIHBTRN ;
EIHBTRN.Inputs = GIHBTRN;
HIHBTRN.Nameno = 2;
HIHBTRN.Rest = NAAATRN_nilnames;
IIHBTRN = A_HEAP(A68_217 ) ;
(*IIHBTRN) = HIHBTRN ;
EIHBTRN.Outputs = IIHBTRN;
 /* line 78: */
EIHBTRN.Nametypes = THHBTRN_new_nametypes;
EIHBTRN.Fnbody = (*(&(Fdec->Fnbody)));
EIHBTRN.Usage = (*(&(Fdec->Usage)));
JIHBTRN = A_HEAP(A68_252 ) ;
(*JIHBTRN) = EIHBTRN ;
DIHBTRN.F = JIHBTRN;
 /* line 79: */
DIHBTRN.C = A68_TRUE;
...
A_STATIC A68_BOOL  MGHBTRN_delay_body(A68_248  Fnbody)
{ 
A68_248  NGHBTRN;  /* united object - for case conformity */
A68_BOOL  OGHBTRN;  /* clause result */
A_PROC_ENTRY(delay_body);
 /* line 45: */
 /* line 46: */
NGHBTRN = Fnbody ;
switch ( NGHBTRN.mode )
{ 
case 6: /* REF STRUCT(INT,MODE176,MODE138,MODE176,MODE138)  */
 /* line 47: */
OGHBTRN = A68_TRUE;
break;
case 7: /* REF STRUCT(MODE176,MODE138)  */
 /* line 48: */
OGHBTRN = A68_TRUE;
break;
default: 
...
A_STATIC A68_VOID  SGHBTRN_make_nametype(A68_254  Nametypes, A68_INT  First, A68_INT  Last, A68_251  *ReturnedValue)
{ 
A68_251  TGHBTRN;  /* clause result */
A68_251 * UGHBTRN;  /* YIELD */
A68_157 * VGHBTRN_ty;
A68_INT  WGHBTRN_i;
A68_INT  XGHBTRN;  /* to part of loop */
A68_INT  YGHBTRN;  /* by part of loop */
A68_157  ZGHBTRN;  /* collateral clause result */
A68_157 * AHHBTRN;  /* YIELD */
A68_251  BHHBTRN;  /* collateral clause result */
A68_154  CHHBTRN;  /* OPERATORS - mode -> union mode */
A68_129  DHHBTRN;  /* OPERATORS - mode -> union mode */
A_PROC_ENTRY(make_nametype);
 /* line 53: */
 /* line 54: */
if ( (First==Last) )
{ 
 /* line 55: */
UGHBTRN = A_HEAP(A68_251 ) ;
TGHBTRN = (*UGHBTRN) = (*(&A_VINDEX(Nametypes,First)));
} 
else
{ 
VGHBTRN_ty = GAAATRN_niltstr;
 /* line 56: */
 /* line 57: */
XGHBTRN = First;
YGHBTRN = (-1);
for ( WGHBTRN_i = Last;
( YGHBTRN > 0 && WGHBTRN_i <= XGHBTRN) ||
( YGHBTRN < 0 && WGHBTRN_i >= XGHBTRN) ||
( YGHBTRN == 0 ) ;
WGHBTRN_i += YGHBTRN )
{ 
ZGHBTRN.Elem = (*(&((&A_VINDEX(Nametypes,WGHBTRN_i))->Type)));
ZGHBTRN.Rest = VGHBTRN_ty;
AHHBTRN = A_HEAP(A68_157 ) ;
(*AHHBTRN) = ZGHBTRN ;
VGHBTRN_ty = AHHBTRN;
}
 /* line 58: */
BHHBTRN.Name = TTCAOST_nullid;
BHHBTRN.Type = A_UNITE(CHHBTRN,mode3,3,VGHBTRN_ty);
 /* line 59: */
BHHBTRN.Attr = A_UNITE(DHHBTRN,mode5,5,(&ZHAATRN_attrnull));
TGHBTRN = BHHBTRN;
} 
A_PROC_EXIT(make_nametype);
*ReturnedValue = (TGHBTRN);
return;
} 
#undef NL
...
A68_VOID  GHHBTRN_transform_delay(A68_265 * Closure, A68_108  Msg, A68_359  *ReturnedValue)
{ 
A68_468  NIHBTRN;  /* collateral clause result */
A68_405  OIHBTRN;  /* OPERATORS - mode -> union mode */
A68_364  PIHBTRN;  /* procedure value */
A68_405  QIHBTRN;  /* OPERATORS - mode -> union mode */
A68_361  RIHBTRN;  /* procedure value */
A68_405  SIHBTRN;  /* OPERATORS - mode -> union mode */
A68_370  TIHBTRN;  /* procedure value */
A68_405  UIHBTRN;  /* OPERATORS - mode -> union mode */
A68_379  VIHBTRN;  /* procedure value */
A68_405  WIHBTRN;  /* OPERATORS - mode -> union mode */
A68_400  XIHBTRN;  /* YIELD */
A68_400  YIHBTRN;  /* procedure value */
A68_404  ZIHBTRN;  /* OPERATORS - istruct -> vector */
A68_360 * AJHBTRN_newtprocs;
A68_359  BJHBTRN;  /* clause result */
A68_402  CJHBTRN;  /* CALL */
A68_359  DJHBTRN;  /* avoid structure result */
A_PROC_ENTRY(transform_delay);
 /* line 62: */
 /* line 63: */
{ 
 /* line 86: */
 /* line 87: */
PIHBTRN.fn.fn_global = IWLATRN_null_formula;
PIHBTRN.nonlocals = A68_NIL;
NIHBTRN.data[0] = A_UNITE(OIHBTRN,mode4,4,PIHBTRN);
 /* line 88: */
RIHBTRN.fn.fn_global = DWLATRN_null_attr;
RIHBTRN.nonlocals = A68_NIL;
NIHBTRN.data[1] = A_UNITE(QIHBTRN,mode1,1,RIHBTRN);
 /* line 89: */
TIHBTRN.fn.fn_global = NWLATRN_null_type;
TIHBTRN.nonlocals = A68_NIL;
NIHBTRN.data[2] = A_UNITE(SIHBTRN,mode10,10,TIHBTRN);
 /* line 90: */
VIHBTRN.fn.fn_global = SWLATRN_null_unit;
VIHBTRN.nonlocals = A68_NIL;
NIHBTRN.data[3] = A_UNITE(UIHBTRN,mode19,19,VIHBTRN);
YIHBTRN.fn.fn_global = KHHBTRN_fndec_trans;
YIHBTRN.nonlocals = A68_NIL;
XIHBTRN = YIHBTRN ;
NIHBTRN.data[4] = A_UNITE(WIHBTRN,mode40,40,XIHBTRN);
AJHBTRN_newtprocs = THJATRN_make_newtprocs(AWLATRN_nulltprocs, A_HISVEC(ZIHBTRN,NIHBTRN,5,A68_405 ));
 /* line 92: */
 /* line 93: */
CJHBTRN = (*(&(AWLATRN_nulltprocs->Closure))) ;
A_CALLPROC(CJHBTRN,(Closure, AJHBTRN_newtprocs, Msg, &DJHBTRN),(Closure, AJHBTRN_newtprocs, Msg, &DJHBTRN,(CJHBTRN).nonlocals));
BJHBTRN = DJHBTRN;
} 
A_PROC_EXIT(transform_delay);
*ReturnedValue = (BJHBTRN);
return;
} 
#undef NL
 /* line 1: */
 /* line 2: */
 /* line 4: */
void GGHBTRN(void)   /* initialise DECS delay */
{ 
static A68_BOOL A_invoked = A68_FALSE;

/* --- Configuration information for this module */
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","/u/model/ella/oslib/assoc/mfiles","-dir","/u/model/ella/ostools/assoc/mfiles","-dir","./mfiles","-staredit","259","./a68files/delay.a68",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/transform/assoc/./a68files/delay.a68";
A_config.translation_time = "Tue Apr  4 10:07:33 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "FGHBTRN (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 10:07:33 1995";
A_config.arguments = A_config_arguments;
A_config.environment = A_config_environment;
A_config.modinfo_files = A_config_modinfo_files;
A_PROC_ENTRY(DECS delay);
UEAALIB_a68config(LGAALIB_configinfo, KGHBTRN);
 /* line 44: */
 /* line 51: */
 /* line 61: */
 /* line 95: */
 ...
 /* line 97: */
/*SKIP*/;
A_PROC_EXIT(DECS delay);
} 
#undef NL
/* end of translation of ./a68files/delay.a68 */
