/* $Id: minus_real.c,v 34.2 1995/03/29 13:04:05 ella Exp $ */
...
static char *rcsid = " $Id: minus_real.c,v 34.2 1995/03/29 13:04:05 ella Exp $ ";

/* DEC/CMS REPLACEMENT HISTORY, Element MINUS_REAL.C */
/* *7    11-AUG-1989 15:05:15 ELLADEV "Updated provisional with fixes for R4B388. BGH" */
/* *6    10-AUG-1989 12:30:42 ELLADEV "Definitive release 4.0, first provisional release 4.1. BGH" */
/* *5    30-JUN-1989 17:14:53 ELLADEV "Updated provisional with fixes for R4B383. BGH" */
/* *4    26-JUN-1989 18:06:54 ELLADEV "Updated provisional with fixes for R4B380. BGH" */
/* *3    17-FEB-1989 17:17:33 ELLADEV "Updated provisional with partial fixes for R4B043. BGH" */
/* *2    21-JAN-1989 11:20:56 ELLADEV "Provisional for Release 4.0 BGH" */
/* *1    17-JAN-1989 16:54:29 ELLADEV "first draft for Release 4.0, stored in CMS lib [elladev.cms.ella_server]""" */
/* DEC/CMS REPLACEMENT HISTORY, Element MINUS_REAL.C */
/************************************************************************/
...
if (n_known && m_known)
   {
     /* Set up default result if exceptions should occur */
...
/* If we get this far, there was no exception on VAX, so signal this. */
   ...
   if (errEvt != 0)
     ...
     *(qf)qf_result  = TRUE;
     ...
     if (*(tv)tv_result  == twovalued_QUERY)
       {
       /* Zero answer valid if inputs are of same magnitude and sign */
