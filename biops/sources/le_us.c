/* $Id: le_us.c,v 34.2 1995/03/29 13:04:03 ella Exp $ */
...
static char *rcsid = " $Id: le_us.c,v 34.2 1995/03/29 13:04:03 ella Exp $ ";

/* DEC/CMS REPLACEMENT HISTORY, Element LE_US.C */
/* *6    10-AUG-1989 12:29:11 ELLADEV "Definitive release 4.0, first provisional release 4.1. BGH" */
/* *5    30-JUN-1989 17:14:37 ELLADEV "Updated provisional with fixes for R4B383. BGH" */
/* *4    26-JUN-1989 18:06:40 ELLADEV "Updated provisional with fixes for R4B380. BGH" */
/* *3    17-FEB-1989 17:17:21 ELLADEV "Updated provisional with partial fixes for R4B043. BGH" */
/* *2    21-JAN-1989 11:18:12 ELLADEV "Provisional for Release 4.0 BGH" */
/* *1    17-JAN-1989 16:54:20 ELLADEV "first draft for Release 4.0, stored in CMS lib [elladev.cms.ella_server]""" */
/* DEC/CMS REPLACEMENT HISTORY, Element LE_US.C */
/*************************************************************************/
...
/*     LE_US
       ********
Description:
     Less then or equal comparison on the assumption that the signals represent
     unsigned integers
 ...
 *
 * LE_US (M, N, result)
 * unsigned less-than or equal operator for arbitary length bit strings
 ...
 *        then result == ?
 *        else result == ((unsigned)M <= (unsigned)N)
 *
 */
...
void
LE_US(m_known, m_addr, m_offset, m_len,
...
#define tv_result r_addr
	...
	*(tv)tv_result = (more && (*m > *n)) ? twovalued_FALSE : twovalued_TRUE;
}
