/* $Id: sub_s.c,v 34.2 1995/03/29 13:04:13 ella Exp $ */
...
static char *rcsid = " $Id: sub_s.c,v 34.2 1995/03/29 13:04:13 ella Exp $ ";

/* DEC/CMS REPLACEMENT HISTORY, Element SUB_S.C */
/* *6    10-AUG-1989 12:34:53 ELLADEV "Definitive release 4.0, first provisional release 4.1. BGH" */
/* *5    30-JUN-1989 17:15:44 ELLADEV "Updated provisional with fixes for R4B383. BGH" */
/* *4    26-JUN-1989 18:07:53 ELLADEV "Updated provisional with fixes for R4B380. BGH" */
/* *3    17-FEB-1989 17:18:24 ELLADEV "Updated provisional with partial fixes for R4B043. BGH" */
/* *2    21-JAN-1989 11:23:51 ELLADEV "Provisional for Release 4.0 BGH" */
/* *1    17-JAN-1989 16:55:10 ELLADEV "first draft for Release 4.0, stored in CMS lib [elladev.cms.ella_server]""" */
/* DEC/CMS REPLACEMENT HISTORY, Element SUB_S.C */
/* Subtraction of two arbitrary length, two's complement, signed numbers */
...
Description:
	Subtracts A two's complement integer (signed) of arbitrary length
...
Design:
*
* Subtraction of arbitrary length, two's complement integers (signed).
*
* Design
*
* ASSERT X == +|x| && Y == +|y|
...
void
SUB_S(x_known, x_addr, x_offset, x_len, 
