/* $Id: xor.c,v 34.2 1995/03/29 13:04:18 ella Exp $ */
...
static char *rcsid = " $Id: xor.c,v 34.2 1995/03/29 13:04:18 ella Exp $ ";

/* DEC/CMS REPLACEMENT HISTORY, Element XOR.C */
/* *6    10-AUG-1989 12:36:48 ELLADEV "Definitive release 4.0, first provisional release 4.1. BGH" */
/* *5    30-JUN-1989 17:16:29 ELLADEV "Updated provisional with fixes for R4B383. BGH" */
/* *4    26-JUN-1989 18:08:40 ELLADEV "Updated provisional with fixes for R4B380. BGH" */
/* *3    17-FEB-1989 17:18:53 ELLADEV "Updated provisional with partial fixes for R4B043. BGH" */
/* *2    21-JAN-1989 11:25:26 ELLADEV "Provisional for Release 4.0 BGH" */
/* *1    17-JAN-1989 16:55:34 ELLADEV "first draft for Release 4.0, stored in CMS lib [elladev.cms.ella_server]""" */
/* DEC/CMS REPLACEMENT HISTORY, Element XOR.C */
/*************************************************************************/
...
void
XOR(m_known, m_addr, m_offset, m_len, 
...
#define bs_result bsalign(qf_result + qfsize)
	...
	adjust_input(m_addr, m_offset, m_len, adjustaddress(bs_result, byte_len), m_len, FALSE);
