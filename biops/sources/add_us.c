/* $Id: add_us.c,v 34.2 1995/03/29 13:03:42 ella Exp $ */
...
static char *rcsid = " $Id: add_us.c,v 34.2 1995/03/29 13:03:42 ella Exp $ ";

/* DEC/CMS REPLACEMENT HISTORY, Element ADD_US.C */
/* *6    10-AUG-1989 12:14:39 ELLADEV "Definitive release 4.0, first provisional release 4.1. BGH" */
/* *5    30-JUN-1989 17:12:35 ELLADEV "Updated provisional with fixes for R4B383. BGH" */
/* *4    26-JUN-1989 18:04:20 ELLADEV "Updated provisional with fixes for R4B380. BGH" */
/* *3    17-FEB-1989 17:16:27 ELLADEV "Updated provisional with partial fixes for R4B043. BGH" */
/* *2    21-JAN-1989 11:06:40 ELLADEV "Provisional for Release 4.0 BGH" */
/* *1    17-JAN-1989 16:53:29 ELLADEV "first draft for Release 4.0, stored in CMS lib [elladev.cms.ella_server]""" */
/* DEC/CMS REPLACEMENT HISTORY, Element ADD_US.C */
/* Addition of two arbitrary length, two's complement, unsigned numbers */
...
Description:
	Adds two two's complement integers (unsigned) of arbitrary length.
...
Design:
*
* Addition of arbitrary length, two's complement integers (unsigned).
*
* Design
*
* ASSERT X == +|x| && Y == +|y|
...
void 
ADD_US(x_known, x_addr, x_offset, x_len,
