...
A_ISTRUCT(A68_CHAR ,53,A68t148);
typedef struct A68t148  A68_148 ;    /* STRUCT 53 CHAR */
...
static A68_148   DTPACTR = {"$Id: values.a68,v 34.2 1995/03/29 13:02:09 ella Exp $"}; 
A_GISVEC(A68_VC ,ETPACTR,DTPACTR,53)
...
JBAAOSI_concat( A_HISVEC(DYPACTR,YXPACTR,3,A68_VC ), &EYPACTR );
CYPACTR = EYPACTR;
A_PROC_EXIT(nlmacro);
...
YZPACTR_b = (JZPACTR.data.mode1);
 /* line 219: */
XUAAOSI_lwhole( (A68_LINT )YZPACTR_b, 0, &ZZPACTR );
LZPACTR = ZZPACTR;
break;
case 8: /* STRUCT(INT)  */
...
ACQACTR_l = ZBQACTR_label.Labno;
 ...
 /* line 291: */
 /* line 292: */
FUAAOSI_whole( ACQACTR_l, 0, &DCQACTR );
...
NIQACTR_bb = (JIQACTR.data.mode1);
 /* line 456: */
PVAAOSI_hex( NIQACTR_bb, 24, &QIQACTR );
...
FUAAOSI_whole( QJQACTR_r.Rdenno, 0, &VJQACTR );
...
FUAAOSI_whole( (A68_INT )A_SHR(KKQACTR,WGAACTR_operandsshift), 0, &LKQACTR );
FUAAOSI_whole( (A68_INT )(A68_BITS )((A68_BITS )XJQACTR_o.Param&ZGAACTR_parammask), 0, &NKQACTR );
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/values.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/modes.m","./mfiles/incvalue.m","./mfiles/incid.m","./mfiles/incoperfn.m","./mfiles/incmode.m","./mfiles/idtable.m","./mfiles/coutput.m","./mfiles/environment.m","./mfiles/environ.m","./mfiles/centities.m","/u/model/ella/osif/assoc/mfiles/usefulops.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/values.a68";
A_config.translation_time = "Tue Apr  4 09:31:00 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "ZSPACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:31:00 1995";
...
#undef NL
/* end of translation of ./a68files/values.a68 */
