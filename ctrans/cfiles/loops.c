...
A_ISTRUCT(A68_CHAR ,52,A68t174);
typedef struct A68t174  A68_174 ;    /* STRUCT 52 CHAR */
struct A68t175{
...
static A68_174   ECABCTR = {"$Id: loops.a68,v 34.2 1995/03/29 13:02:02 ella Exp $"}; 
A_GISVEC(A68_VC ,FCABCTR,ECABCTR,52)
...
STABCTR.data[1] = A_UNITE(VTABCTR,mode2,2,OTABCTR_ctrl);
 /* line 448: */
FUAAOSI_whole( QVMACTR_dimensions((*(&A_VINDEX(NL(ENABCTR_modeofrows),I)))), 0, &ZTABCTR );
...
{ 
 /* line 411: */
FRABCTR = 1 ;
FUAAOSI_whole( A_CALLPROC(WVMACTR_istructlength,((*(&A_VINDEX(ENABCTR_modeofrows,FRABCTR)))),((*(&A_VINDEX(ENABCTR_modeofrows,FRABCTR))),(WVMACTR_istructlength).nonlocals)), 0, &GRABCTR );
ERABCTR = GRABCTR;
} 
else
{ 
...
{ 
 /* line 428: */
FUAAOSI_whole( A_CALLPROC(WVMACTR_istructlength,((*(&A_VINDEX(ENABCTR_modeofrows,ASABCTR_i)))),((*(&A_VINDEX(ENABCTR_modeofrows,ASABCTR_i))),(WVMACTR_istructlength).nonlocals)), 0, &HSABCTR );
GSABCTR = HSABCTR;
} 
else
{ 
...
MDMACTR_writecstream(A_HISVEC(ZSABCTR,DSABCTR,3,A68_93 ), GNABCTR_codestream);
 ...
 /* line 435: */
 /* line 436: */
FUAAOSI_whole( ASABCTR_i, 0, &ETABCTR );
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/loops.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/values.m","./mfiles/modes.m","./mfiles/incmode.m","./mfiles/environment.m","./mfiles/environ.m","./mfiles/coutput.m","./mfiles/clauses.m","/u/model/ella/osif/assoc/mfiles/usefulops.m","./mfiles/centities.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/loops.a68";
A_config.translation_time = "Tue Apr  4 09:32:46 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "ACABCTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:32:46 1995";
...
#undef NL
/* end of translation of ./a68files/loops.a68 */
