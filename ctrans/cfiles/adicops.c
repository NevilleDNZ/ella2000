...
A_ISTRUCT(A68_CHAR ,54,A68t181);
typedef struct A68t181  A68_181 ;    /* STRUCT 54 CHAR */
...
A_ISTRUCT(struct A68t169 ,3,A68t202);
typedef struct A68t202  A68_202 ;    /* STRUCT 3 MODE169 */
...
A_ISTRUCT(struct A68t169 ,4,A68t206);
typedef struct A68t206  A68_206 ;    /* STRUCT 4 MODE169 */
...
A_ISTRUCT(A68_CHAR ,12,A68t208);
typedef struct A68t208  A68_208 ;    /* STRUCT 12 CHAR */
...
static A68_181   VFTACTR = {"$Id: adicops.a68,v 34.3 1995/03/29 13:01:47 ella Exp $"}; 
A_GISVEC(A68_VC ,WFTACTR,VFTACTR,54)
...
static A68_182   RPTACTR = {"(A68_CHAR)"}; 
A_GISVEC(A68_VC ,SPTACTR,RPTACTR,10)
static A68_197   WPTACTR = {"ADICOPS - REPR "}; 
A_GISVEC(A68_VC ,XPTACTR,WPTACTR,15)
static A68_198   GQTACTR = {"ADICOPS - LENG incorrect mode:"}; 
A_GISVEC(A68_VC ,IQTACTR,GQTACTR,30)
static A68_199   WQTACTR = {"ADICOPS - SHORT incorrect mode:"}; 
...
static A68_197   FSTACTR = {"ADICOPS - SIGN "}; 
A_GISVEC(A68_VC ,GSTACTR,FSTACTR,15)
static A68_197   PSTACTR = {"incorrect mode:"}; 
...
static A68_200   KVTACTR = {""}; 
A_GISVEC(A68_VC ,LVTACTR,KVTACTR,0)
static A68_205   QVTACTR = {"A_ENTIER"}; 
...
static A68_208   DYTACTR = {"A_COMPL_CONJ"}; 
...
static A68_205   SBUACTR = {"A_C_PLUS"}; 
A_GISVEC(A68_VC ,UBUACTR,SBUACTR,8)
static A68_208   ACUACTR = {"A_COMPL_PLUS"}; 
...
static A68_197   VOUACTR = {" incorrect mode"}; 
...
static A68_197   EXUACTR = {"A_COMPL_MINUSAB"}; 
...
static A68_197   BYUACTR = {"A_COMPL_TIMESAB"}; 
A_GISVEC(A68_VC ,CYUACTR,BYUACTR,15)
static A68_208   GYUACTR = {"A_VC_TIMESAB"}; 
A_GISVEC(A68_VC ,HYUACTR,GYUACTR,12)
static A68_208   JYUACTR = {"A_RC_TIMESAB"}; 
...
FUAAOSI_whole( FQTACTR_m, 0, &JQTACTR );
...
FUAAOSI_whole( VQTACTR_m, 0, &ZQTACTR );
...
A68_201  WSTACTR;  /* collateral clause result */
...
A68_202  RTTACTR;  /* collateral clause result */
...
OSTACTR_m = (*(&(NSTACTR_op->Mode)));
 /* line 295: */
 /* line 296: */
FUAAOSI_whole( OSTACTR_m, 0, &RSTACTR );
...
A68_204  TUTACTR;  /* collateral clause result */
...
A68_206  RVTACTR;  /* collateral clause result */
...
IUTACTR_m = (*(&(HUTACTR_op->Mode)));
 /* line 326: */
 /* line 327: */
FUAAOSI_whole( IUTACTR_m, 0, &LUTACTR );
...
A68_202  OAUACTR;  /* collateral clause result */
...
A68_206  VAUACTR;  /* collateral clause result */
...
if ( Lval )
{ 
DQAAOSI_orab((&(FAUACTR_l->Info)), VKJACTR_lvalue);
} 
 /* line 427: */
 /* line 428: */
if ( (Modes.upb==0) )
...
A68_VC  AOUACTR_temp;
A68_202  COUACTR;  /* collateral clause result */
...
A68_202  APUACTR;  /* collateral clause result */
...
A68_202  MPUACTR;  /* collateral clause result */
...
UOUACTR_m = (*(&(SOUACTR_left->Mode)));
 /* line 698: */
 /* line 699: */
FUAAOSI_whole( UOUACTR_m, 0, &XOUACTR );
...
A68_202  BRUACTR;  /* collateral clause result */
...
A68_202  MRUACTR;  /* collateral clause result */
...
A68_INT  YSUACTR_m;
A68_206  ATUACTR;  /* collateral clause result */
...
BUUACTR_lhs = KOQACTR_yield(Left);
 /* line 807: */
DQAAOSI_orab((&(BUUACTR_lhs->Info)), VKJACTR_lvalue);
 /* line 808: */
 /* line 809: */
 /* line 810: */
if ( Macro )
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/adicops.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/values.m","./mfiles/uniquenameserver.m","./mfiles/modes.m","./mfiles/incmode.m","./mfiles/idtable.m","./mfiles/incoperfn.m","./mfiles/evalbase.m","./mfiles/environment.m","./mfiles/environ.m","./mfiles/coutput.m","./mfiles/centities.m","./mfiles/biops.m","/u/model/ella/osif/assoc/mfiles/usefulops.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/adicops.a68";
A_config.translation_time = "Tue Apr  4 09:31:34 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "RFTACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:31:34 1995";
...
#undef NL
/* end of translation of ./a68files/adicops.a68 */
