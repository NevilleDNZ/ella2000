...
A_ISTRUCT(A68_CHAR ,56,A68t157);
typedef struct A68t157  A68_157 ;    /* STRUCT 56 CHAR */
struct A68t158{
A68_VC  Symbol;
...
extern A68_BITS * GMBAOSI_null_dirptr;
extern A68_BITS * VWBAOSI_open_directory(A68_VC ,struct A68t54 );
extern A68_VOID  EXBAOSI_close_directory(A68_BITS *,struct A68t54 );
extern A68_VOID  KXBAOSI_get_next_dir_entry(A68_BITS *,struct A68t54 ,A68_VC *);
#include <stdlib.h>
...
static A68_157   QXKACTR = {"$Id: liblookup.a68,v 34.2 1995/03/29 13:02:00 ella Exp $"}; 
A_GISVEC(A68_VC ,RXKACTR,QXKACTR,56)
...
HMLACTR_f = BJJACTR_find_and_open_file(Filename, FRIACTR_library_directory, (&GMLACTR_fullname));
 ...
 /* line 343: */
 /* line 344: */
IMLACTR = (HMLACTR_f==HNBAOSI_nil_file);
if ( IMLACTR )
{ 
 /* line 345: */
 /* line 346: */
...
CJLACTR_processspec(ZMLACTR_spec, ANLACTR);
 /* line 353: */
 /* line 354: */
XQBAOSI_close_file(HMLACTR_f, XLBAOSI_ignore_msg);
} 
} 
} 
} 
...
PSAAOSI_before( A_HISVEC(SNLACTR,TNLACTR,32,A68_CHAR ), ' ', &UNLACTR );
...
RYKACTR_index+=2;
 ...
 /* line 103: */
 /* line 104: */
KXAAOSI_xc( EZKACTR_mode, &JZKACTR );
...
RYKACTR_index+=2;
 ...
 /* line 114: */
 /* line 115: */
KXAAOSI_xc( WZKACTR_mode, &CALACTR );
KXAAOSI_xc( SZKACTR_bival, &EALACTR );
...
RYKACTR_index+=1;
 ...
 /* line 128: */
 /* line 129: */
KXAAOSI_xc( NALACTR_mode, &YALACTR );
...
RYKACTR_index+=2;
 ...
 /* line 142: */
 /* line 143: */
KXAAOSI_xc( EBLACTR_prio, &YBLACTR );
KXAAOSI_xc( IBLACTR_lhsmode, &ACLACTR );
KXAAOSI_xc( MBLACTR_rhsmode, &CCLACTR );
KXAAOSI_xc( QBLACTR_resmode, &ECLACTR );
...
RYKACTR_index+=2;
 ...
 /* line 157: */
 /* line 158: */
KXAAOSI_xc( KCLACTR_prio, &JDLACTR );
KXAAOSI_xc( OCLACTR_lhsmode, &LDLACTR );
KXAAOSI_xc( SCLACTR_rhsmode, &NDLACTR );
KXAAOSI_xc( WCLACTR_resmode, &PDLACTR );
KXAAOSI_xc( ADLACTR_biop, &RDLACTR );
...
RYKACTR_index+=2;
 ...
 /* line 163: */
 /* line 164: */
KXAAOSI_xc( VDLACTR_mode, &DELACTR );
KXAAOSI_xc( ZDLACTR_res, &FELACTR );
...
RYKACTR_index+=(2*OELACTR_params);
 ...
 /* line 173: */
 /* line 174: */
KXAAOSI_xc( JELACTR_mode, &TELACTR );
KXAAOSI_xc( NELACTR_res, &VELACTR );
KXAAOSI_xc( OELACTR_params, &XELACTR );
...
RYKACTR_index+=(2*CFLACTR_nmodes);
 ...
 /* line 181: */
 /* line 182: */
KXAAOSI_xc( BFLACTR_mode, &GFLACTR );
KXAAOSI_xc( CFLACTR_nmodes, &IFLACTR );
...
RYKACTR_index+=((A68_INT)(unsigned char)A_VINDEX(Spec,RYKACTR_index)+1);
 ...
 /* line 192: */
 /* line 193: */
KXAAOSI_xc( MFLACTR_mode, &TFLACTR );
KXAAOSI_xc( NFLACTR_nfields, &VFLACTR );
...
RYKACTR_index+=3;
 ...
 /* line 202: */
 /* line 203: */
KXAAOSI_xc( ZFLACTR_mode, &MGLACTR );
KXAAOSI_xc( DGLACTR_elemmode, &OGLACTR );
KXAAOSI_xc( HGLACTR_noelems, &QGLACTR );
...
RYKACTR_index+=1;
 ...
 /* line 213: */
 /* line 214: */
KXAAOSI_xc( UGLACTR_mode, &IHLACTR );
KXAAOSI_xc( YGLACTR_elemmode, &KHLACTR );
...
RYKACTR_index+=1;
 ...
 /* line 226: */
 /* line 227: */
KXAAOSI_xc( OHLACTR_mode, &EILACTR );
KXAAOSI_xc( SHLACTR_elemmode, &GILACTR );
KXAAOSI_xc( THLACTR_dims, &IILACTR );
...
RYKACTR_index+=2;
 ...
 /* line 233: */
 /* line 234: */
KXAAOSI_xc( MILACTR_mode, &UILACTR );
KXAAOSI_xc( QILACTR_elemmode, &WILACTR );
...
break;
default: 
KXAAOSI_xc( UYKACTR_type, &ZILACTR );
...
{ 
 /* line 237: */
PSAAOSI_before( A_HISVEC(FJLACTR,(*Currentmodule),32,A68_CHAR ), ' ', &GJLACTR );
...
PJLACTR_name = A_VTRIM(OJLACTR,(NJLACTR),A_VTSCRIPT(&(OJLACTR.upb),(NJLACTR).upb,1,LJLACTR_namelength));
 /* line 253: */
ZAAAOSI_makervc( PJLACTR_name, &RJLACTR );
...
XJLACTR_name = A_VTRIM(WJLACTR,(VJLACTR),A_VTSCRIPT(&(WJLACTR.upb),(VJLACTR).upb,1,TJLACTR_namelength));
 /* line 259: */
ZAAAOSI_makervc( XJLACTR_name, &ZJLACTR );
...
FKLACTR_name = A_VTRIM(EKLACTR,(DKLACTR),A_VTSCRIPT(&(EKLACTR.upb),(DKLACTR).upb,1,BKLACTR_namelength));
 /* line 265: */
ZAAAOSI_makervc( FKLACTR_name, &HKLACTR );
...
TKLACTR_table = SKLACTR;
 /* line 272: */
ZAAAOSI_makervc( NKLACTR_name, &VKLACTR );
...
HLLACTR_table = GLLACTR;
 /* line 279: */
ZAAAOSI_makervc( BLLACTR_name, &JLLACTR );
...
QLLACTR_initialised = A68_TRUE;
 /* line 329: */
TLLACTR_d = VWBAOSI_open_directory((*(&(FRIACTR_library_directory->Dir))), XLBAOSI_ignore_msg);
 /* line 330: */
 /* line 331: */
 /* line 332: */
ULLACTR = (TLLACTR_d==GMBAOSI_null_dirptr);
if ( ULLACTR )
{ 
...
{ 
 /* line 357: */
KXBAOSI_get_next_dir_entry( TLLACTR_d, XLBAOSI_ignore_msg, &BNLACTR );
...
A_CALLPROC(AMLACTR_add_lib_module,(CNLACTR_filename),(CNLACTR_filename,(AMLACTR_add_lib_module).nonlocals));
 ...
 /* line 368: */
EXBAOSI_close_directory(TLLACTR_d, XLBAOSI_ignore_msg);
 /* line 370: */
 /* line 371: */
 /* line 372: */
...
A_PROC_ENTRY(lookup_in_table);
 ...
 /* line 390: */
{ 
PSAAOSI_before( A_HISVEC(HOLACTR,Id,32,A68_CHAR ), ' ', &IOLACTR );
...
PSAAOSI_before( A_VC_PLUS(A_VC_PLUS(JOLACTR_reqd_symbol,ROLACTR),A_HISVEC(SOLACTR,TOLACTR,32,A68_CHAR )), ' ', &UOLACTR );
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/liblookup.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/moduletracer.m","./mfiles/incinstallation.m","./mfiles/environment.m","./mfiles/common.m","/u/model/ella/osif/assoc/mfiles/osif.m","/u/model/ella/osif/assoc/mfiles/usefulops.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/liblookup.a68";
A_config.translation_time = "Tue Apr  4 09:30:08 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "MXKACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:30:08 1995";
...
#undef NL
/* end of translation of ./a68files/liblookup.a68 */
