...
A_ISTRUCT(A68_CHAR ,56,A68t114);
typedef struct A68t114  A68_114 ;    /* STRUCT 56 CHAR */
struct A68t115{
A68_VC  Name;
A68_BITS  Value;
A_PAD_BITS(PAD_69)
...
extern A68_VOID  XUAAOSI_lwhole(A68_LINT ,A68_INT ,A68_VC *);
...
static A68_114   KWWACTR = {"$Id: mnemonics.a68,v 34.2 1995/03/29 13:02:03 ella Exp $"}; 
A_GISVEC(A68_VC ,LWWACTR,KWWACTR,56)
...
default: 
 /* line 181: */
FUAAOSI_whole( PAXACTR_si.Nse, DZWACTR_fieldlength, &ABXACTR );
...
DBXACTR_i = (OAXACTR.data.mode2);
 ...
 /* line 186: */
 /* line 188: */
FUAAOSI_whole( DBXACTR_i, DZWACTR_fieldlength, &HBXACTR );
...
WBXACTR_sl = (OAXACTR.data.mode5);
 ...
 /* line 197: */
 /* line 199: */
FUAAOSI_whole( WBXACTR_sl.Labno, DZWACTR_fieldlength, &ZBXACTR );
...
FUAAOSI_whole( A_ABS(ICXACTR), DZWACTR_fieldlength, &JCXACTR );
...
FUAAOSI_whole( A_ABS(WCXACTR), DZWACTR_fieldlength, &XCXACTR );
...
FUAAOSI_whole( A_ABS(LDXACTR), DZWACTR_fieldlength, &MDXACTR );
ODXACTR = DDXACTR_o.Mode ;
WCNACTR_modename( A_ABS(ODXACTR), &PDXACTR );
XUAAOSI_lwhole( (A68_LINT )DDXACTR_o.Denotation, DZWACTR_fieldlength, &RDXACTR );
...
FUAAOSI_whole( A_ABS(AEXACTR), DZWACTR_fieldlength, &BEXACTR );
...
{ 
 /* line 254: */
FUAAOSI_whole( JEXACTR_o.Param, DZWACTR_fieldlength, &WGXACTR );
XGXACTR_p = WGXACTR;
 /* line 255: */
 /* line 256: */
 /* line 257: */
...
FUAAOSI_whole( A_ABS(CHXACTR), DZWACTR_fieldlength, &DHXACTR );
...
case 10: 
 ...
 /* line 302: */
 /* line 304: */
FUAAOSI_whole( (JEXACTR_o.Param/16), DZWACTR_fieldlength, &BKXACTR );
MEXACTR_standardpreludeops( ((JEXACTR_o.Param/16)+1), &DKXACTR );
GKXACTR = JEXACTR_o.Param ;
HKXACTR = 16 ;
FUAAOSI_whole( A_MOD(GKXACTR,HKXACTR,FKXACTR), DZWACTR_fieldlength, &IKXACTR );
...
break;
 ...
 /* line 315: */
 /* line 317: */
FUAAOSI_whole( (JEXACTR_o.Param/16), DZWACTR_fieldlength, &AMXACTR );
EMXACTR = JEXACTR_o.Param ;
FMXACTR = 16 ;
FUAAOSI_whole( A_MOD(EMXACTR,FMXACTR,DMXACTR), DZWACTR_fieldlength, &GMXACTR );
...
{ 
 /* line 322: */
 /* line 323: */
FUAAOSI_whole( ((-1)-JEXACTR_o.Param), DZWACTR_fieldlength, &UMXACTR );
...
default: 
 /* line 412: */
 /* line 413: */
FUAAOSI_whole( CQXACTR_t.Type, DZWACTR_fieldlength, &XQXACTR );
...
FUAAOSI_whole( A_ABS(IRXACTR), DZWACTR_fieldlength, &JRXACTR );
LRXACTR = CQXACTR_t.Mode ;
WCNACTR_modename( A_ABS(LRXACTR), &MRXACTR );
FUAAOSI_whole( CQXACTR_t.Decno, DZWACTR_fieldlength, &ORXACTR );
...
{ 
 ...
 /* line 436: */
 /* line 437: */
FUAAOSI_whole( PRXACTR_r.Maxname, DZWACTR_fieldlength, &ESXACTR );
...
FUAAOSI_whole( A_ABS(NSXACTR), DZWACTR_fieldlength, &OSXACTR );
QSXACTR = PRXACTR_r.Mode ;
WCNACTR_modename( A_ABS(QSXACTR), &RSXACTR );
FUAAOSI_whole( PRXACTR_r.Rdenno, DZWACTR_fieldlength, &TSXACTR );
...
OTXACTR_l = (MAXACTR.data.mode14);
 /* line 449: */
 /* line 450: */
RTXACTR = OTXACTR_l.Name ;
STXACTR = A_VVAC(QTXACTR) ;
if ( A_VSTRUCTCOMP(RTXACTR,STXACTR) )
{ 
UTXACTR = VTXACTR;
} 
else
...
case 1: 
 /* line 457: */
FUAAOSI_whole( OTXACTR_l.Labno, DZWACTR_fieldlength, &ZTXACTR );
...
case 2: 
 ...
 /* line 459: */
 /* line 460: */
FUAAOSI_whole( OTXACTR_l.Labno, DZWACTR_fieldlength, &CUXACTR );
...
default: 
 ...
 /* line 463: */
 /* line 464: */
FUAAOSI_whole( OTXACTR_l.Status, DZWACTR_fieldlength, &GUXACTR );
FUAAOSI_whole( OTXACTR_l.Labno, DZWACTR_fieldlength, &IUXACTR );
...
{ 
 /* line 465: */
 /* line 466: */
FUAAOSI_whole( OTXACTR_l.Labno, DZWACTR_fieldlength, &LUXACTR );
...
FUAAOSI_whole( A_ABS(WUXACTR), DZWACTR_fieldlength, &XUXACTR );
...
FUAAOSI_whole( OUXACTR_u.Param, DZWACTR_fieldlength, &DVXACTR );
...
EVXACTR_c = (MAXACTR.data.mode16);
 ...
 /* line 478: */
 /* line 480: */
FUAAOSI_whole( EVXACTR_c.I, DZWACTR_fieldlength, &HVXACTR );
...
QVXACTR_c = (MAXACTR.data.mode19);
 ...
 /* line 488: */
 /* line 490: */
FUAAOSI_whole( QVXACTR_c.Mode, 0, &XVXACTR );
FUAAOSI_whole( QVXACTR_c.Number, 0, &ZVXACTR );
...
BWXACTR_f = (MAXACTR.data.mode18);
 ...
 /* line 498: */
 /* line 499: */
FUAAOSI_whole( BWXACTR_f.Info.Nochars, DZWACTR_fieldlength, &HWXACTR );
FUAAOSI_whole( BWXACTR_f.Info.Nocases, DZWACTR_fieldlength, &JWXACTR );
FUAAOSI_whole( BWXACTR_f.Info.W, DZWACTR_fieldlength, &LWXACTR );
...
default: 
 ...
 /* line 512: */
 /* line 513: */
FUAAOSI_whole( PWXACTR_s.Fn, DZWACTR_fieldlength, &UXXACTR );
...
FUAAOSI_whole( A_ABS(FYXACTR), DZWACTR_fieldlength, &GYXACTR );
IYXACTR = PWXACTR_s.Mode ;
WCNACTR_modename( A_ABS(IYXACTR), &JYXACTR );
FUAAOSI_whole( PWXACTR_s.Param, DZWACTR_fieldlength, &LYXACTR );
...
default: 
 ...
 /* line 541: */
 /* line 542: */
FUAAOSI_whole( OYXACTR_s.Fn, DZWACTR_fieldlength, &LZXACTR );
...
FUAAOSI_whole( A_ABS(ZZXACTR), DZWACTR_fieldlength, &AAYACTR );
...
FUAAOSI_whole( A_ABS(HAYACTR), DZWACTR_fieldlength, &IAYACTR );
...
default: 
 ...
 /* line 563: */
 /* line 564: */
FUAAOSI_whole( NAYACTR_t.Fn, DZWACTR_fieldlength, &KBYACTR );
...
PBYACTR_c = (OBYACTR.data.mode1);
 ...
 /* line 572: */
 /* line 574: */
FUAAOSI_whole( PBYACTR_c.Body, DZWACTR_fieldlength, &TBYACTR );
FUAAOSI_whole( PBYACTR_c.Moduleno, DZWACTR_fieldlength, &VBYACTR );
...
WBYACTR_s = (OBYACTR.data.mode2);
 ...
 /* line 577: */
 /* line 578: */
FUAAOSI_whole( WBYACTR_s.Moduleno, DZWACTR_fieldlength, &BCYACTR );
FUAAOSI_whole( WBYACTR_s.I, DZWACTR_fieldlength, &DCYACTR );
FUAAOSI_whole( WBYACTR_s.J, DZWACTR_fieldlength, &FCYACTR );
...
GCYACTR_e = (OBYACTR.data.mode3);
 ...
 /* line 585: */
 /* line 587: */
FUAAOSI_whole( GCYACTR_e.Moduleno, DZWACTR_fieldlength, &NCYACTR );
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/mnemonics.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/identifiers.m","./mfiles/incimperatives.m","/u/model/ella/osif/assoc/mfiles/usefulops.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/mnemonics.a68";
A_config.translation_time = "Tue Apr  4 09:32:08 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "GWWACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:32:08 1995";
...
#undef NL
/* end of translation of ./a68files/mnemonics.a68 */
