...
A_ISTRUCT(A68_CHAR ,54,A68t149);
typedef struct A68t149  A68_149 ;    /* STRUCT 54 CHAR */
...
extern A68_60  XLBAOSI_ignore_msg;
extern A68_74 * HNBAOSI_nil_file;
#define VPBAOSI_newline_char '\012'
extern A68_BOOL  PPBAOSI_(struct A68t75 ,struct A68t75 );
extern A68_75  JPBAOSI_io_error;
extern A68_74 * FQBAOSI_open_file(A68_VC ,struct A68t77 ,struct A68t60 );
extern A68_VOID  XQBAOSI_close_file(struct A68t74 *,struct A68t60 );
extern A68_VOID  HRBAOSI_read_buffer(struct A68t74 *,A68_VC ,A68_INT *,struct A68t60 ,A68_75 *);
extern A68_VOID  JSBAOSI_write_buffer(struct A68t74 *,A68_VC ,struct A68t60 ,A68_75 *);
extern A68_77  PNBAOSI_read_access;
extern A68_77  TNBAOSI_write_access;
extern A68_VOID  VTBAOSI_delete_file(A68_VC ,struct A68t60 ,A68_75 *);
#include <stdlib.h>
...
extern A68_VOID  ONAAOSI_translate_msg(struct A68t54 ,struct A68t36 ,A68_57 *);
...
static A68_149   STLACTR = {"$Id: coutput.a68,v 34.3 1995/03/29 13:01:50 ella Exp $"}; 
A_GISVEC(A68_VC ,TTLACTR,STLACTR,54)
...
A68_135  FXLACTR;  /* OPERATORS - scalar -> [] or VEC[] */
 /* line 170: */
{ 
ONAAOSI_translate_msg( Msgno, Params, &DXLACTR );
...
A68_135  ZZLACTR;  /* OPERATORS - scalar -> [] or VEC[] */
 /* line 234: */
{ 
ONAAOSI_translate_msg( Msgno, Params, &XZLACTR );
...
{ 
 /* line 388: */
HRBAOSI_read_buffer( (*(&((*NL(REMACTR_currentfilestream))->File))), A_VEC(YEMACTR,(&WEMACTR_c),A68_CHAR *), (&XEMACTR_charsread), XLBAOSI_ignore_msg, &ZEMACTR );
ZEMACTR;
 /* line 389: */
...
VFMACTR_f = FQBAOSI_open_file(UFMACTR, PNBAOSI_read_access, XLBAOSI_ignore_msg);
 /* line 439: */
 /* line 440: */
 /* line 441: */
WFMACTR = (VFMACTR_f==HNBAOSI_nil_file);
if ( WFMACTR )
{ 
 /* line 442: */
 /* line 443: */
FUAAOSI_whole( Streamno, 0, &XFMACTR );
...
A68_135  TGMACTR;  /* OPERATORS - istruct to row */
 /* line 475: */
{ 
ONAAOSI_translate_msg( Msgno, Params, &QGMACTR );
...
{ 
 /* line 99: */
YULACTR_modinfo = FQBAOSI_open_file(A_VC_PLUS(KULACTR_modulename,CVLACTR), TNBAOSI_write_access, XLBAOSI_ignore_msg);
 /* line 100: */
 /* line 101: */
 /* line 102: */
DVLACTR = (YULACTR_modinfo==HNBAOSI_nil_file);
if ( DVLACTR )
{ 
 /* line 103: */
...
case 3: /* SHORT INT */
 /* line 116: */
 /* line 117: */
MVLACTR = A_HVEC(PVLACTR,VPBAOSI_newline_char,A68_CHAR );
break;
default: 
...
break;
 ...
 /* line 121: */
 /* line 122: */
JSBAOSI_write_buffer( YULACTR_modinfo, MVLACTR, XLBAOSI_ignore_msg, &WVLACTR );
VVLACTR = PPBAOSI_(WVLACTR, JPBAOSI_io_error);
if ( VVLACTR )
{ 
 /* line 123: */
 /* line 124: */
...
FUAAOSI_whole( Streamno, 0, &VWLACTR );
...
JSBAOSI_write_buffer( (*(&(JXLACTR_f->File))), A_VC_PLUS(A_HVEC(MXLACTR,LWLACTR_ceditid,A68_CHAR ),A_HISVEC(OXLACTR,PXLACTR,4,A68_CHAR )), GXLACTR_msg, &QXLACTR );
QXLACTR;
break;
case 1: /* CHAR */
RXLACTR_c = (KXLACTR.data.mode1);
 /* line 180: */
 /* line 181: */
JSBAOSI_write_buffer( (*(&(JXLACTR_f->File))), A_HVEC(SXLACTR,RXLACTR_c,A68_CHAR ), GXLACTR_msg, &TXLACTR );
TXLACTR;
break;
case 2: /* VECTOR [] CHAR */
UXLACTR_cf = (KXLACTR.data.mode2);
 /* line 182: */
 /* line 183: */
JSBAOSI_write_buffer( (*(&(JXLACTR_f->File))), UXLACTR_cf, GXLACTR_msg, &VXLACTR );
VXLACTR;
break;
case 4: /* SHORT INT */
 /* line 184: */
{ 
JSBAOSI_write_buffer( (*(&(JXLACTR_f->File))), A_HVEC(WXLACTR,VPBAOSI_newline_char,A68_CHAR ), GXLACTR_msg, &XXLACTR );
XXLACTR;
 /* line 185: */
 /* line 186: */
 /* line 187: */
...
{ 
JSBAOSI_write_buffer( (*(&(JXLACTR_f->File))), ZXLACTR, GXLACTR_msg, &AYLACTR );
AYLACTR;
 /* line 188: */
...
FUAAOSI_whole( BYLACTR, 0, &CYLACTR );
JSBAOSI_write_buffer( (*(&(JXLACTR_f->File))), CYLACTR, GXLACTR_msg, &DYLACTR );
DYLACTR;
 /* line 189: */
JSBAOSI_write_buffer( (*(&(JXLACTR_f->File))), FYLACTR, GXLACTR_msg, &GYLACTR );
GYLACTR;
 /* line 190: */
JSBAOSI_write_buffer( (*(&(JXLACTR_f->File))), YQIACTR_basenamesourcefile, GXLACTR_msg, &HYLACTR );
HYLACTR;
 /* line 191: */
JSBAOSI_write_buffer( (*(&(JXLACTR_f->File))), ZQIACTR_sourcefilesuffix, GXLACTR_msg, &IYLACTR );
IYLACTR;
 /* line 192: */
JSBAOSI_write_buffer( (*(&(JXLACTR_f->File))), A_HVEC(JYLACTR,'\"',A68_CHAR ), GXLACTR_msg, &KYLACTR );
KYLACTR;
 /* line 193: */
 /* line 194: */
 /* line 195: */
 /* line 196: */
 /* line 197: */
JSBAOSI_write_buffer( (*(&(JXLACTR_f->File))), A_HVEC(LYLACTR,VPBAOSI_newline_char,A68_CHAR ), GXLACTR_msg, &MYLACTR );
MYLACTR;
} 
} 
break;
...
case 4: /* SHORT INT */
 /* line 248: */
{ 
TYLACTR_write_mem(DAMACTR_ms, A_HVEC(NAMACTR,VPBAOSI_newline_char,A68_CHAR ));
 /* line 249: */
 /* line 250: */
 /* line 251: */
if ( BQIACTR_lineoption )
...
FUAAOSI_whole( QAMACTR, 0, &RAMACTR );
...
TYLACTR_write_mem(DAMACTR_ms, A_HVEC(UAMACTR,'\"',A68_CHAR ));
 ...
 /* line 260: */
 /* line 261: */
TYLACTR_write_mem(DAMACTR_ms, A_HVEC(VAMACTR,VPBAOSI_newline_char,A68_CHAR ));
} 
} 
break;
default: 
...
HCMACTR_f = FQBAOSI_open_file(GCMACTR, TNBAOSI_write_access, XLBAOSI_ignore_msg);
 /* line 306: */
 /* line 307: */
 /* line 308: */
ICMACTR = (HCMACTR_f==HNBAOSI_nil_file);
if ( ICMACTR )
{ 
...
if ( (YULACTR_modinfo!=HNBAOSI_nil_file) )
{ 
XQBAOSI_close_file(YULACTR_modinfo, XLBAOSI_ignore_msg);
} 
 /* line 356: */
 /* line 357: */
 /* line 359: */
...
DEMACTR_cfile = FQBAOSI_open_file(A_VC_PLUS(A_VC_PLUS(XDMACTR,KULACTR_modulename),CEMACTR), TNBAOSI_write_access, XLBAOSI_ignore_msg);
 /* line 360: */
if ( (DEMACTR_cfile==HNBAOSI_nil_file) )
{ 
...
KEMACTR_fs = (JEMACTR.data.mode1);
 /* line 367: */
{ 
XQBAOSI_close_file((*(&(KEMACTR_fs->File))), XLBAOSI_ignore_msg);
 /* line 368: */
...
(*ZGMACTR_i) = A_CALLPROC(LFMACTR_streamchar,(),((LFMACTR_streamchar).nonlocals));
 ...
 /* line 491: */
 /* line 492: */
A_CALLPROC(NFMACTR_selectstream,(UTAAOSI_stringvalue(A_HISVEC(DHMACTR,YGMACTR_stream,4,A68_CHAR ))),(UTAAOSI_stringvalue(A_HISVEC(DHMACTR,YGMACTR_stream,4,A68_CHAR )),(NFMACTR_selectstream).nonlocals));
} 
else
{ 
 /* line 493: */
JSBAOSI_write_buffer( DEMACTR_cfile, A_HVEC(EHMACTR,WGMACTR_c,A68_CHAR ), UGMACTR_cfile_msg, &FHMACTR );
FHMACTR;
} 
} 
}
...
VDMACTR_endofstreams:
 /* line 497: */
XQBAOSI_close_file(DEMACTR_cfile, XLBAOSI_ignore_msg);
 /* line 498: */
 /* line 499: */
A_CALLPROC(GULACTR_purgeoutputfiles,(),((GULACTR_purgeoutputfiles).nonlocals));
} 
...
{ 
 /* line 494: */
XQBAOSI_close_file((*(&(LHMACTR_f->File))), XLBAOSI_ignore_msg);
 /* line 509: */
...
VTBAOSI_delete_file( OHMACTR, XLBAOSI_ignore_msg, &PHMACTR );
PHMACTR;
} 
} 
break;
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/coutput.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/moduletracer.m","./mfiles/environment.m","./mfiles/environ.m","./mfiles/centities.m","/u/model/ella/osif/assoc/mfiles/osif.m","/u/model/ella/osif/assoc/mfiles/messageproc.m","/u/model/ella/osif/assoc/mfiles/usefulops.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/coutput.a68";
A_config.translation_time = "Tue Apr  4 09:30:16 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "OTLACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:30:16 1995";
...
#undef NL
/* end of translation of ./a68files/coutput.a68 */
