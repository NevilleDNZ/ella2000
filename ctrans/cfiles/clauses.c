...
A_ISTRUCT(A68_CHAR ,54,A68t206);
typedef struct A68t206  A68_206 ;    /* STRUCT 54 CHAR */
struct A68t207{
A68_BOOL  Block;
A_PAD_BOOL(PAD_111)
...
A_ISTRUCT(A68_CHAR ,5,A68t228);
typedef struct A68t228  A68_228 ;    /* STRUCT 5 CHAR */
A_ISTRUCT(struct A68t93 ,5,A68t229);
typedef struct A68t229  A68_229 ;    /* STRUCT 5 MODE93 */

A_PROCEDURE(A68_VOID ,A68t230,(struct A68t154 ,struct A68t94 ,struct A68t77 ),(struct A68t154 ,struct A68t94 ,struct A68t77 ,void *));
typedef struct A68t230  A68_230 ;    /* PROC(MODE154,MODE94,REF MODE77) VOID */
A_ISTRUCT(A68_CHAR ,10,A68t231);
typedef struct A68t231  A68_231 ;    /* STRUCT 10 CHAR */
A_ISTRUCT(struct A68t93 ,6,A68t232);
typedef struct A68t232  A68_232 ;    /* STRUCT 6 MODE93 */
A_ISTRUCT(A68_CHAR ,9,A68t233);
typedef struct A68t233  A68_233 ;    /* STRUCT 9 CHAR */
A_ISTRUCT(A68_CHAR ,8,A68t234);
typedef struct A68t234  A68_234 ;    /* STRUCT 8 CHAR */
A_ISTRUCT(struct A68t93 ,8,A68t235);
typedef struct A68t235  A68_235 ;    /* STRUCT 8 MODE93 */

A_PROCEDURE(A68_VOID ,A68t236,(struct A68t154 ,struct A68t94 *,struct A68t77 ),(struct A68t154 ,struct A68t94 *,struct A68t77 ,void *));
typedef struct A68t236  A68_236 ;    /* PROC(MODE154,REF MODE94,REF MODE77) VOID */
A_ISTRUCT(A68_CHAR ,35,A68t237);
typedef struct A68t237  A68_237 ;    /* STRUCT 35 CHAR */
A_ISTRUCT(struct A68t93 ,7,A68t238);
typedef struct A68t238  A68_238 ;    /* STRUCT 7 MODE93 */
A_ISTRUCT(A68_CHAR ,6,A68t239);
typedef struct A68t239  A68_239 ;    /* STRUCT 6 CHAR */

A_PROCEDURE(A68_VOID ,A68t240,(A68_BOOL ,struct A68t109 ),(A68_BOOL ,struct A68t109 ,void *));
typedef struct A68t240  A68_240 ;    /* PROC(BOOL,MODE109) VOID */
A_ISTRUCT(A68_CHAR ,12,A68t241);
typedef struct A68t241  A68_241 ;    /* STRUCT 12 CHAR */

A_PROCEDURE(A68_VOID ,A68t242,(A68_BOOL ,struct A68t94 *),(A68_BOOL ,struct A68t94 *,void *));
typedef struct A68t242  A68_242 ;    /* PROC(BOOL,REF MODE94) VOID */
A_ISTRUCT(A68_CHAR ,14,A68t243);
typedef struct A68t243  A68_243 ;    /* STRUCT 14 CHAR */

A_PROCEDURE(A68_VOID ,A68t244,(struct A68t207 ,struct A68t109 ,struct A68t85 *,A68_BOOL ,A68_BOOL ,A68_BOOL ),(struct A68t207 ,struct A68t109 ,struct A68t85 *,A68_BOOL ,A68_BOOL ,A68_BOOL ,void *));
typedef struct A68t244  A68_244 ;    /* PROC(MODE207,MODE109,REF MODE85,BOOL,BOOL,BOOL) VOID */

A_PROCEDURE(A68_VOID ,A68t245,(A68_BOOL ,A68_BOOL ,struct A68t109 ),(A68_BOOL ,A68_BOOL ,struct A68t109 ,void *));
typedef struct A68t245  A68_245 ;    /* PROC(BOOL,BOOL,MODE109) VOID */

A_PROCEDURE(A68_VOID ,A68t246,(A68_VC ,A68_INT ,struct A68t101 *,struct A68t98 *),(A68_VC ,A68_INT ,struct A68t101 *,struct A68t98 *,void *));
typedef struct A68t246  A68_246 ;    /* PROC(MODE26,INT,REF MODE101) MODE98 */

A_PROCEDURE(A68_VOID ,A68t247,(struct A68t101 *),(struct A68t101 *,void *));
typedef struct A68t247  A68_247 ;    /* PROC(REF MODE101) VOID */
A_ISTRUCT(A68_CHAR ,20,A68t248);
typedef struct A68t248  A68_248 ;    /* STRUCT 20 CHAR */
...
static A68_206   EZYACTR = {"$Id: clauses.a68,v 34.2 1995/03/29 13:01:49 ella Exp $"}; 
A_GISVEC(A68_VC ,FZYACTR,EZYACTR,54)
...
static A68_206   PEZACTR = {"A_ERROR(\"Bad case conformity - two choices for mode\");"}; 
A_GISVEC(A68_VC ,QEZACTR,PEZACTR,54)
static A68_228   XEZACTR = {"case "}; 
...
static A68_231   KGZACTR = {"A_ENQ_SKIP"}; 
A_GISVEC(A68_VC ,MGZACTR,KGZACTR,10)
static A68_228   QGZACTR = {"if ( "}; 
...
static A68_231   AIZACTR = {"A_ENQ_SKIP"}; 
A_GISVEC(A68_VC ,CIZACTR,AIZACTR,10)
static A68_233   GIZACTR = {"switch ( "}; 
...
static A68_234   VIZACTR = {"case 1: "}; 
A_GISVEC(A68_VC ,WIZACTR,VIZACTR,8)
static A68_237   FJZACTR = {"united object - for case conformity"}; 
A_GISVEC(A68_VC ,GJZACTR,FJZACTR,35)
static A68_233   LJZACTR = {"switch ( "}; 
A_GISVEC(A68_VC ,MJZACTR,LJZACTR,9)
static A68_228   QJZACTR = {".mode"}; 
...
{ 
A68_229  LRZACTR;  /* collateral clause result */
...
A68_229  WEZACTR;  /* collateral clause result */
...
FUAAOSI_whole( Casenumber, 0, &BFZACTR );
...
A68_232  PGZACTR;  /* collateral clause result */
...
A68_VOID  GHZACTR_else(void)
{ 
A68_232  HHZACTR;  /* collateral clause result */
...
A68_235  FIZACTR;  /* collateral clause result */
...
A68_238  KJZACTR;  /* collateral clause result */
...
A68_VOID  GKZACTR_comma(A68_INT  Caseno)
{ 
A68_232  HKZACTR;  /* collateral clause result */
...
FUAAOSI_whole( Caseno, 0, &RKZACTR );
...
A68_98  BOZACTR_temp;
A68_229  EOZACTR;  /* collateral clause result */
...
A68_229  XOZACTR;  /* collateral clause result */
...
A68_247  JSZACTR_emitcode;   /* proc value of non-global proc */
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/clauses.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/incimperatives.m","./mfiles/unionaids.m","./mfiles/modes.m","./mfiles/incmode.m","./mfiles/evaluator.m","./mfiles/tracer.m","./mfiles/moduletracer.m","./mfiles/idtable.m","./mfiles/values.m","./mfiles/coutput.m","./mfiles/centities.m","./mfiles/environment.m","./mfiles/environ.m","/u/model/ella/osif/assoc/mfiles/usefulops.m",""};
static A_CONFIG_INFO A_config;
/* --- end of configuration information */
A68_60  AMZACTR;  /* procedure value */
A68_240  ANZACTR;  /* procedure value */
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/clauses.a68";
A_config.translation_time = "Tue Apr  4 09:32:28 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "AZYACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:32:28 1995";
...
#undef NL
/* end of translation of ./a68files/clauses.a68 */
