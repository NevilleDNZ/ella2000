...
A_ISTRUCT(A68_CHAR ,54,A68t195);
typedef struct A68t195  A68_195 ;    /* STRUCT 54 CHAR */
struct A68t196{
struct A68t106  L;
...
extern A68_59 * HNBAOSI_nil_file;
extern A68_BOOL  PPBAOSI_(struct A68t60 ,struct A68t60 );
extern A68_BOOL  TPBAOSI_(struct A68t60 ,struct A68t60 );
extern A68_60  DPBAOSI_io_ok;
...
extern A68_VOID  PSAAOSI_before(A68_VC ,A68_CHAR ,A68_VC *);
extern A68_VOID  ZAAAOSI_makervc(A68_VC ,A68_VC *);
extern A68_VOID  KXAAOSI_xc(A68_INT ,A68_VC *);
extern A68_VOID  FUAAOSI_whole(A68_INT ,A68_INT ,A68_VC *);
extern A68_VOID  XUAAOSI_lwhole(A68_LINT ,A68_INT ,A68_VC *);
extern A68_VOID  PVAAOSI_hex(A68_LBITS ,A68_INT ,A68_VC *);
extern A68_BOOL  HWAAOSI_vcdectoint(A68_INT *,A68_VC );
...
static A68_195   PLOACTR = {"$Id: modules.a68,v 34.3 1995/03/29 13:02:04 ella Exp $"}; 
A_GISVEC(A68_VC ,QLOACTR,PLOACTR,54)
...
LQOACTR = 1 ;
MQOACTR = 2 ;
KQOACTR = (A68_CHAR)((16*(*(&A_R1INDEX(CQOACTR_ir,LQOACTR))))+(*(&A_R1INDEX(CQOACTR_ir,MQOACTR))));
} 
A_PROC_EXIT(hexchar);
return( KQOACTR );
} 
...
PSAAOSI_before( A_HISVEC(ZFPACTR,AGPACTR,32,A68_CHAR ), ' ', &BGPACTR );
...
{
PVAAOSI_hex( (A68_LBITS )(A68_BITS )(A68_INT)(unsigned char)(*AJPACTR_c), 2, &CJPACTR );
...
A_PROC_ENTRY(filter);
 /* line 149: */
PSAAOSI_before( A_VTRIM(TNOACTR,(Name),A_VTSCRIPT(&(TNOACTR.upb),(Name).upb,1,SRIACTR_filenametruncate)), ' ', &UNOACTR );
SNOACTR = UNOACTR;
A_PROC_EXIT(filter);
...
{ 
 /* line 212: */
 /* line 213: */
SRBAOSI_read_line( F, ZNOACTR_modinfo_buf, (&EOOACTR_chars_read), XLBAOSI_ignore_msg, &FOOACTR );
GOOACTR = TPBAOSI_(FOOACTR, DPBAOSI_io_ok);
if ( ! GOOACTR )
{ /* line 214: */
GOOACTR = !HWAAOSI_vcdectoint(Ri, A_VTRIM(HOOACTR,(ZNOACTR_modinfo_buf),A_VTSCRIPT(&(HOOACTR.upb),(ZNOACTR_modinfo_buf).upb,1,EOOACTR_chars_read)));
}
 /* line 215: */
IOOACTR = GOOACTR;
if ( IOOACTR )
...
{ 
 /* line 222: */
 /* line 223: */
SRBAOSI_read_line( F, ZNOACTR_modinfo_buf, (&MOOACTR_chars_read), XLBAOSI_ignore_msg, &NOOACTR );
OOOACTR = TPBAOSI_(NOOACTR, DPBAOSI_io_ok);
if ( ! OOOACTR )
{ /* line 224: */
...
DOOACTR_read_int(F, (&NQOACTR_ubound));
 /* line 272: */
KXAAOSI_xc( NQOACTR_ubound, &RQOACTR );
...
JROACTR_hex_spec = IROACTR;
 ...
 /* line 277: */
 /* line 278: */
SRBAOSI_read_line( F, JROACTR_hex_spec, (&ZOOACTR_chars_read), XLBAOSI_ignore_msg, &KROACTR );
if ( TPBAOSI_(KROACTR, DPBAOSI_io_ok) )
{ 
 /* line 279: */
SXIACTR_terminalerror(261);
} 
...
) )
{
 ...
 /* line 306: */
 /* line 307: */
SRBAOSI_read_line( F, ZNOACTR_modinfo_buf, (&NSOACTR_chars_read), XLBAOSI_ignore_msg, &OSOACTR );
if ( TPBAOSI_(OSOACTR, DPBAOSI_io_ok) )
{ 
 /* line 308: */
SXIACTR_terminalerror(261);
} 
...
KTOACTR_rhspresent = ((*(&A_VINDEX(ZNOACTR_modinfo_buf,JTOACTR)))==EMOACTR_flip);
 /* line 319: */
ZAAAOSI_makervc( A_VTRIM(LTOACTR,(ZNOACTR_modinfo_buf),A_VTSCRIPT(&(LTOACTR.upb),(ZNOACTR_modinfo_buf).upb,(PSOACTR_i+=1),NSOACTR_chars_read)), &MTOACTR );
...
{ 
 ...
 /* line 325: */
{ 
SRBAOSI_read_line( F, ZNOACTR_modinfo_buf, (&NSOACTR_chars_read), XLBAOSI_ignore_msg, &OTOACTR );
PTOACTR_read_status = OTOACTR;
 /* line 326: */
 /* line 327: */
 /* line 328: */
QTOACTR = PPBAOSI_(PTOACTR_read_status, DPBAOSI_io_ok);
if ( QTOACTR )
{ 
 /* line 329: */
...
{ 
 /* line 330: */
 /* line 331: */
if ( TPBAOSI_(PTOACTR_read_status, MPBAOSI_io_no_newline) )
{ 
 /* line 332: */
SXIACTR_terminalerror(261);
} 
...
if ( !VTOACTR ) break;
 /* line 339: */
ZAAAOSI_makervc( A_VC_PLUS((*(&(KSOACTR_keptitem->Rhs))),STOACTR_line), &WTOACTR );
...
if ( SUOACTR )
{ 
KXAAOSI_xc( LUOACTR_version, &VUOACTR );
...
IMOACTR_debugmessage(1, A_VC_PLUS(A_VC_PLUS(XUOACTR,A_HISVEC(YUOACTR,SMOACTR_modinfomagic,8,A68_CHAR )),A_HVEC(ZUOACTR,'\"',A68_CHAR )));
 /* line 373: */
XQBAOSI_close_file(F, XLBAOSI_ignore_msg);
 /* line 374: */
 /* line 375: */
PSAAOSI_before( A_HISVEC(AVOACTR,Name,32,A68_CHAR ), ' ', &BVOACTR );
...
IMOACTR_debugmessage(1, IVOACTR);
 /* line 379: */
KXAAOSI_xc( LUOACTR_version, &LVOACTR );
...
DOOACTR_read_int(F, (&((&(RVOACTR_xmi->L))->Level)));
 /* line 397: */
 /* line 398: */
KXAAOSI_xc( (*(&((&(RVOACTR_xmi->L))->Level))), &XWOACTR );
...
KZOACTR_modinfofile = BJJACTR_find_and_open_file(FZOACTR_modinfobasename, Dirlist, (&GZOACTR_full_filename));
 ...
 /* line 449: */
 /* line 450: */
LZOACTR = (KZOACTR_modinfofile==HNBAOSI_nil_file);
if ( LZOACTR )
{ 
 /* line 451: */
 /* line 452: */
...
{ 
 ...
 /* line 889: */
 /* line 890: */
FUAAOSI_whole( QMOACTR_currentmodinfoversion, 0, &BLPACTR );
...
FUAAOSI_whole( (*(&((&(BBPACTR_currentmodinfo->L))->Level))), 0, &CMPACTR );
...
FUAAOSI_whole( (*(&((&(BBPACTR_currentmodinfo->G))->Level))), 0, &PMPACTR );
ALPACTR.data[18] = A_UNITE(QMPACTR,mode2,2,PMPACTR);
 /* line 900: */
ALPACTR.data[19] = A_UNITE(RMPACTR,mode3,3,EIAACTR_cnewline);
FUAAOSI_whole( (*(&(BBPACTR_currentmodinfo->Type))), 0, &SMPACTR );
...
PSAAOSI_before( A_HISVEC(IPPACTR,JPPACTR,32,A68_CHAR ), ' ', &KPPACTR );
...
PSAAOSI_before( A_HISVEC(PRPACTR,QRPACTR,32,A68_CHAR ), ' ', &RRPACTR );
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/modules.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/uniquenameserver.m","./mfiles/moduletracer.m","./mfiles/liblookup.m","./mfiles/incinstallation.m","./mfiles/incid.m","./mfiles/idtable.m","./mfiles/environment.m","./mfiles/environ.m","./mfiles/coutput.m","./mfiles/common.m","./mfiles/centities.m","/u/model/ella/osif/assoc/mfiles/osif.m","/u/model/ella/osif/assoc/mfiles/usefulops.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/modules.a68";
A_config.translation_time = "Tue Apr  4 09:30:44 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "LLOACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:30:44 1995";
...
#undef NL
/* end of translation of ./a68files/modules.a68 */
