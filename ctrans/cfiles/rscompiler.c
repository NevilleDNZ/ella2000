...
A_ISTRUCT(A68_CHAR ,57,A68t50);
typedef struct A68t50  A68_50 ;    /* STRUCT 57 CHAR */
struct A68t52{
A68_INT  Mode;
A_PAD_INT(PAD_19)
A68_INT  Modeproc;
...
static A68_50   CKAACTR = {"$Id: rscompiler.a68,v 34.2 1995/03/29 13:02:06 ella Exp $"}; 
A_GISVEC(A68_VC ,DKAACTR,CKAACTR,57)
...
(*NSFACTR) = (A68_CHAR)(JSFACTR_k+(A68_INT)(unsigned char)'0');
} 
A_PROC_EXIT(outint);
return;
} 
...
{ 
 /* line 2084: */
 /* line 2085: */
EBCACTR = (A68_CHAR)((A68_INT)(unsigned char)XACACTR_c+LKAACTR_bolddiff);
} 
else
{ 
 /* line 2086: */
...
(*GCCACTR) = (A68_CHAR)(CCCACTR_k+(A68_INT)(unsigned char)'0');
} 
A_PROC_EXIT(outint);
return;
} 
...
(*KZEACTR) = (A68_CHAR)(I/XDAACTR_maxchar);
 /* line 5704: */
 /* line 5705: */
LZEACTR = ((*NL(QYEACTR_ki))+2) ;
NZEACTR = (&A_VINDEX(NL(Ka),LZEACTR)) ;
(*NZEACTR) = (A68_CHAR)A_MOD(I,XDAACTR_maxchar,MZEACTR);
} 
 /* line 5706: */
 /* line 5707: */
(*NL(QYEACTR_ki))+=2;
...
(*WJFACTR) = (A68_CHAR)(A68_INT )(A68_BITS )((A68_BITS )(*NL(MFBACTR_t1))&(A68_BITS )63);
 /* line 6163: */
 /* line 6164: */
if ( ((*NL(MFBACTR_t1))==74) )
{ 
...
(*AKFACTR) = (A68_CHAR)(A68_INT )(A68_BITS )((A68_BITS )((*NL(MFBACTR_t1)) = (*(&A_VINDEX((*NL(AIFACTR_inserts)),GJFACTR_new))))&(A68_BITS )63);
 /* line 6185: */
if ( ((*NL(MFBACTR_t1))==32) )
{ 
...
(*DLFACTR) = (A68_CHAR)(A68_INT )(A68_BITS )((A68_BITS )(*NL(MFBACTR_t1))&(A68_BITS )63);
 /* line 6261: */
 /* line 6262: */
if ( ((*NL(MFBACTR_t1))==74) )
{ 
...
A68_BITS  KGBACTR;  /* SHL */
A68_INT  LGBACTR;  /* SHL */
A68_BOOL  MGBACTR;  /* clause result */
A68_BITS  NGBACTR;  /* SHR */
A68_INT  OGBACTR;  /* SHR */
...
(*NL(LFBACTR_failpos)) = 0;
 ...
 /* line 1119: */
 /* line 1120: */
KGBACTR = (A68_BITS )((A68_BITS )WFBACTR_u&(A68_BITS )31) ;
LGBACTR = 8 ;
(*NL(KFBACTR_crts)) = ((A68_INT )A_SHL(KGBACTR,LGBACTR)+XFBACTR_v);
} 
else
{ 
...
{ 
 ...
 /* line 1128: */
 /* line 1129: */
NGBACTR = (A68_BITS )(*NL(MFBACTR_t1)) ;
OGBACTR = 3 ;
PGBACTR = (((XFBACTR_v*NL(OFBACTR_boolwds3))+(A68_INT )A_SHR(NGBACTR,OGBACTR))+NL(NFBACTR_sidbwdm)) ;
...
A68_BITS  WHBACTR;  /* SHL */
A68_INT  XHBACTR;  /* SHL */
A68_BOOL  YHBACTR;  /* clause result */
A68_BITS  ZHBACTR;  /* SHR */
A68_INT  AIBACTR;  /* SHR */
...
GHBACTR_rstind+=1;
 ...
 /* line 1179: */
 /* line 1180: */
WHBACTR = (A68_BITS )((A68_BITS )EHBACTR_u&(A68_BITS )31) ;
XHBACTR = 8 ;
BHBACTR_failcrts = ((A68_INT )A_SHL(WHBACTR,XHBACTR)+FHBACTR_v);
} 
} 
else
{ 
...
{ 
 ...
 /* line 1187: */
 /* line 1188: */
ZHBACTR = (A68_BITS )DHBACTR_symbol ;
AIBACTR = 3 ;
BIBACTR = (((FHBACTR_v*NL(OFBACTR_boolwds3))+NL(NFBACTR_sidbwdm))+(A68_INT )A_SHR(ZHBACTR,AIBACTR)) ;
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/rscompiler.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/incinstallation.m","./mfiles/incid.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/rscompiler.a68";
A_config.translation_time = "Tue Apr  4 09:26:57 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "YJAACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:26:57 1995";
...
#undef NL
/* end of translation of ./a68files/rscompiler.a68 */
