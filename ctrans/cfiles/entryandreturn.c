...
A_ISTRUCT(A68_CHAR ,21,A68t310);
typedef struct A68t310  A68_310 ;    /* STRUCT 21 CHAR */
...
A_PROCEDURE(A68_VOID ,A68t317,(struct A68t204 ,A68_VC ,A68_VC ,struct A68t154 *),(struct A68t204 ,A68_VC ,A68_VC ,struct A68t154 *,void *));
typedef struct A68t317  A68_317 ;    /* PROC(MODE204,REF MODE26,REF MODE26,REF MODE154) VOID */
...
extern A68_VOID  ZZBAOSI_local_time_str(A68_LINT ,A68_VC *);
#include <stdlib.h>
...
extern A68_VOID  JQCAOSI_get_args(A68_36 *);
#include <signal.h>
...
static A68_274   EDYACTR = {"$Id: entryandreturn.a68,v 34.2 1995/03/29 13:01:52 ella Exp $"}; 
A_GISVEC(A68_VC ,FDYACTR,EDYACTR,61)
...
static A68_125   MPYACTR = {"int main (int argc, char **argv)"}; 
A_GISVEC(A68_VC ,NPYACTR,MPYACTR,32)
...
static A68_310   FQYACTR = {"A_prelude(argc,argv);"}; 
A_GISVEC(A68_VC ,GQYACTR,FQYACTR,21)
...
static A68_310   BSYACTR = {"A_invoked = A68_TRUE;"}; 
...
ZZBAOSI_local_time_str( (*(&((&IYIACTR_config_info)->Translationtime))), &AKYACTR );
...
{ 
PLYACTR = 1 ;
ZZBAOSI_local_time_str( (*(&((&A_R1INDEX(DBPACTR_specs,PLYACTR))->Timeoflastchange))), &QLYACTR );
...
HSYACTR.data[1] = Modulename;
 /* line 285: */
JBAAOSI_concat( A_HISVEC(KSYACTR,HSYACTR,2,A68_VC ), &LSYACTR );
...
JBAAOSI_concat( A_HISVEC(AUYACTR,XTYACTR,2,A68_VC ), &BUYACTR );
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/entryandreturn.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/values.m","./mfiles/uniquenameserver.m","./mfiles/modules.m","./mfiles/incmode.m","./mfiles/incvalue.m","./mfiles/incimperatives.m","./mfiles/incid.m","./mfiles/environment.m","./mfiles/identifiers.m","./mfiles/modes.m","./mfiles/coutput.m","./mfiles/environ.m","./mfiles/centities.m","/u/model/ella/osif/assoc/mfiles/osif.m","/u/model/ella/osif/assoc/mfiles/usefulops.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/entryandreturn.a68";
A_config.translation_time = "Tue Apr  4 09:32:16 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "ADYACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:32:16 1995";
...
#undef NL
/* end of translation of ./a68files/entryandreturn.a68 */
