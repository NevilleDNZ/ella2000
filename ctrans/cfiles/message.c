...
A_ISTRUCT(A68_CHAR ,54,A68t60);
typedef struct A68t60  A68_60 ;    /* STRUCT 54 CHAR */
...
A_ISTRUCT(A68_CHAR ,27,A68t103);
typedef struct A68t103  A68_103 ;    /* STRUCT 27 CHAR */
A_ISTRUCT(A68_CHAR ,29,A68t104);
typedef struct A68t104  A68_104 ;    /* STRUCT 29 CHAR */
A_ISTRUCT(A68_CHAR ,41,A68t105);
typedef struct A68t105  A68_105 ;    /* STRUCT 41 CHAR */
A_ISTRUCT(A68_CHAR ,44,A68t106);
typedef struct A68t106  A68_106 ;    /* STRUCT 44 CHAR */
A_ISTRUCT(A68_CHAR ,36,A68t107);
typedef struct A68t107  A68_107 ;    /* STRUCT 36 CHAR */
A_ISTRUCT(A68_CHAR ,18,A68t108);
typedef struct A68t108  A68_108 ;    /* STRUCT 18 CHAR */
A_ISTRUCT(A68_CHAR ,47,A68t109);
typedef struct A68t109  A68_109 ;    /* STRUCT 47 CHAR */
A_ISTRUCT(A68_CHAR ,42,A68t110);
typedef struct A68t110  A68_110 ;    /* STRUCT 42 CHAR */
A_ISTRUCT(A68_CHAR ,20,A68t111);
typedef struct A68t111  A68_111 ;    /* STRUCT 20 CHAR */
A_ISTRUCT(A68_CHAR ,56,A68t112);
typedef struct A68t112  A68_112 ;    /* STRUCT 56 CHAR */
A_ISTRUCT(A68_CHAR ,58,A68t113);
typedef struct A68t113  A68_113 ;    /* STRUCT 58 CHAR */
...
static A68_60   GDHACTR = {"$Id: message.a68,v 34.2 1995/03/29 13:02:02 ella Exp $"}; 
A_GISVEC(A68_VC ,HDHACTR,GDHACTR,54)
...
static A68_60   JMHACTR = {"(149) decs module restriction - library operators only"}; 
...
static A68_103   RMHACTR = {"(153) .1 cannot be selected"}; 
...
static A68_104   XMHACTR = {"(156) wrong number of indices"}; 
A_GISVEC(A68_VC ,YMHACTR,XMHACTR,29)
static A68_103   ZMHACTR = {"(157) only one index needed"}; 
...
static A68_105   LNHACTR = {"(163) bounds required in mode declaration"}; 
...
static A68_106   VNHACTR = {"(168) operator .3 has more than two operands"}; 
...
static A68_107   ZNHACTR = {"(170) operator .3 must have operands"}; 
A_GISVEC(A68_VC ,AOHACTR,ZNHACTR,36)
static A68_108   BOHACTR = {"(171) .1 not in .2"}; 
A_GISVEC(A68_VC ,COHACTR,BOHACTR,18)
static A68_107   DOHACTR = {"(172) identifier .4 already declared"}; 
A_GISVEC(A68_VC ,EOHACTR,DOHACTR,36)
static A68_103   FOHACTR = {"(173) HEAP not allowed here"}; 
...
static A68_77   JOHACTR = {"(175) bounds required in variable declaration"}; 
A_GISVEC(A68_VC ,KOHACTR,JOHACTR,45)
static A68_105   LOHACTR = {"(176) declaration not allowed after label"}; 
A_GISVEC(A68_VC ,MOHACTR,LOHACTR,41)
static A68_104   NOHACTR = {"(177) label .4 declared twice"}; 
...
static A68_109   TOHACTR = {"(180) declaration must be followed by semicolon"}; 
A_GISVEC(A68_VC ,UOHACTR,TOHACTR,47)
static A68_110   VOHACTR = {"(181) bounds not allowed in parameter mode"}; 
...
static A68_103   BPHACTR = {"(184) label .4 not declared"}; 
A_GISVEC(A68_VC ,CPHACTR,BPHACTR,27)
static A68_111   DPHACTR = {"(185) needs: HERE .4"}; 
...
static A68_108   JPHACTR = {"(188) mixed bounds"}; 
A_GISVEC(A68_VC ,KPHACTR,JPHACTR,18)
static A68_108   LPHACTR = {"(189) already kept"}; 
A_GISVEC(A68_VC ,MPHACTR,LPHACTR,18)
static A68_112   NPHACTR = {"(190) objects of mode XTYPE and YTYPE cannot be assigned"}; 
...
static A68_113   VPHACTR = {"(194) decs module restriction - label .4 is in outer level"}; 
...
static A68_110   LQHACTR = {"(202) nested mode declarations not allowed"}; 
A_GISVEC(A68_VC ,MQHACTR,LQHACTR,42)
static A68_82   NQHACTR = {"(203) .3 not expected here"}; 
A_GISVEC(A68_VC ,OQHACTR,NQHACTR,26)
static A68_106   PQHACTR = {"(204) priority already defined at this level"}; 
A_GISVEC(A68_VC ,QQHACTR,PQHACTR,44)
static A68_105   RQHACTR = {"(205) label .4 already used as identifier"}; 
A_GISVEC(A68_VC ,SQHACTR,RQHACTR,41)
static A68_111   TQHACTR = {"(206) too many modes"}; 
A_GISVEC(A68_VC ,UQHACTR,TQHACTR,20)
static A68_103   VQHACTR = {"(207) syntax stack overflow"}; 
...
static A68_104   HRHACTR = {"(213) BIOP ^a not implemented"}; 
...
static A68_105   HSHACTR = {"(261) Invalid module keeplist information"}; 
...
static A68_107   ZSHACTR = {"(275) Out of range buffer_limit - ^a"}; 
...
static A68_109   RTHACTR = {"(284) Staredit flags \"^a\" found in A68_STAREDIT"}; 
...
static A68_109   XTHACTR = {"(300) Invalid program ( detected by translator)"}; 
A_GISVEC(A68_VC ,YTHACTR,XTHACTR,47)
static A68_104   ZTHACTR = {"(301) Bits denotation too big"}; 
A_GISVEC(A68_VC ,AUHACTR,ZTHACTR,29)
static A68_81   BUHACTR = {"(302) Int denotation too big"}; 
A_GISVEC(A68_VC ,CUHACTR,BUHACTR,28)
static A68_104   DUHACTR = {"(303) Real denotation too big"}; 
...
static A68_60   TUHACTR = {"(311) Too many dimensions in a row, system limit is 15"}; 
...
static A68_111   XUHACTR = {"(313) Vector too big"}; 
...
static A68_109   ZVHACTR = {"(327) Previous version is a partial composition"}; 
A_GISVEC(A68_VC ,AWHACTR,ZVHACTR,47)
static A68_85   BWHACTR = {"(328) Keeplist order has changed"}; 
A_GISVEC(A68_VC ,CWHACTR,BWHACTR,32)
static A68_60   DWHACTR = {"(329) Previous version has a different number of holes"}; 
...
static A68_105   DXHACTR = {"(342) Decs module in incompatible context"}; 
...
static A68_106   VXHACTR = {"(351) IS test will always deliver FALSE here"}; 
...
static A68_108   EZHACTR = {"COMMA {conformity}"}; 
...
static A68_107   KJIACTR = {"(649) Compiler error: table overflow"}; 
...
static A68_107   OLIACTR = {"(703) Cannot create c body file - ^a"}; 
A_GISVEC(A68_VC ,PLIACTR,OLIACTR,36)
static A68_105   QLIACTR = {"(704) Cannot open stream for reading - ^a"}; 
A_GISVEC(A68_VC ,RLIACTR,QLIACTR,41)
static A68_105   SLIACTR = {"(705) Non-numeric cedit /^a/ in stream ^a"}; 
...
static A68_107   GMIACTR = {"(712) (^a) - close called previously"}; 
A_GISVEC(A68_VC ,HMIACTR,GMIACTR,36)
static A68_103   IMIACTR = {"(713) illegal c output data"}; 
...
static A68_107   OMIACTR = {"(716) read error on stream file \"^a\""}; 
...
static A68_103   SMIACTR = {"(750) Output file full - ^a"}; 
...
static A68_109   WMIACTR = {"(799) Value stack has more than one value on it"}; 
...
static A68_99   SNIACTR = {"(810) uninitialised reference variable"}; 
A_GISVEC(A68_VC ,TNIACTR,SNIACTR,38)
...
static A68_105   EOIACTR = {"(816) Cannot open ^a as library directory"}; 
...
static A68_110   IOIACTR = {"(900) Goto in proc context not implemented"}; 
...
default: 
 /* line 550: */
FUAAOSI_whole( Messagenumber, 0, &UOIACTR );
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/message.a68",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/message.a68";
A_config.translation_time = "Tue Apr  4 09:29:39 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "CDHACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:29:39 1995";
...
#undef NL
/* end of translation of ./a68files/message.a68 */
