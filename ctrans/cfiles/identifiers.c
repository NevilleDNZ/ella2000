...
A_ISTRUCT(A68_CHAR ,58,A68t241);
typedef struct A68t241  A68_241 ;    /* STRUCT 58 CHAR */
...
extern A68_VOID  JBAAOSI_concat(struct A68t36 ,A68_VC *);
extern A68_VOID  ZAAAOSI_makervc(A68_VC ,A68_VC *);
extern A68_INT  YRAAOSI_truncate(A68_CHAR ,A68_VC );
extern A68_VOID  GTAAOSI_capitalised(A68_VC ,A68_VC *);
...
static A68_241   QKVACTR = {"$Id: identifiers.a68,v 34.2 1995/03/29 13:01:54 ella Exp $"}; 
A_GISVEC(A68_VC ,RKVACTR,QKVACTR,58)
...
MOVACTR.data[3] = Rhs;
JBAAOSI_concat( A_HISVEC(SOVACTR,MOVACTR,4,A68_VC ), &TOVACTR );
ZAAAOSI_makervc( TOVACTR, &UOVACTR );
...
FPVACTR = A_VC_PLUS(A_VC_PLUS(A_VC_PLUS(JPVACTR,A_HVEC(KPVACTR,' ',A68_CHAR )),(*(&(ZOVACTR_rhsidinfo->Name)))),A_HVEC(LPVACTR,';',A68_CHAR ));
 ...
 /* line 234: */
 /* line 235: */
ZAAAOSI_makervc( A_VC_PLUS(MPVACTR,FPVACTR), &NPVACTR );
BPVACTR = NPVACTR;
} 
else
{ 
...
PPVACTR.data[2] = TPVACTR;
 /* line 237: */
JBAAOSI_concat( A_HISVEC(UPVACTR,PPVACTR,3,A68_VC ), &VPVACTR );
ZAAAOSI_makervc( VPVACTR, &WPVACTR );
BPVACTR = WPVACTR;
} 
} 
...
JBAAOSI_concat( A_HISVEC(NQVACTR,IQVACTR,3,A68_VC ), &OQVACTR );
...
RQVACTR.data[3] = Rhs;
 /* line 252: */
JBAAOSI_concat( A_HISVEC(WQVACTR,RQVACTR,4,A68_VC ), &XQVACTR );
ZAAAOSI_makervc( XQVACTR, &YQVACTR );
...
{ 
 /* line 269: */
ZAAAOSI_makervc( ROVACTR_definition, &GRVACTR );
...
ARWACTR = A_VTRIM(BRWACTR,(S),A_VTSCRIPT(&(BRWACTR.upb),(S).upb,1,YRAAOSI_truncate(C, S)));
...
{ 
 /* line 152: */
GTAAOSI_capitalised( A68name, &JNVACTR );
INVACTR = JNVACTR;
} 
else
{ 
...
FUAAOSI_whole( Modeindex, 0, &EWVACTR );
...
FUAAOSI_whole( EXVACTR_modeoffset, 0, &AYVACTR );
...
MDMACTR_writecstream(A_HISVEC(QAWACTR,XZVACTR,6,A68_66 ), TSLACTR_labelstream(KZVACTR_level));
 /* line 548: */
 /* line 549: */
DQAAOSI_orab((&(HZVACTR_labinfo->Flags)), WQKACTR_labbufferemittedflag);
} 
} 
} 
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/identifiers.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/values.m","./mfiles/uniquenameserver.m","./mfiles/unionaids.m","./mfiles/moduletracer.m","./mfiles/modes.m","./mfiles/incmode.m","./mfiles/incinstallation.m","./mfiles/modules.m","./mfiles/incimperatives.m","./mfiles/incid.m","./mfiles/idtable.m","./mfiles/evaluator.m","./mfiles/environment.m","./mfiles/environ.m","./mfiles/denotations.m","./mfiles/coutput.m","./mfiles/centities.m","/u/model/ella/osif/assoc/mfiles/usefulops.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/identifiers.a68";
A_config.translation_time = "Tue Apr  4 09:31:53 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "MKVACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:31:53 1995";
...
#undef NL
/* end of translation of ./a68files/identifiers.a68 */
