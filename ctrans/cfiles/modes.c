...
A_ISTRUCT(A68_CHAR ,52,A68t144);
typedef struct A68t144  A68_144 ;    /* STRUCT 52 CHAR */
...
extern A68_VOID  FSAAOSI_scanto(A68_CHAR ,A68_VC ,A68_VC *);
...
static A68_144   GNMACTR = {"$Id: modes.a68,v 34.3 1995/03/29 13:02:03 ella Exp $"}; 
A_GISVEC(A68_VC ,HNMACTR,GNMACTR,52)
...
MWNACTR.data[3] = A_UNITE(WWNACTR,mode1,1,XWNACTR);
 /* line 987: */
FUAAOSI_whole( QVMACTR_dimensions(NL(QNNACTR_mode)), 0, &YWNACTR );
...
case 5: 
 /* line 663: */
 /* line 665: */
FUAAOSI_whole( A_CALLPROC(WVMACTR_istructlength,(Mode),(Mode,(WVMACTR_istructlength).nonlocals)), 0, &HFNACTR );
...
A_PROC_ENTRY(cfieldname);
 ...
 /* line 686: */
UFNACTR = (&(Sf->Name)) ;
FSAAOSI_scanto( ' ', A_ISVEC(TFNACTR,UFNACTR,32,A68_CHAR ), &VFNACTR );
GTAAOSI_capitalised( VFNACTR, &WFNACTR );
SFNACTR = WFNACTR;
...
KKNACTR = NKNACTR;
 ...
 /* line 746: */
FUAAOSI_whole( DKNACTR_basicmode, 0, &OKNACTR );
...
FUAAOSI_whole( ZLNACTR_padno+=1, 0, &OMNACTR );
...
FUAAOSI_whole( ZLNACTR_padno+=1, 0, &GNNACTR );
...
if ( TNNACTR )
{ 
FUAAOSI_whole( QNNACTR_mode, 0, &WNNACTR );
...
FUAAOSI_whole( OYNACTR_i, 0, &ZYNACTR );
...
{ 
 /* line 1098: */
FUAAOSI_whole( VUMACTR_intextra(QNNACTR_mode), 0, &IBOACTR );
...
A_PROC_ENTRY(initialisemodetable);
 ...
 /* line 1155: */
{ 
FUAAOSI_whole( Mdes.dim[0].upb, 0, &WCOACTR );
...
{ 
 /* line 1425: */
 /* line 1426: */
FUAAOSI_whole( OJOACTR_i, 0, &RJOACTR );
...
YJOACTR_deflex = LZMACTR_deflexedmode(WJOACTR_i, A68_TRUE);
 ...
 /* line 1441: */
 /* line 1442: */
FUAAOSI_whole( WJOACTR_i, 0, &CKOACTR );
WCNACTR_modename( WJOACTR_i, &EKOACTR );
FUAAOSI_whole( YJOACTR_deflex, 0, &GKOACTR );
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/modes.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/centities.m","./mfiles/moduletracer.m","./mfiles/coutput.m","./mfiles/incvalue.m","./mfiles/uniquenameserver.m","./mfiles/incmode.m","./mfiles/incinstallation.m","./mfiles/environment.m","./mfiles/environ.m","./mfiles/common.m","/u/model/ella/osif/assoc/mfiles/usefulops.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/modes.a68";
A_config.translation_time = "Tue Apr  4 09:30:26 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "CNMACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:30:26 1995";
...
#undef NL
/* end of translation of ./a68files/modes.a68 */
