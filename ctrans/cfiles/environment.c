...
A_ISTRUCT(A68_CHAR ,58,A68t133);
typedef struct A68t133  A68_133 ;    /* STRUCT 58 CHAR */
struct A68t134{
A68_VC  Dir;
struct A68t134 * Next;
};
...
extern A68_46  XLBAOSI_ignore_msg;
extern A68_52 * JNBAOSI_stdout;
extern A68_52 * KNBAOSI_stderr;
extern A68_52 * HNBAOSI_nil_file;
#define VPBAOSI_newline_char '\012'
extern A68_52 * FQBAOSI_open_file(A68_VC ,struct A68t55 ,struct A68t46 );
extern A68_VOID  JSBAOSI_write_buffer(struct A68t52 *,A68_VC ,struct A68t46 ,A68_53 *);
extern A68_55  PNBAOSI_read_access;
extern A68_VOID  FZBAOSI_get_working_directory(A68_VC *);
...
extern A68_VOID  JQCAOSI_get_args(A68_48 *);
#include <signal.h>
...
static A68_133   KPIACTR = {"$Id: environment.a68,v 34.3 1995/03/29 13:01:53 ella Exp $"}; 
A_GISVEC(A68_VC ,LPIACTR,KPIACTR,58)
...
A_PROC_ENTRY(readenv);
 /* line 458: */
{ 
RZBAOSI_get_env_var( Envname, &AZIACTR );
...
A_PROC_ENTRY(typelineonterminal);
 /* line 177: */
{ 
JSBAOSI_write_buffer( JNBAOSI_stdout, Line, XLBAOSI_ignore_msg, &JSIACTR );
JSIACTR;
JSBAOSI_write_buffer( JNBAOSI_stdout, A_HVEC(KSIACTR,VPBAOSI_newline_char,A68_CHAR ), XLBAOSI_ignore_msg, &LSIACTR );
LSIACTR;
} 
...
JSBAOSI_write_buffer( JNBAOSI_stdout, Line, XLBAOSI_ignore_msg, &QSIACTR );
QSIACTR;
...
{ 
 ...
 /* line 204: */
 /* line 205: */
FUAAOSI_whole( SSIACTR_number, 0, &KTIACTR );
...
{ 
 /* line 230: */
 /* line 231: */
FUAAOSI_whole( XRIACTR_linenumber, 0, &WTIACTR );
...
{ 
 /* line 245: */
FUAAOSI_whole( Charposition, 0, &SUIACTR );
OUIACTR = A_VC_PLUS(A_VC_PLUS(RUIACTR,SUIACTR),A_HVEC(TUIACTR,')',A68_CHAR ));
} 
 /* line 247: */
JSBAOSI_write_buffer( KNBAOSI_stderr, A_VC_PLUS(A_VC_PLUS(A_VC_PLUS(A_VC_PLUS(A_VC_PLUS(A_VC_PLUS(A_VC_PLUS(A_HVEC(UUIACTR,'\"',A68_CHAR ),XQIACTR_sourcefilename),A_HVEC(VUIACTR,'\"',A68_CHAR )),UTIACTR),WUIACTR),BUIACTR),Message),OUIACTR), XLBAOSI_ignore_msg, &XUIACTR );
XUIACTR;
 /* line 248: */
 /* line 249: */
JSBAOSI_write_buffer( KNBAOSI_stderr, A_HVEC(YUIACTR,VPBAOSI_newline_char,A68_CHAR ), XLBAOSI_ignore_msg, &ZUIACTR );
ZUIACTR;
} 
...
A_PROC_ENTRY(write_stdout);
 ...
 /* line 376: */
{ 
JSBAOSI_write_buffer( JNBAOSI_stdout, S, XLBAOSI_ignore_msg, &ZXIACTR );
ZXIACTR;
 /* line 377: */
 /* line 378: */
JSBAOSI_write_buffer( JNBAOSI_stdout, A_HVEC(AYIACTR,VPBAOSI_newline_char,A68_CHAR ), XLBAOSI_ignore_msg, &BYIACTR );
BYIACTR;
} 
...
{ 
 /* line 582: */
if ( !HWAAOSI_vcdectoint((&SRIACTR_filenametruncate), A_VINDEX(SBJACTR_argv,YBJACTR_argindex)) )
{ 
 /* line 583: */
...
{ 
 /* line 702: */
 /* line 703: */
if ( !HWAAOSI_vcdectoint((&TRIACTR_tracelevel), A_VINDEX(SBJACTR_argv,YBJACTR_argindex)) )
{ 
 /* line 704: */
...
{ 
 /* line 709: */
 /* line 710: */
if ( !HWAAOSI_vcdectoint((&WRIACTR_debuglevel), A_VINDEX(SBJACTR_argv,YBJACTR_argindex)) )
{ 
 /* line 711: */
...
(*Full_filename) = (IJJACTR.destination);
 /* line 785: */
 /* line 786: */
GJJACTR_file = FQBAOSI_open_file((*Full_filename), PNBAOSI_read_access, XLBAOSI_ignore_msg);
 /* line 787: */
 /* line 788: */
 /* line 789: */
JJJACTR = (GJJACTR_file!=HNBAOSI_nil_file);
if ( JJJACTR )
{ 
 /* line 790: */
...
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","./mfiles","-staredit","59LR","./a68files/environment.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","./mfiles/ctrans_version.m","./mfiles/message.m","./mfiles/moduletracer.m","./mfiles/incinstallation.m","/u/model/ella/osif/assoc/mfiles/usefulops.m","/u/model/ella/osif/assoc/mfiles/osif.m","/u/model/ella/osif/assoc/mfiles/cif.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ctrans/assoc/./a68files/environment.a68";
A_config.translation_time = "Tue Apr  4 09:29:45 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "GPIACTR (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 09:29:45 1995";
...
#undef NL
/* end of translation of ./a68files/environment.a68 */
