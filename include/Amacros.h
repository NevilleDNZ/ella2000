/* $Id: Amacros.h,v 34.3 1995/03/29 13:00:03 ella Exp $ */
...
#define A_COMPL_POWER(z,i)      COMPLEX power not implemented
#define A_COMPL_RE(z)           (z).Re
#define A_COMPL_IM(z)           (z).Im
#define A_COMPL_ARG(z)          ( (z.Re == 0.0) ? \
   ((z.Im > 0.0) ? HALFPI : (z.Im < 0.0) ? -HALFPI : 0.0) : atan(z.Im / z.Re) )
