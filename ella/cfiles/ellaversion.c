...
A_ISTRUCT(A68_CHAR ,58,A68t146);
typedef struct A68t146  A68_146 ;    /* STRUCT 58 CHAR */
A_ISTRUCT(A68_CHAR ,11,A68t147);
typedef struct A68t147  A68_147 ;    /* STRUCT 11 CHAR */
A_ISTRUCT(A68_CHAR ,18,A68t148);
typedef struct A68t148  A68_148 ;    /* STRUCT 18 CHAR */
A_ISTRUCT(A68_CHAR ,21,A68t149);
typedef struct A68t149  A68_149 ;    /* STRUCT 21 CHAR */
A_ISTRUCT(A68_CHAR ,82,A68t150);
typedef struct A68t150  A68_150 ;    /* STRUCT 82 CHAR */
...
static A68_146   KEAAELA = {"$Id: ellaversion.a68,v 34.6 1995/04/03 15:39:18 ella Exp $"}; 
A_GISVEC(A68_VC ,LEAAELA,KEAAELA,58)
static A68_147   MEAAELA = {"Update 34.4"}; 
A_GISVEC(A68_VC ,NEAAELA,MEAAELA,11)
static A68_VC  OEAAELA_version_id;
static A68_148   PEAAELA = {"Release March 1995"}; 
A_GISVEC(A68_VC ,QEAAELA,PEAAELA,18)
static A68_VC  REAAELA_version_msg;
static A68_149   SEAAELA = {"31st March 1995 14:00"}; 
A_GISVEC(A68_VC ,TEAAELA,SEAAELA,21)
static A68_VC  UEAAELA_version_date;
static A68_95   XEAAELA = {"ELLA"}; 
A_GISVEC(A68_VC ,YEAAELA,XEAAELA,4)
static A68_150   ZEAAELA = {"Please make a copy of your library and any other relevant files and report details"}; 
A_GISVEC(A68_VC ,AFAAELA,ZEAAELA,82)

A68_VOID  VEAAELA_ellaversion(A68_134  *ReturnedValue);

A68_VOID  VEAAELA_ellaversion(A68_134  *ReturnedValue)
{ 
A68_134  WEAAELA;  /* collateral clause result */
A68_134  BFAAELA;  /* clause result */
A_PROC_ENTRY(ellaversion);
WEAAELA.Name = YEAAELA;
WEAAELA.Version = OEAAELA_version_id;
WEAAELA.Date = UEAAELA_version_date;
 /* line 58: */
WEAAELA.Msg = REAAELA_version_msg;
 /* line 60: */
WEAAELA.Sys_fault = AFAAELA;
BFAAELA = WEAAELA;
A_PROC_EXIT(ellaversion);
*ReturnedValue = (BFAAELA);
return;
} 
#undef NL
 /* line 1: */
 /* line 3: */
void HEAAELA(void)   /* initialise DECS ellaversion */
{ 
static A68_BOOL A_invoked = A68_FALSE;

/* --- Configuration information for this module */
static char *A_config_arguments[] = {"/u/model/ella/bin/a68toc","-v","-lib","/u/model/ella/a68library/assoc/mfiles","-cdir","./cfiles","-dir","/u/model/ella/osif/assoc/mfiles","-dir","/u/model/ella/oslib/assoc/mfiles","-dir","/u/model/ella/ostools/assoc/mfiles","-dir","/u/model/ella/transform/assoc/mfiles","-dir","./mfiles","-staredit","259","./a68files/ellaversion.a68",""};
static char *A_config_environment[] = {"A68_LIB=","A68_CDIR=","A68_DIR=","A68_STAREDIT=","A68_NAMESEED=","CTRANS_NAMESEED=ctrans_nameseed",""};
static char *A_config_modinfo_files[] = {"/u/model/ella/a68library/assoc/mfiles/a68config.m","/u/model/ella/ostools/assoc/mfiles/osinterface.m","/u/model/ella/oslib/assoc/mfiles/putstrings.m",""};
...
A_config.source_file = "/import/hazel/home/export/model/ella/ella/assoc/./a68files/ellaversion.a68";
A_config.translation_time = "Tue Apr  4 10:32:25 1995";
A_config.ctrans_version = "Ctrans_34.5";
A_config.name_seed = "GEAAELA (from seed file) ";
A_config.spec_change_time = "Tue Apr  4 10:32:25 1995";
A_config.arguments = A_config_arguments;
A_config.environment = A_config_environment;
A_config.modinfo_files = A_config_modinfo_files;
A_PROC_ENTRY(DECS ellaversion);
UEAALIB_a68config(LGAALIB_configinfo, LEAAELA);
 /* line 52: */
OEAAELA_version_id = NEAAELA;
 /* line 53: */
REAAELA_version_msg = QEAAELA;
 /* line 54: */
UEAAELA_version_date = TEAAELA;
 /* line 56: */
 /* line 61: */
A_PROC_EXIT(DECS ellaversion);
} 
#undef NL
/* end of translation of ./a68files/ellaversion.a68 */
